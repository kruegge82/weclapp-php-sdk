...
| ------------- | ------------- | ------------- |
| [**pickCheckReasonCountGet()**](PickCheckReasonApi.md#pickCheckReasonCountGet) | **GET** /pickCheckReason/count |  |
| [**pickCheckReasonGet()**](PickCheckReasonApi.md#pickCheckReasonGet) | **GET** /pickCheckReason |  |
| [**pickCheckReasonIdIdDelete()**](PickCheckReasonApi.md#pickCheckReasonIdIdDelete) | **DELETE** /pickCheckReason/id/{id} |  |
| [**pickCheckReasonIdIdGet()**](PickCheckReasonApi.md#pickCheckReasonIdIdGet) | **GET** /pickCheckReason/id/{id} |  |
| [**pickCheckReasonIdIdPut()**](PickCheckReasonApi.md#pickCheckReasonIdIdPut) | **PUT** /pickCheckReason/id/{id} |  |
| [**pickCheckReasonPost()**](PickCheckReasonApi.md#pickCheckReasonPost) | **POST** /pickCheckReason |  |


## `pickCheckReasonCountGet()`

```php
pickCheckReasonCountGet(): \kruegge82\weclapp\Model\AccountingTransactionCountGet200Response
```
...
try {
    $result = $apiInstance->pickCheckReasonCountGet();
    print_r($result);
} catch (Exception $e) {
...
```php
pickCheckReasonGet($page, $page_size, $sort): \kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response
```
...
try {
    $result = $apiInstance->pickCheckReasonGet($page, $page_size, $sort);
    print_r($result);
} catch (Exception $e) {
...
```php
pickCheckReasonIdIdPut($id, $body, $dry_run): \kruegge82\weclapp\Model\CustomValue
```
...
try {
    $result = $apiInstance->pickCheckReasonIdIdPut($id, $body, $dry_run);
    print_r($result);
} catch (Exception $e) {
...
```php
pickCheckReasonPost($body, $dry_run): \kruegge82\weclapp\Model\CustomValue
```
...
try {
    $result = $apiInstance->pickCheckReasonPost($body, $dry_run);
    print_r($result);
} catch (Exception $e) {

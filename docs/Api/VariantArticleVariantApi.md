...
| ------------- | ------------- | ------------- |
| [**variantArticleVariantCountGet()**](VariantArticleVariantApi.md#variantArticleVariantCountGet) | **GET** /variantArticleVariant/count | count variantArticleVariant |
| [**variantArticleVariantGet()**](VariantArticleVariantApi.md#variantArticleVariantGet) | **GET** /variantArticleVariant | query variantArticleVariant |
| [**variantArticleVariantIdIdGet()**](VariantArticleVariantApi.md#variantArticleVariantIdIdGet) | **GET** /variantArticleVariant/id/{id} | query a specific variantArticleVariant |


## `variantArticleVariantCountGet()`

```php
variantArticleVariantCountGet($filter): \kruegge82\weclapp\Model\AccountingTransactionCountGet200Response
```
...
try {
    $result = $apiInstance->variantArticleVariantCountGet($filter);
    print_r($result);
} catch (Exception $e) {
...
```php
variantArticleVariantGet($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities): \kruegge82\weclapp\Model\VariantArticleVariantGet200Response
```
...
try {
    $result = $apiInstance->variantArticleVariantGet($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities);
    print_r($result);
} catch (Exception $e) {

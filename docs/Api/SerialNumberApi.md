...
$apiInstance = new kruegge82\weclapp\Api\SerialNumberApi(
...
[**\kruegge82\weclapp\Model\SerialNumberGet200Response**](../Model/SerialNumberGet200Response.md)
...
try {
    $result = $apiInstance->serialNumberIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SerialNumberApi->serialNumberIdIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\SerialNumber**](../Model/SerialNumber.md)

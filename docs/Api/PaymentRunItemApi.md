# kruegge82\weclapp\PaymentRunItemApi

All URIs are relative to http://nullapi/v2, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**paymentRunItemCountGet()**](PaymentRunItemApi.md#paymentRunItemCountGet) | **GET** /paymentRunItem/count |  |
| [**paymentRunItemGet()**](PaymentRunItemApi.md#paymentRunItemGet) | **GET** /paymentRunItem |  |
| [**paymentRunItemIdIdGet()**](PaymentRunItemApi.md#paymentRunItemIdIdGet) | **GET** /paymentRunItem/id/{id} |  |


## `paymentRunItemCountGet()`

```php
paymentRunItemCountGet(): \kruegge82\weclapp\Model\AccountingTransactionCountGet200Response
```
...
try {
    $result = $apiInstance->paymentRunItemCountGet();
    print_r($result);
} catch (Exception $e) {
...
```php
paymentRunItemGet($page, $page_size, $sort): \kruegge82\weclapp\Model\PaymentRunItemGet200Response
```
...
try {
    $result = $apiInstance->paymentRunItemGet($page, $page_size, $sort);
    print_r($result);
} catch (Exception $e) {

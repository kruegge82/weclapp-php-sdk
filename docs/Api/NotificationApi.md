...
$apiInstance = new kruegge82\weclapp\Api\NotificationApi(
...
[**\kruegge82\weclapp\Model\NotificationGet200Response**](../Model/NotificationGet200Response.md)
...
try {
    $result = $apiInstance->notificationIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling NotificationApi->notificationIdIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\Notification**](../Model/Notification.md)
...
```php
notificationIdIdMarkReadPost($id, $body): \kruegge82\weclapp\Model\NotificationIdIdMarkReadPost200Response
```
...
try {
    $result = $apiInstance->notificationIdIdMarkReadPost($id, $body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling NotificationApi->notificationIdIdMarkReadPost: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\NotificationIdIdMarkReadPost200Response**](../Model/NotificationIdIdMarkReadPost200Response.md)

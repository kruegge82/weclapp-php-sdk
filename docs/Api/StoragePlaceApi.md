...
$apiInstance = new kruegge82\weclapp\Api\StoragePlaceApi(
...
[**\kruegge82\weclapp\Model\StoragePlaceGet200Response**](../Model/StoragePlaceGet200Response.md)
...
try {
    $result = $apiInstance->storagePlaceIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StoragePlaceApi->storagePlaceIdIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\StoragePlace**](../Model/StoragePlace.md)

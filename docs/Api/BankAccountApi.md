...
$apiInstance = new kruegge82\weclapp\Api\BankAccountApi(
...
[**\kruegge82\weclapp\Model\BankAccountGet200Response**](../Model/BankAccountGet200Response.md)
...
try {
    $apiInstance->bankAccountIdIdDelete($id, $dry_run);
} catch (Exception $e) {
    echo 'Exception when calling BankAccountApi->bankAccountIdIdDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->bankAccountIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankAccountApi->bankAccountIdIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\BankAccount**](../Model/BankAccount.md)

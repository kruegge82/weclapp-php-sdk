...
$apiInstance = new kruegge82\weclapp\Api\CustomerApi(
...
[**\kruegge82\weclapp\Model\CustomerGet200Response**](../Model/CustomerGet200Response.md)
...
try {
    $apiInstance->customerIdIdDelete($id, $dry_run);
} catch (Exception $e) {
    echo 'Exception when calling CustomerApi->customerIdIdDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->customerIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CustomerApi->customerIdIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\Customer**](../Model/Customer.md)

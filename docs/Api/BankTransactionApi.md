...
$apiInstance = new kruegge82\weclapp\Api\BankTransactionApi(
...
[**\kruegge82\weclapp\Model\BankTransactionGet200Response**](../Model/BankTransactionGet200Response.md)
...
try {
    $apiInstance->bankTransactionIdIdDelete($id, $dry_run);
} catch (Exception $e) {
    echo 'Exception when calling BankTransactionApi->bankTransactionIdIdDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->bankTransactionIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankTransactionApi->bankTransactionIdIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\BankTransaction**](../Model/BankTransaction.md)

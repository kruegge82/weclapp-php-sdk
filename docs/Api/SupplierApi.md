...
$apiInstance = new kruegge82\weclapp\Api\SupplierApi(
...
[**\kruegge82\weclapp\Model\SupplierGet200Response**](../Model/SupplierGet200Response.md)
...
try {
    $apiInstance->supplierIdIdDelete($id, $dry_run);
} catch (Exception $e) {
    echo 'Exception when calling SupplierApi->supplierIdIdDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->supplierIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierApi->supplierIdIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\Supplier**](../Model/Supplier.md)

...
$apiInstance = new kruegge82\weclapp\Api\PaymentRunApi(
...
[**\kruegge82\weclapp\Model\PaymentRunGet200Response**](../Model/PaymentRunGet200Response.md)
...
try {
    $apiInstance->paymentRunIdIdDelete($id, $dry_run);
} catch (Exception $e) {
    echo 'Exception when calling PaymentRunApi->paymentRunIdIdDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->paymentRunIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PaymentRunApi->paymentRunIdIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\PaymentRun**](../Model/PaymentRun.md)

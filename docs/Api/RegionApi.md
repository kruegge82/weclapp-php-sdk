...
$apiInstance = new kruegge82\weclapp\Api\RegionApi(
...
[**\kruegge82\weclapp\Model\RegionGet200Response**](../Model/RegionGet200Response.md)
...
try {
    $apiInstance->regionIdIdDelete($id, $dry_run);
} catch (Exception $e) {
    echo 'Exception when calling RegionApi->regionIdIdDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->regionIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling RegionApi->regionIdIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\kruegge82\weclapp\Model\Region**](../Model/Region.md)

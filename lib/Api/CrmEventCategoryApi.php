...
class CrmEventCategoryApi
{
     ...
     */
    public function crmEventCategoryCountGet($filter = null, string $contentType = self::contentTypes['crmEventCategoryCountGet'][0])
    {
        list($response) = $this->crmEventCategoryCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function crmEventCategoryCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['crmEventCategoryCountGet'][0])
    {
        $request = $this->crmEventCategoryCountGetRequest($filter, $contentType);
     ...
     */
    public function crmEventCategoryCountGetAsync($filter = null, string $contentType = self::contentTypes['crmEventCategoryCountGet'][0])
    {
        return $this->crmEventCategoryCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function crmEventCategoryCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['crmEventCategoryCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->crmEventCategoryCountGetRequest($filter, $contentType);
     ...
     */
    public function crmEventCategoryCountGetRequest($filter = null, string $contentType = self::contentTypes['crmEventCategoryCountGet'][0])
    {
     ...
     */
    public function crmEventCategoryGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['crmEventCategoryGet'][0])
    {
        list($response) = $this->crmEventCategoryGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function crmEventCategoryGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['crmEventCategoryGet'][0])
    {
        $request = $this->crmEventCategoryGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function crmEventCategoryGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['crmEventCategoryGet'][0])
    {
        return $this->crmEventCategoryGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function crmEventCategoryGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['crmEventCategoryGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response';
        $request = $this->crmEventCategoryGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function crmEventCategoryGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['crmEventCategoryGet'][0])
    {
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function crmEventCategoryIdIdPut($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryIdIdPut'][0])
    {
        list($response) = $this->crmEventCategoryIdIdPutWithHttpInfo($id, $custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function crmEventCategoryIdIdPutWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryIdIdPut'][0])
    {
        $request = $this->crmEventCategoryIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function crmEventCategoryIdIdPutAsync($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryIdIdPut'][0])
    {
        return $this->crmEventCategoryIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function crmEventCategoryIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->crmEventCategoryIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function crmEventCategoryIdIdPutRequest($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryIdIdPut'][0])
    {
        ...
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling crmEventCategoryIdIdPut'
            );
        }
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function crmEventCategoryPost($custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryPost'][0])
    {
        list($response) = $this->crmEventCategoryPostWithHttpInfo($custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function crmEventCategoryPostWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryPost'][0])
    {
        $request = $this->crmEventCategoryPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function crmEventCategoryPostAsync($custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryPost'][0])
    {
        return $this->crmEventCategoryPostAsyncWithHttpInfo($custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function crmEventCategoryPostAsyncWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->crmEventCategoryPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function crmEventCategoryPostRequest($custom_value, $dry_run = null, string $contentType = self::contentTypes['crmEventCategoryPost'][0])
    {

        // verify the required parameter 'custom_value' is set
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling crmEventCategoryPost'
            );
        }

...
class BankAccountApi
{
     ...
     */
    public function bankAccountCountGet($filter = null, string $contentType = self::contentTypes['bankAccountCountGet'][0])
    {
        list($response) = $this->bankAccountCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function bankAccountCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['bankAccountCountGet'][0])
    {
        $request = $this->bankAccountCountGetRequest($filter, $contentType);
     ...
     */
    public function bankAccountCountGetAsync($filter = null, string $contentType = self::contentTypes['bankAccountCountGet'][0])
    {
        return $this->bankAccountCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankAccountCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['bankAccountCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->bankAccountCountGetRequest($filter, $contentType);
     ...
     */
    public function bankAccountCountGetRequest($filter = null, string $contentType = self::contentTypes['bankAccountCountGet'][0])
    {
     ...
     */
    public function bankAccountGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['bankAccountGet'][0])
    {
        list($response) = $this->bankAccountGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function bankAccountGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['bankAccountGet'][0])
    {
        $request = $this->bankAccountGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\BankAccountGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\BankAccountGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\BankAccountGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankAccountGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['bankAccountGet'][0])
    {
        return $this->bankAccountGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankAccountGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['bankAccountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\BankAccountGet200Response';
        $request = $this->bankAccountGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function bankAccountGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['bankAccountGet'][0])
    {
    ...
    public function bankAccountIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['bankAccountIdIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\BankAccount' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\BankAccount' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\BankAccount', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\BankAccount $bank_account bank_account (required)
     * @param  bool|null $dry_run dry_run (optional)
     ...
     * @return \kruegge82\weclapp\Model\BankAccount|\kruegge82\weclapp\Model\ApiProblem
     */
    public function bankAccountIdIdPut($id, $bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountIdIdPut'][0])
    {
        list($response) = $this->bankAccountIdIdPutWithHttpInfo($id, $bank_account, $dry_run, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\BankAccount $bank_account (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bankAccountIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\BankAccount|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function bankAccountIdIdPutWithHttpInfo($id, $bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountIdIdPut'][0])
    {
        $request = $this->bankAccountIdIdPutRequest($id, $bank_account, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankAccountIdIdPutAsync($id, $bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountIdIdPut'][0])
    {
        return $this->bankAccountIdIdPutAsyncWithHttpInfo($id, $bank_account, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankAccountIdIdPutAsyncWithHttpInfo($id, $bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\BankAccount';
        $request = $this->bankAccountIdIdPutRequest($id, $bank_account, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function bankAccountIdIdPutRequest($id, $bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountIdIdPut'][0])
    {
        ...
        if ($bank_account === null || (is_array($bank_account) && count($bank_account) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bank_account when calling bankAccountIdIdPut'
            );
        }
     ...
     * @return \kruegge82\weclapp\Model\BankAccount|\kruegge82\weclapp\Model\ApiProblem
     */
    public function bankAccountPost($bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountPost'][0])
    {
        list($response) = $this->bankAccountPostWithHttpInfo($bank_account, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\BankAccount|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function bankAccountPostWithHttpInfo($bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountPost'][0])
    {
        $request = $this->bankAccountPostRequest($bank_account, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankAccountPostAsync($bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountPost'][0])
    {
        return $this->bankAccountPostAsyncWithHttpInfo($bank_account, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankAccountPostAsyncWithHttpInfo($bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\BankAccount';
        $request = $this->bankAccountPostRequest($bank_account, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function bankAccountPostRequest($bank_account, $dry_run = null, string $contentType = self::contentTypes['bankAccountPost'][0])
    {

...
class SystemApi
{
    ...
    /**
     * Operation systemCreateDemoTestSystemPost
     *
     * @param  \kruegge82\weclapp\Model\SystemCreateDemoTestSystemPostRequest $system_create_demo_test_system_post_request system_create_demo_test_system_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemCreateDemoTestSystemPost'] to see the possible values for this operation
     *
     ...
     */
    public function systemCreateDemoTestSystemPost($system_create_demo_test_system_post_request, string $contentType = self::contentTypes['systemCreateDemoTestSystemPost'][0])
    {
        list($response) = $this->systemCreateDemoTestSystemPostWithHttpInfo($system_create_demo_test_system_post_request, $contentType);
        return $response;
    }

    /**
     * Operation systemCreateDemoTestSystemPostWithHttpInfo
     *
     * @param  \kruegge82\weclapp\Model\SystemCreateDemoTestSystemPostRequest $system_create_demo_test_system_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemCreateDemoTestSystemPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function systemCreateDemoTestSystemPostWithHttpInfo($system_create_demo_test_system_post_request, string $contentType = self::contentTypes['systemCreateDemoTestSystemPost'][0])
    {
        $request = $this->systemCreateDemoTestSystemPostRequest($system_create_demo_test_system_post_request, $contentType);
    ...
    /**
     * Operation systemCreateDemoTestSystemPostAsync
     *
     * @param  \kruegge82\weclapp\Model\SystemCreateDemoTestSystemPostRequest $system_create_demo_test_system_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemCreateDemoTestSystemPost'] to see the possible values for this operation
     *
     ...
     */
    public function systemCreateDemoTestSystemPostAsync($system_create_demo_test_system_post_request, string $contentType = self::contentTypes['systemCreateDemoTestSystemPost'][0])
    {
        return $this->systemCreateDemoTestSystemPostAsyncWithHttpInfo($system_create_demo_test_system_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation systemCreateDemoTestSystemPostAsyncWithHttpInfo
     *
     * @param  \kruegge82\weclapp\Model\SystemCreateDemoTestSystemPostRequest $system_create_demo_test_system_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemCreateDemoTestSystemPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemCreateDemoTestSystemPostAsyncWithHttpInfo($system_create_demo_test_system_post_request, string $contentType = self::contentTypes['systemCreateDemoTestSystemPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionBatchBookingPost200Response';
        $request = $this->systemCreateDemoTestSystemPostRequest($system_create_demo_test_system_post_request, $contentType);
    ...
    /**
     * Create request for operation 'systemCreateDemoTestSystemPost'
     *
     * @param  \kruegge82\weclapp\Model\SystemCreateDemoTestSystemPostRequest $system_create_demo_test_system_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemCreateDemoTestSystemPost'] to see the possible values for this operation
     *
     ...
     */
    public function systemCreateDemoTestSystemPostRequest($system_create_demo_test_system_post_request, string $contentType = self::contentTypes['systemCreateDemoTestSystemPost'][0])
    {

        // verify the required parameter 'system_create_demo_test_system_post_request' is set
        if ($system_create_demo_test_system_post_request === null || (is_array($system_create_demo_test_system_post_request) && count($system_create_demo_test_system_post_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $system_create_demo_test_system_post_request when calling systemCreateDemoTestSystemPost'
            );
        }


        $resourcePath = '/system/createDemoTestSystem';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($system_create_demo_test_system_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($system_create_demo_test_system_post_request));
            } else {
                $httpBody = $system_create_demo_test_system_post_request;
            }
    ...
    /**
     * Operation systemDemoTestSystemInfoGet
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemDemoTestSystemInfoGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\SystemDemoTestSystemInfoGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function systemDemoTestSystemInfoGet(string $contentType = self::contentTypes['systemDemoTestSystemInfoGet'][0])
    {
        list($response) = $this->systemDemoTestSystemInfoGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation systemDemoTestSystemInfoGetWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemDemoTestSystemInfoGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\SystemDemoTestSystemInfoGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function systemDemoTestSystemInfoGetWithHttpInfo(string $contentType = self::contentTypes['systemDemoTestSystemInfoGet'][0])
    {
        $request = $this->systemDemoTestSystemInfoGetRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\SystemDemoTestSystemInfoGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\SystemDemoTestSystemInfoGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\SystemDemoTestSystemInfoGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\SystemDemoTestSystemInfoGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\SystemDemoTestSystemInfoGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation systemDemoTestSystemInfoGetAsync
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemDemoTestSystemInfoGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemDemoTestSystemInfoGetAsync(string $contentType = self::contentTypes['systemDemoTestSystemInfoGet'][0])
    {
        return $this->systemDemoTestSystemInfoGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation systemDemoTestSystemInfoGetAsyncWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemDemoTestSystemInfoGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemDemoTestSystemInfoGetAsyncWithHttpInfo(string $contentType = self::contentTypes['systemDemoTestSystemInfoGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\SystemDemoTestSystemInfoGet200Response';
        $request = $this->systemDemoTestSystemInfoGetRequest($contentType);
    ...
    /**
     * Create request for operation 'systemDemoTestSystemInfoGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemDemoTestSystemInfoGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function systemDemoTestSystemInfoGetRequest(string $contentType = self::contentTypes['systemDemoTestSystemInfoGet'][0])
    {


        $resourcePath = '/system/demoTestSystemInfo';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation systemLicensesGet
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemLicensesGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\SystemLicensesGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function systemLicensesGet(string $contentType = self::contentTypes['systemLicensesGet'][0])
    {
        list($response) = $this->systemLicensesGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation systemLicensesGetWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemLicensesGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\SystemLicensesGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function systemLicensesGetWithHttpInfo(string $contentType = self::contentTypes['systemLicensesGet'][0])
    {
        $request = $this->systemLicensesGetRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\SystemLicensesGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\SystemLicensesGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\SystemLicensesGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\SystemLicensesGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\SystemLicensesGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation systemLicensesGetAsync
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemLicensesGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemLicensesGetAsync(string $contentType = self::contentTypes['systemLicensesGet'][0])
    {
        return $this->systemLicensesGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation systemLicensesGetAsyncWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemLicensesGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemLicensesGetAsyncWithHttpInfo(string $contentType = self::contentTypes['systemLicensesGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\SystemLicensesGet200Response';
        $request = $this->systemLicensesGetRequest($contentType);
    ...
    /**
     * Create request for operation 'systemLicensesGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemLicensesGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function systemLicensesGetRequest(string $contentType = self::contentTypes['systemLicensesGet'][0])
    {


        $resourcePath = '/system/licenses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation systemPermissionsGet
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemPermissionsGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\SystemPermissionsGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function systemPermissionsGet(string $contentType = self::contentTypes['systemPermissionsGet'][0])
    {
        list($response) = $this->systemPermissionsGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation systemPermissionsGetWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemPermissionsGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\SystemPermissionsGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function systemPermissionsGetWithHttpInfo(string $contentType = self::contentTypes['systemPermissionsGet'][0])
    {
        $request = $this->systemPermissionsGetRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\SystemPermissionsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\SystemPermissionsGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\SystemPermissionsGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\SystemPermissionsGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\SystemPermissionsGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation systemPermissionsGetAsync
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemPermissionsGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemPermissionsGetAsync(string $contentType = self::contentTypes['systemPermissionsGet'][0])
    {
        return $this->systemPermissionsGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation systemPermissionsGetAsyncWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemPermissionsGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemPermissionsGetAsyncWithHttpInfo(string $contentType = self::contentTypes['systemPermissionsGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\SystemPermissionsGet200Response';
        $request = $this->systemPermissionsGetRequest($contentType);
    ...
    /**
     * Create request for operation 'systemPermissionsGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['systemPermissionsGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function systemPermissionsGetRequest(string $contentType = self::contentTypes['systemPermissionsGet'][0])
    {

...
class ContractAuthorizationUnitApi
{
     ...
     */
    public function contractAuthorizationUnitCountGet($filter = null, string $contentType = self::contentTypes['contractAuthorizationUnitCountGet'][0])
    {
        list($response) = $this->contractAuthorizationUnitCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function contractAuthorizationUnitCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['contractAuthorizationUnitCountGet'][0])
    {
        $request = $this->contractAuthorizationUnitCountGetRequest($filter, $contentType);
     ...
     */
    public function contractAuthorizationUnitCountGetAsync($filter = null, string $contentType = self::contentTypes['contractAuthorizationUnitCountGet'][0])
    {
        return $this->contractAuthorizationUnitCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contractAuthorizationUnitCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['contractAuthorizationUnitCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->contractAuthorizationUnitCountGetRequest($filter, $contentType);
     ...
     */
    public function contractAuthorizationUnitCountGetRequest($filter = null, string $contentType = self::contentTypes['contractAuthorizationUnitCountGet'][0])
    {
     ...
     */
    public function contractAuthorizationUnitGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['contractAuthorizationUnitGet'][0])
    {
        list($response) = $this->contractAuthorizationUnitGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function contractAuthorizationUnitGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['contractAuthorizationUnitGet'][0])
    {
        $request = $this->contractAuthorizationUnitGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\ContractAuthorizationUnitGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\ContractAuthorizationUnitGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\ContractAuthorizationUnitGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contractAuthorizationUnitGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['contractAuthorizationUnitGet'][0])
    {
        return $this->contractAuthorizationUnitGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contractAuthorizationUnitGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['contractAuthorizationUnitGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ContractAuthorizationUnitGet200Response';
        $request = $this->contractAuthorizationUnitGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contractAuthorizationUnitGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['contractAuthorizationUnitGet'][0])
    {
    ...
    public function contractAuthorizationUnitIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['contractAuthorizationUnitIdIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\ContractAuthorizationUnit' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\ContractAuthorizationUnit' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\ContractAuthorizationUnit', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:

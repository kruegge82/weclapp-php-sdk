...
class MetaApi
{
    ...
    /**
     * Operation metaQueryFilterPropertiesGet
     *
     * @param  string $resource resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaQueryFilterPropertiesGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function metaQueryFilterPropertiesGet($resource, string $contentType = self::contentTypes['metaQueryFilterPropertiesGet'][0])
    {
        list($response) = $this->metaQueryFilterPropertiesGetWithHttpInfo($resource, $contentType);
        return $response;
    }

    /**
     * Operation metaQueryFilterPropertiesGetWithHttpInfo
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function metaQueryFilterPropertiesGetWithHttpInfo($resource, string $contentType = self::contentTypes['metaQueryFilterPropertiesGet'][0])
    {
        $request = $this->metaQueryFilterPropertiesGetRequest($resource, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response', []),
            ...
            $returnType = '\kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response',
    ...
    /**
     * Operation metaQueryFilterPropertiesGetAsync
     *
     * @param  string $resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaQueryFilterPropertiesGet'] to see the possible values for this operation
     *
     ...
     */
    public function metaQueryFilterPropertiesGetAsync($resource, string $contentType = self::contentTypes['metaQueryFilterPropertiesGet'][0])
    {
        return $this->metaQueryFilterPropertiesGetAsyncWithHttpInfo($resource, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation metaQueryFilterPropertiesGetAsyncWithHttpInfo
     *
     * @param  string $resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaQueryFilterPropertiesGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function metaQueryFilterPropertiesGetAsyncWithHttpInfo($resource, string $contentType = self::contentTypes['metaQueryFilterPropertiesGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response';
        $request = $this->metaQueryFilterPropertiesGetRequest($resource, $contentType);
    ...
    /**
     * Create request for operation 'metaQueryFilterPropertiesGet'
     *
     * @param  string $resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaQueryFilterPropertiesGet'] to see the possible values for this operation
     *
     ...
     */
    public function metaQueryFilterPropertiesGetRequest($resource, string $contentType = self::contentTypes['metaQueryFilterPropertiesGet'][0])
    {

        // verify the required parameter 'resource' is set
        if ($resource === null || (is_array($resource) && count($resource) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resource when calling metaQueryFilterPropertiesGet'
            );
        }


        $resourcePath = '/meta/queryFilterProperties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation metaQuerySortPropertiesGet
     *
     * @param  string $resource resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaQuerySortPropertiesGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function metaQuerySortPropertiesGet($resource, string $contentType = self::contentTypes['metaQuerySortPropertiesGet'][0])
    {
        list($response) = $this->metaQuerySortPropertiesGetWithHttpInfo($resource, $contentType);
        return $response;
    }

    /**
     * Operation metaQuerySortPropertiesGetWithHttpInfo
     *
     * @param  string $resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaQuerySortPropertiesGet'] to see the possible values for this operation
     *
     ...
     * @return array of \kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function metaQuerySortPropertiesGetWithHttpInfo($resource, string $contentType = self::contentTypes['metaQuerySortPropertiesGet'][0])
    {
        $request = $this->metaQuerySortPropertiesGetRequest($resource, $contentType);
    ...
    /**
     * Operation metaQuerySortPropertiesGetAsync
     *
     * @param  string $resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaQuerySortPropertiesGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function metaQuerySortPropertiesGetAsync($resource, string $contentType = self::contentTypes['metaQuerySortPropertiesGet'][0])
    {
        return $this->metaQuerySortPropertiesGetAsyncWithHttpInfo($resource, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation metaQuerySortPropertiesGetAsyncWithHttpInfo
     *
     * @param  string $resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaQuerySortPropertiesGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function metaQuerySortPropertiesGetAsyncWithHttpInfo($resource, string $contentType = self::contentTypes['metaQuerySortPropertiesGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\MetaQueryFilterPropertiesGet200Response';
        $request = $this->metaQuerySortPropertiesGetRequest($resource, $contentType);
    ...
    /**
     * Create request for operation 'metaQuerySortPropertiesGet'
     *
     * @param  string $resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaQuerySortPropertiesGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function metaQuerySortPropertiesGetRequest($resource, string $contentType = self::contentTypes['metaQuerySortPropertiesGet'][0])
    {

        // verify the required parameter 'resource' is set
        if ($resource === null || (is_array($resource) && count($resource) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resource when calling metaQuerySortPropertiesGet'
            );
        }


        $resourcePath = '/meta/querySortProperties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation metaResourcesGet
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaResourcesGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\MetaResourcesGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function metaResourcesGet(string $contentType = self::contentTypes['metaResourcesGet'][0])
    {
        list($response) = $this->metaResourcesGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation metaResourcesGetWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaResourcesGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\MetaResourcesGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function metaResourcesGetWithHttpInfo(string $contentType = self::contentTypes['metaResourcesGet'][0])
    {
        $request = $this->metaResourcesGetRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\MetaResourcesGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\MetaResourcesGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\MetaResourcesGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\MetaResourcesGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\MetaResourcesGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation metaResourcesGetAsync
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaResourcesGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function metaResourcesGetAsync(string $contentType = self::contentTypes['metaResourcesGet'][0])
    {
        return $this->metaResourcesGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation metaResourcesGetAsyncWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaResourcesGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function metaResourcesGetAsyncWithHttpInfo(string $contentType = self::contentTypes['metaResourcesGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\MetaResourcesGet200Response';
        $request = $this->metaResourcesGetRequest($contentType);
    ...
    /**
     * Create request for operation 'metaResourcesGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['metaResourcesGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function metaResourcesGetRequest(string $contentType = self::contentTypes['metaResourcesGet'][0])
    {

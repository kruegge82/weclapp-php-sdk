...
class PlaceOfServiceApi
{
     ...
     */
    public function placeOfServiceCountGet($filter = null, string $contentType = self::contentTypes['placeOfServiceCountGet'][0])
    {
        list($response) = $this->placeOfServiceCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function placeOfServiceCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['placeOfServiceCountGet'][0])
    {
        $request = $this->placeOfServiceCountGetRequest($filter, $contentType);
     ...
     */
    public function placeOfServiceCountGetAsync($filter = null, string $contentType = self::contentTypes['placeOfServiceCountGet'][0])
    {
        return $this->placeOfServiceCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOfServiceCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['placeOfServiceCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->placeOfServiceCountGetRequest($filter, $contentType);
     ...
     */
    public function placeOfServiceCountGetRequest($filter = null, string $contentType = self::contentTypes['placeOfServiceCountGet'][0])
    {
     ...
     */
    public function placeOfServiceGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['placeOfServiceGet'][0])
    {
        list($response) = $this->placeOfServiceGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function placeOfServiceGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['placeOfServiceGet'][0])
    {
        $request = $this->placeOfServiceGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOfServiceGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['placeOfServiceGet'][0])
    {
        return $this->placeOfServiceGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOfServiceGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['placeOfServiceGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response';
        $request = $this->placeOfServiceGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function placeOfServiceGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['placeOfServiceGet'][0])
    {
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function placeOfServiceIdIdPut($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServiceIdIdPut'][0])
    {
        list($response) = $this->placeOfServiceIdIdPutWithHttpInfo($id, $custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function placeOfServiceIdIdPutWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServiceIdIdPut'][0])
    {
        $request = $this->placeOfServiceIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOfServiceIdIdPutAsync($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServiceIdIdPut'][0])
    {
        return $this->placeOfServiceIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOfServiceIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServiceIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->placeOfServiceIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function placeOfServiceIdIdPutRequest($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServiceIdIdPut'][0])
    {
        ...
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling placeOfServiceIdIdPut'
            );
        }
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function placeOfServicePost($custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServicePost'][0])
    {
        list($response) = $this->placeOfServicePostWithHttpInfo($custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function placeOfServicePostWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServicePost'][0])
    {
        $request = $this->placeOfServicePostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOfServicePostAsync($custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServicePost'][0])
    {
        return $this->placeOfServicePostAsyncWithHttpInfo($custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOfServicePostAsyncWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServicePost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->placeOfServicePostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function placeOfServicePostRequest($custom_value, $dry_run = null, string $contentType = self::contentTypes['placeOfServicePost'][0])
    {

        // verify the required parameter 'custom_value' is set
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling placeOfServicePost'
            );
        }

...
class ProductionWorkScheduleApi
{
     ...
     */
    public function productionWorkScheduleCountGet($filter = null, string $contentType = self::contentTypes['productionWorkScheduleCountGet'][0])
    {
        list($response) = $this->productionWorkScheduleCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function productionWorkScheduleCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['productionWorkScheduleCountGet'][0])
    {
        $request = $this->productionWorkScheduleCountGetRequest($filter, $contentType);
     ...
     */
    public function productionWorkScheduleCountGetAsync($filter = null, string $contentType = self::contentTypes['productionWorkScheduleCountGet'][0])
    {
        return $this->productionWorkScheduleCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productionWorkScheduleCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['productionWorkScheduleCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->productionWorkScheduleCountGetRequest($filter, $contentType);
     ...
     */
    public function productionWorkScheduleCountGetRequest($filter = null, string $contentType = self::contentTypes['productionWorkScheduleCountGet'][0])
    {
     ...
     */
    public function productionWorkScheduleGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['productionWorkScheduleGet'][0])
    {
        list($response) = $this->productionWorkScheduleGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function productionWorkScheduleGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['productionWorkScheduleGet'][0])
    {
        $request = $this->productionWorkScheduleGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\ProductionWorkScheduleGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\ProductionWorkScheduleGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\ProductionWorkScheduleGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productionWorkScheduleGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['productionWorkScheduleGet'][0])
    {
        return $this->productionWorkScheduleGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productionWorkScheduleGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['productionWorkScheduleGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ProductionWorkScheduleGet200Response';
        $request = $this->productionWorkScheduleGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productionWorkScheduleGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['productionWorkScheduleGet'][0])
    {
    ...
    public function productionWorkScheduleIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['productionWorkScheduleIdIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\ProductionWorkSchedule' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\ProductionWorkSchedule' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\ProductionWorkSchedule', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\ProductionWorkSchedule $production_work_schedule production_work_schedule (required)
     * @param  bool|null $dry_run dry_run (optional)
     ...
     * @return \kruegge82\weclapp\Model\ProductionWorkSchedule|\kruegge82\weclapp\Model\ApiProblem
     */
    public function productionWorkScheduleIdIdPut($id, $production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkScheduleIdIdPut'][0])
    {
        list($response) = $this->productionWorkScheduleIdIdPutWithHttpInfo($id, $production_work_schedule, $dry_run, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\ProductionWorkSchedule $production_work_schedule (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productionWorkScheduleIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\ProductionWorkSchedule|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function productionWorkScheduleIdIdPutWithHttpInfo($id, $production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkScheduleIdIdPut'][0])
    {
        $request = $this->productionWorkScheduleIdIdPutRequest($id, $production_work_schedule, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productionWorkScheduleIdIdPutAsync($id, $production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkScheduleIdIdPut'][0])
    {
        return $this->productionWorkScheduleIdIdPutAsyncWithHttpInfo($id, $production_work_schedule, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productionWorkScheduleIdIdPutAsyncWithHttpInfo($id, $production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkScheduleIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ProductionWorkSchedule';
        $request = $this->productionWorkScheduleIdIdPutRequest($id, $production_work_schedule, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productionWorkScheduleIdIdPutRequest($id, $production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkScheduleIdIdPut'][0])
    {
        ...
        // verify the required parameter 'production_work_schedule' is set
        if ($production_work_schedule === null || (is_array($production_work_schedule) && count($production_work_schedule) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $production_work_schedule when calling productionWorkScheduleIdIdPut'
            );
        }
        ...
        // for model (json/xml)
        if (isset($production_work_schedule)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($production_work_schedule));
            } else {
                $httpBody = $production_work_schedule;
            }
     ...
     * @return \kruegge82\weclapp\Model\ProductionWorkSchedule|\kruegge82\weclapp\Model\ApiProblem
     */
    public function productionWorkSchedulePost($production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkSchedulePost'][0])
    {
        list($response) = $this->productionWorkSchedulePostWithHttpInfo($production_work_schedule, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\ProductionWorkSchedule|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function productionWorkSchedulePostWithHttpInfo($production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkSchedulePost'][0])
    {
        $request = $this->productionWorkSchedulePostRequest($production_work_schedule, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productionWorkSchedulePostAsync($production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkSchedulePost'][0])
    {
        return $this->productionWorkSchedulePostAsyncWithHttpInfo($production_work_schedule, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productionWorkSchedulePostAsyncWithHttpInfo($production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkSchedulePost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ProductionWorkSchedule';
        $request = $this->productionWorkSchedulePostRequest($production_work_schedule, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productionWorkSchedulePostRequest($production_work_schedule, $dry_run = null, string $contentType = self::contentTypes['productionWorkSchedulePost'][0])
    {

        // verify the required parameter 'production_work_schedule' is set
        if ($production_work_schedule === null || (is_array($production_work_schedule) && count($production_work_schedule) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $production_work_schedule when calling productionWorkSchedulePost'
            );
        }

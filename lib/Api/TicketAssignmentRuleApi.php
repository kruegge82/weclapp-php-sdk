...
class TicketAssignmentRuleApi
{
     ...
     */
    public function ticketAssignmentRuleCountGet(string $contentType = self::contentTypes['ticketAssignmentRuleCountGet'][0])
    {
        list($response) = $this->ticketAssignmentRuleCountGetWithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function ticketAssignmentRuleCountGetWithHttpInfo(string $contentType = self::contentTypes['ticketAssignmentRuleCountGet'][0])
    {
        $request = $this->ticketAssignmentRuleCountGetRequest($contentType);
     ...
     */
    public function ticketAssignmentRuleCountGetAsync(string $contentType = self::contentTypes['ticketAssignmentRuleCountGet'][0])
    {
        return $this->ticketAssignmentRuleCountGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketAssignmentRuleCountGetAsyncWithHttpInfo(string $contentType = self::contentTypes['ticketAssignmentRuleCountGet'][0])
    {
     ...
     */
    public function ticketAssignmentRuleCountGetRequest(string $contentType = self::contentTypes['ticketAssignmentRuleCountGet'][0])
    {
     ...
     */
    public function ticketAssignmentRuleGet($page = null, $page_size = null, $sort = null, string $contentType = self::contentTypes['ticketAssignmentRuleGet'][0])
    {
        list($response) = $this->ticketAssignmentRuleGetWithHttpInfo($page, $page_size, $sort, $contentType);
        return $response;
    }
     ...
     */
    public function ticketAssignmentRuleGetWithHttpInfo($page = null, $page_size = null, $sort = null, string $contentType = self::contentTypes['ticketAssignmentRuleGet'][0])
    {
        $request = $this->ticketAssignmentRuleGetRequest($page, $page_size, $sort, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketAssignmentRuleGetAsync($page = null, $page_size = null, $sort = null, string $contentType = self::contentTypes['ticketAssignmentRuleGet'][0])
    {
        return $this->ticketAssignmentRuleGetAsyncWithHttpInfo($page, $page_size, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketAssignmentRuleGetAsyncWithHttpInfo($page = null, $page_size = null, $sort = null, string $contentType = self::contentTypes['ticketAssignmentRuleGet'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketAssignmentRuleGetRequest($page = null, $page_size = null, $sort = null, string $contentType = self::contentTypes['ticketAssignmentRuleGet'][0])
    {
     ...
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\TicketAssignmentRule $body body (required)
     * @param  bool|null $dry_run dry_run (optional)
     ...
     * @return \kruegge82\weclapp\Model\TicketAssignmentRule|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ticketAssignmentRuleIdIdPut($id, $body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRuleIdIdPut'][0])
    {
        list($response) = $this->ticketAssignmentRuleIdIdPutWithHttpInfo($id, $body, $dry_run, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\TicketAssignmentRule $body (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketAssignmentRuleIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\TicketAssignmentRule|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ticketAssignmentRuleIdIdPutWithHttpInfo($id, $body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRuleIdIdPut'][0])
    {
        $request = $this->ticketAssignmentRuleIdIdPutRequest($id, $body, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketAssignmentRuleIdIdPutAsync($id, $body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRuleIdIdPut'][0])
    {
        return $this->ticketAssignmentRuleIdIdPutAsyncWithHttpInfo($id, $body, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketAssignmentRuleIdIdPutAsyncWithHttpInfo($id, $body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRuleIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TicketAssignmentRule';
        $request = $this->ticketAssignmentRuleIdIdPutRequest($id, $body, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketAssignmentRuleIdIdPutRequest($id, $body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRuleIdIdPut'][0])
    {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling ticketAssignmentRuleIdIdPut'
            );
        }
     ...
     * @return \kruegge82\weclapp\Model\TicketAssignmentRule|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ticketAssignmentRulePost($body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRulePost'][0])
    {
        list($response) = $this->ticketAssignmentRulePostWithHttpInfo($body, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\TicketAssignmentRule|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ticketAssignmentRulePostWithHttpInfo($body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRulePost'][0])
    {
        $request = $this->ticketAssignmentRulePostRequest($body, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketAssignmentRulePostAsync($body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRulePost'][0])
    {
        return $this->ticketAssignmentRulePostAsyncWithHttpInfo($body, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketAssignmentRulePostAsyncWithHttpInfo($body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRulePost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TicketAssignmentRule';
        $request = $this->ticketAssignmentRulePostRequest($body, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketAssignmentRulePostRequest($body, $dry_run = null, string $contentType = self::contentTypes['ticketAssignmentRulePost'][0])
    {

        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling ticketAssignmentRulePost'
            );
        }

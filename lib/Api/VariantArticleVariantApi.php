...
/**
 * VariantArticleVariantApi Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class VariantArticleVariantApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation variantArticleVariantCountGet
     *
     * count variantArticleVariant
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['variantArticleVariantCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function variantArticleVariantCountGet($filter = null, string $contentType = self::contentTypes['variantArticleVariantCountGet'][0])
    {
        list($response) = $this->variantArticleVariantCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation variantArticleVariantCountGetWithHttpInfo
     *
     * count variantArticleVariant
     *
     ...
     */
    public function variantArticleVariantCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['variantArticleVariantCountGet'][0])
    {
        $request = $this->variantArticleVariantCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation variantArticleVariantCountGetAsync
     *
     * count variantArticleVariant
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function variantArticleVariantCountGetAsync($filter = null, string $contentType = self::contentTypes['variantArticleVariantCountGet'][0])
    {
        return $this->variantArticleVariantCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation variantArticleVariantCountGetAsyncWithHttpInfo
     *
     * count variantArticleVariant
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function variantArticleVariantCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['variantArticleVariantCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->variantArticleVariantCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'variantArticleVariantCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['variantArticleVariantCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function variantArticleVariantCountGetRequest($filter = null, string $contentType = self::contentTypes['variantArticleVariantCountGet'][0])
    {



        $resourcePath = '/variantArticleVariant/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation variantArticleVariantGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['variantArticleVariantGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\VariantArticleVariantGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function variantArticleVariantGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['variantArticleVariantGet'][0])
    {
        list($response) = $this->variantArticleVariantGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation variantArticleVariantGetWithHttpInfo
     *
     * query variantArticleVariant
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\VariantArticleVariantGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function variantArticleVariantGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['variantArticleVariantGet'][0])
    {
        $request = $this->variantArticleVariantGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\VariantArticleVariantGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\VariantArticleVariantGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\VariantArticleVariantGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\VariantArticleVariantGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\VariantArticleVariantGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation variantArticleVariantGetAsync
     *
     * query variantArticleVariant
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function variantArticleVariantGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['variantArticleVariantGet'][0])
    {
        return $this->variantArticleVariantGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation variantArticleVariantGetAsyncWithHttpInfo
     *
     * query variantArticleVariant
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function variantArticleVariantGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['variantArticleVariantGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\VariantArticleVariantGet200Response';
        $request = $this->variantArticleVariantGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'variantArticleVariantGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function variantArticleVariantGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['variantArticleVariantGet'][0])
    {
        ...
        $resourcePath = '/variantArticleVariant';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation variantArticleVariantIdIdGet
     *
     * query a specific variantArticleVariant
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['variantArticleVariantIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\VariantArticleVariant|\kruegge82\weclapp\Model\ApiProblem
     */
    public function variantArticleVariantIdIdGet($id, string $contentType = self::contentTypes['variantArticleVariantIdIdGet'][0])
    {
        list($response) = $this->variantArticleVariantIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation variantArticleVariantIdIdGetWithHttpInfo
     *
     * query a specific variantArticleVariant
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\VariantArticleVariant|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function variantArticleVariantIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['variantArticleVariantIdIdGet'][0])
    {
        $request = $this->variantArticleVariantIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\VariantArticleVariant' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\VariantArticleVariant' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\VariantArticleVariant', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\VariantArticleVariant';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\VariantArticleVariant',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation variantArticleVariantIdIdGetAsync
     *
     * query a specific variantArticleVariant
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function variantArticleVariantIdIdGetAsync($id, string $contentType = self::contentTypes['variantArticleVariantIdIdGet'][0])
    {
        return $this->variantArticleVariantIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation variantArticleVariantIdIdGetAsyncWithHttpInfo
     *
     * query a specific variantArticleVariant
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function variantArticleVariantIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['variantArticleVariantIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\VariantArticleVariant';
        $request = $this->variantArticleVariantIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'variantArticleVariantIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['variantArticleVariantIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function variantArticleVariantIdIdGetRequest($id, string $contentType = self::contentTypes['variantArticleVariantIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling variantArticleVariantIdIdGet'
            );
        }


        $resourcePath = '/variantArticleVariant/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

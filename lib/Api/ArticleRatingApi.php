...
class ArticleRatingApi
{
     ...
     */
    public function articleRatingCountGet($filter = null, string $contentType = self::contentTypes['articleRatingCountGet'][0])
    {
        list($response) = $this->articleRatingCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function articleRatingCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['articleRatingCountGet'][0])
    {
        $request = $this->articleRatingCountGetRequest($filter, $contentType);
     ...
     */
    public function articleRatingCountGetAsync($filter = null, string $contentType = self::contentTypes['articleRatingCountGet'][0])
    {
        return $this->articleRatingCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleRatingCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['articleRatingCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->articleRatingCountGetRequest($filter, $contentType);
     ...
     */
    public function articleRatingCountGetRequest($filter = null, string $contentType = self::contentTypes['articleRatingCountGet'][0])
    {
     ...
     */
    public function articleRatingGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['articleRatingGet'][0])
    {
        list($response) = $this->articleRatingGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function articleRatingGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['articleRatingGet'][0])
    {
        $request = $this->articleRatingGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleRatingGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['articleRatingGet'][0])
    {
        return $this->articleRatingGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleRatingGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['articleRatingGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response';
        $request = $this->articleRatingGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleRatingGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['articleRatingGet'][0])
    {
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function articleRatingIdIdPut($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingIdIdPut'][0])
    {
        list($response) = $this->articleRatingIdIdPutWithHttpInfo($id, $custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function articleRatingIdIdPutWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingIdIdPut'][0])
    {
        $request = $this->articleRatingIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleRatingIdIdPutAsync($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingIdIdPut'][0])
    {
        return $this->articleRatingIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleRatingIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->articleRatingIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleRatingIdIdPutRequest($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingIdIdPut'][0])
    {
        ...
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling articleRatingIdIdPut'
            );
        }
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function articleRatingPost($custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingPost'][0])
    {
        list($response) = $this->articleRatingPostWithHttpInfo($custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function articleRatingPostWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingPost'][0])
    {
        $request = $this->articleRatingPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleRatingPostAsync($custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingPost'][0])
    {
        return $this->articleRatingPostAsyncWithHttpInfo($custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleRatingPostAsyncWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->articleRatingPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleRatingPostRequest($custom_value, $dry_run = null, string $contentType = self::contentTypes['articleRatingPost'][0])
    {

        // verify the required parameter 'custom_value' is set
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling articleRatingPost'
            );
        }

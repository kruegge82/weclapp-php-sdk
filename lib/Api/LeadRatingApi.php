...
/**
 * LeadRatingApi Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
...
class LeadRatingApi
{
    ...
    /**
     * Operation leadRatingCountGet
     *
     * count leadRating
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function leadRatingCountGet($filter = null, string $contentType = self::contentTypes['leadRatingCountGet'][0])
    {
        list($response) = $this->leadRatingCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation leadRatingCountGetWithHttpInfo
     *
     * count leadRating
     *
     ...
     */
    public function leadRatingCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['leadRatingCountGet'][0])
    {
        $request = $this->leadRatingCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation leadRatingCountGetAsync
     *
     * count leadRating
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function leadRatingCountGetAsync($filter = null, string $contentType = self::contentTypes['leadRatingCountGet'][0])
    {
        return $this->leadRatingCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation leadRatingCountGetAsyncWithHttpInfo
     *
     * count leadRating
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['leadRatingCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->leadRatingCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'leadRatingCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function leadRatingCountGetRequest($filter = null, string $contentType = self::contentTypes['leadRatingCountGet'][0])
    {



        $resourcePath = '/leadRating/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function leadRatingGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['leadRatingGet'][0])
    {
        list($response) = $this->leadRatingGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation leadRatingGetWithHttpInfo
     *
     * query leadRating
     *
     ...
     */
    public function leadRatingGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['leadRatingGet'][0])
    {
        $request = $this->leadRatingGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['leadRatingGet'][0])
    {
        return $this->leadRatingGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation leadRatingGetAsyncWithHttpInfo
     *
     * query leadRating
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['leadRatingGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response';
        $request = $this->leadRatingGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'leadRatingGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function leadRatingGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['leadRatingGet'][0])
    {
    ...
    /**
     * Operation leadRatingIdIdDelete
     *
     * delete a leadRating
     *
     * @param  string $id id (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingIdIdDelete'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function leadRatingIdIdDelete($id, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdDelete'][0])
    {
        $this->leadRatingIdIdDeleteWithHttpInfo($id, $dry_run, $contentType);
    }

    /**
     * Operation leadRatingIdIdDeleteWithHttpInfo
     *
     * delete a leadRating
     *
     ...
     */
    public function leadRatingIdIdDeleteWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdDelete'][0])
    {
        $request = $this->leadRatingIdIdDeleteRequest($id, $dry_run, $contentType);
    ...
    /**
     * Operation leadRatingIdIdDeleteAsync
     *
     * delete a leadRating
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingIdIdDeleteAsync($id, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdDelete'][0])
    {
        return $this->leadRatingIdIdDeleteAsyncWithHttpInfo($id, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation leadRatingIdIdDeleteAsyncWithHttpInfo
     *
     * delete a leadRating
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingIdIdDeleteAsyncWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdDelete'][0])
    {
        $returnType = '';
        $request = $this->leadRatingIdIdDeleteRequest($id, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'leadRatingIdIdDelete'
     *
     * @param  string $id (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingIdIdDelete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function leadRatingIdIdDeleteRequest($id, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling leadRatingIdIdDelete'
            );
        }



        $resourcePath = '/leadRating/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation leadRatingIdIdGet
     *
     * query a specific leadRating
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function leadRatingIdIdGet($id, string $contentType = self::contentTypes['leadRatingIdIdGet'][0])
    {
        list($response) = $this->leadRatingIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation leadRatingIdIdGetWithHttpInfo
     *
     * query a specific leadRating
     *
     * @param  string $id (required)
     ...
     */
    public function leadRatingIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['leadRatingIdIdGet'][0])
    {
        $request = $this->leadRatingIdIdGetRequest($id, $contentType);
    ...
    /**
     * Operation leadRatingIdIdGetAsync
     *
     * query a specific leadRating
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingIdIdGetAsync($id, string $contentType = self::contentTypes['leadRatingIdIdGet'][0])
    {
        return $this->leadRatingIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation leadRatingIdIdGetAsyncWithHttpInfo
     *
     * query a specific leadRating
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['leadRatingIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->leadRatingIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'leadRatingIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function leadRatingIdIdGetRequest($id, string $contentType = self::contentTypes['leadRatingIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling leadRatingIdIdGet'
            );
        }
     ...
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function leadRatingIdIdPut($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdPut'][0])
    {
        list($response) = $this->leadRatingIdIdPutWithHttpInfo($id, $custom_value, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation leadRatingIdIdPutWithHttpInfo
     *
     * update a leadRating
     *
     * @param  string $id (required)
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function leadRatingIdIdPutWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdPut'][0])
    {
        $request = $this->leadRatingIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
    ...
    /**
     * Operation leadRatingIdIdPutAsync
     *
     * update a leadRating
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingIdIdPutAsync($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdPut'][0])
    {
        return $this->leadRatingIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation leadRatingIdIdPutAsyncWithHttpInfo
     *
     * update a leadRating
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->leadRatingIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'leadRatingIdIdPut'
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value (required)
     * @param  bool|null $dry_run (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function leadRatingIdIdPutRequest($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingIdIdPut'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling leadRatingIdIdPut'
            );
        }
        ...
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling leadRatingIdIdPut'
            );
        }
    ...
    /**
     * Operation leadRatingPost
     *
     * create a leadRating
     *
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value custom_value (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function leadRatingPost($custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingPost'][0])
    {
        list($response) = $this->leadRatingPostWithHttpInfo($custom_value, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation leadRatingPostWithHttpInfo
     *
     * create a leadRating
     *
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value (required)
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function leadRatingPostWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingPost'][0])
    {
        $request = $this->leadRatingPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingPostAsync($custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingPost'][0])
    {
        return $this->leadRatingPostAsyncWithHttpInfo($custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation leadRatingPostAsyncWithHttpInfo
     *
     * create a leadRating
     *
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadRatingPostAsyncWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->leadRatingPostRequest($custom_value, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'leadRatingPost'
     *
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadRatingPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function leadRatingPostRequest($custom_value, $dry_run = null, string $contentType = self::contentTypes['leadRatingPost'][0])
    {

        // verify the required parameter 'custom_value' is set
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling leadRatingPost'
            );
        }

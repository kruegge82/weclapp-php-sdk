...
class CalendarEventApi
{
     ...
     */
    public function calendarEventCountGet($filter = null, string $contentType = self::contentTypes['calendarEventCountGet'][0])
    {
        list($response) = $this->calendarEventCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function calendarEventCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['calendarEventCountGet'][0])
    {
        $request = $this->calendarEventCountGetRequest($filter, $contentType);
     ...
     */
    public function calendarEventCountGetAsync($filter = null, string $contentType = self::contentTypes['calendarEventCountGet'][0])
    {
        return $this->calendarEventCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarEventCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['calendarEventCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->calendarEventCountGetRequest($filter, $contentType);
     ...
     */
    public function calendarEventCountGetRequest($filter = null, string $contentType = self::contentTypes['calendarEventCountGet'][0])
    {
     ...
     */
    public function calendarEventGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['calendarEventGet'][0])
    {
        list($response) = $this->calendarEventGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function calendarEventGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['calendarEventGet'][0])
    {
        $request = $this->calendarEventGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\CalendarEventGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\CalendarEventGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\CalendarEventGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarEventGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['calendarEventGet'][0])
    {
        return $this->calendarEventGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarEventGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['calendarEventGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CalendarEventGet200Response';
        $request = $this->calendarEventGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarEventGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['calendarEventGet'][0])
    {
    ...
    public function calendarEventIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['calendarEventIdIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\CalendarEvent' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\CalendarEvent' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\CalendarEvent', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\CalendarEvent $calendar_event calendar_event (required)
     * @param  bool|null $dry_run dry_run (optional)
     ...
     * @return \kruegge82\weclapp\Model\CalendarEvent|\kruegge82\weclapp\Model\ApiProblem
     */
    public function calendarEventIdIdPut($id, $calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventIdIdPut'][0])
    {
        list($response) = $this->calendarEventIdIdPutWithHttpInfo($id, $calendar_event, $dry_run, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\CalendarEvent $calendar_event (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarEventIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\CalendarEvent|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarEventIdIdPutWithHttpInfo($id, $calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventIdIdPut'][0])
    {
        $request = $this->calendarEventIdIdPutRequest($id, $calendar_event, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarEventIdIdPutAsync($id, $calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventIdIdPut'][0])
    {
        return $this->calendarEventIdIdPutAsyncWithHttpInfo($id, $calendar_event, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarEventIdIdPutAsyncWithHttpInfo($id, $calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CalendarEvent';
        $request = $this->calendarEventIdIdPutRequest($id, $calendar_event, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarEventIdIdPutRequest($id, $calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventIdIdPut'][0])
    {
        ...
        // verify the required parameter 'calendar_event' is set
        if ($calendar_event === null || (is_array($calendar_event) && count($calendar_event) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_event when calling calendarEventIdIdPut'
            );
        }
        ...
        if (isset($calendar_event)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($calendar_event));
            } else {
                $httpBody = $calendar_event;
            }
     ...
     * @return \kruegge82\weclapp\Model\CalendarEvent|\kruegge82\weclapp\Model\ApiProblem
     */
    public function calendarEventPost($calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventPost'][0])
    {
        list($response) = $this->calendarEventPostWithHttpInfo($calendar_event, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CalendarEvent|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarEventPostWithHttpInfo($calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventPost'][0])
    {
        $request = $this->calendarEventPostRequest($calendar_event, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarEventPostAsync($calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventPost'][0])
    {
        return $this->calendarEventPostAsyncWithHttpInfo($calendar_event, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarEventPostAsyncWithHttpInfo($calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CalendarEvent';
        $request = $this->calendarEventPostRequest($calendar_event, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarEventPostRequest($calendar_event, $dry_run = null, string $contentType = self::contentTypes['calendarEventPost'][0])
    {

        // verify the required parameter 'calendar_event' is set
        if ($calendar_event === null || (is_array($calendar_event) && count($calendar_event) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_event when calling calendarEventPost'
            );
        }

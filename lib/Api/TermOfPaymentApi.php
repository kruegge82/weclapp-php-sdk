...
/**
 * TermOfPaymentApi Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
...
class TermOfPaymentApi
{
    ...
    /**
     * Operation termOfPaymentCountGet
     *
     * count termOfPayment
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function termOfPaymentCountGet($filter = null, string $contentType = self::contentTypes['termOfPaymentCountGet'][0])
    {
        list($response) = $this->termOfPaymentCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation termOfPaymentCountGetWithHttpInfo
     *
     * count termOfPayment
     *
     ...
     */
    public function termOfPaymentCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['termOfPaymentCountGet'][0])
    {
        $request = $this->termOfPaymentCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation termOfPaymentCountGetAsync
     *
     * count termOfPayment
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function termOfPaymentCountGetAsync($filter = null, string $contentType = self::contentTypes['termOfPaymentCountGet'][0])
    {
        return $this->termOfPaymentCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation termOfPaymentCountGetAsyncWithHttpInfo
     *
     * count termOfPayment
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['termOfPaymentCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->termOfPaymentCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'termOfPaymentCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function termOfPaymentCountGetRequest($filter = null, string $contentType = self::contentTypes['termOfPaymentCountGet'][0])
    {



        $resourcePath = '/termOfPayment/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\TermOfPaymentGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function termOfPaymentGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['termOfPaymentGet'][0])
    {
        list($response) = $this->termOfPaymentGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation termOfPaymentGetWithHttpInfo
     *
     * query termOfPayment
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\TermOfPaymentGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function termOfPaymentGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['termOfPaymentGet'][0])
    {
        $request = $this->termOfPaymentGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\TermOfPaymentGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\TermOfPaymentGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\TermOfPaymentGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\TermOfPaymentGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\TermOfPaymentGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation termOfPaymentGetAsync
     *
     * query termOfPayment
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['termOfPaymentGet'][0])
    {
        return $this->termOfPaymentGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation termOfPaymentGetAsyncWithHttpInfo
     *
     * query termOfPayment
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['termOfPaymentGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TermOfPaymentGet200Response';
        $request = $this->termOfPaymentGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'termOfPaymentGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function termOfPaymentGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['termOfPaymentGet'][0])
    {
    ...
    /**
     * Operation termOfPaymentIdIdDelete
     *
     * delete a termOfPayment
     *
     * @param  string $id id (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentIdIdDelete'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function termOfPaymentIdIdDelete($id, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdDelete'][0])
    {
        $this->termOfPaymentIdIdDeleteWithHttpInfo($id, $dry_run, $contentType);
    }

    /**
     * Operation termOfPaymentIdIdDeleteWithHttpInfo
     *
     * delete a termOfPayment
     *
     ...
     */
    public function termOfPaymentIdIdDeleteWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdDelete'][0])
    {
        $request = $this->termOfPaymentIdIdDeleteRequest($id, $dry_run, $contentType);
    ...
    /**
     * Operation termOfPaymentIdIdDeleteAsync
     *
     * delete a termOfPayment
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentIdIdDeleteAsync($id, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdDelete'][0])
    {
        return $this->termOfPaymentIdIdDeleteAsyncWithHttpInfo($id, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation termOfPaymentIdIdDeleteAsyncWithHttpInfo
     *
     * delete a termOfPayment
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentIdIdDeleteAsyncWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdDelete'][0])
    {
        $returnType = '';
        $request = $this->termOfPaymentIdIdDeleteRequest($id, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'termOfPaymentIdIdDelete'
     *
     * @param  string $id (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentIdIdDelete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function termOfPaymentIdIdDeleteRequest($id, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling termOfPaymentIdIdDelete'
            );
        }



        $resourcePath = '/termOfPayment/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation termOfPaymentIdIdGet
     *
     * query a specific termOfPayment
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\TermOfPayment|\kruegge82\weclapp\Model\ApiProblem
     */
    public function termOfPaymentIdIdGet($id, string $contentType = self::contentTypes['termOfPaymentIdIdGet'][0])
    {
        list($response) = $this->termOfPaymentIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation termOfPaymentIdIdGetWithHttpInfo
     *
     * query a specific termOfPayment
     *
     * @param  string $id (required)
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\TermOfPayment|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function termOfPaymentIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['termOfPaymentIdIdGet'][0])
    {
        $request = $this->termOfPaymentIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\TermOfPayment' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\TermOfPayment' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\TermOfPayment', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\TermOfPayment';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\TermOfPayment',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation termOfPaymentIdIdGetAsync
     *
     * query a specific termOfPayment
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentIdIdGetAsync($id, string $contentType = self::contentTypes['termOfPaymentIdIdGet'][0])
    {
        return $this->termOfPaymentIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation termOfPaymentIdIdGetAsyncWithHttpInfo
     *
     * query a specific termOfPayment
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['termOfPaymentIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TermOfPayment';
        $request = $this->termOfPaymentIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'termOfPaymentIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function termOfPaymentIdIdGetRequest($id, string $contentType = self::contentTypes['termOfPaymentIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling termOfPaymentIdIdGet'
            );
        }
    ...
    /**
     * Operation termOfPaymentIdIdPut
     *
     * update a termOfPayment
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\TermOfPayment $term_of_payment term_of_payment (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\TermOfPayment|\kruegge82\weclapp\Model\ApiProblem
     */
    public function termOfPaymentIdIdPut($id, $term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdPut'][0])
    {
        list($response) = $this->termOfPaymentIdIdPutWithHttpInfo($id, $term_of_payment, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation termOfPaymentIdIdPutWithHttpInfo
     *
     * update a termOfPayment
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\TermOfPayment $term_of_payment (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\TermOfPayment|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function termOfPaymentIdIdPutWithHttpInfo($id, $term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdPut'][0])
    {
        $request = $this->termOfPaymentIdIdPutRequest($id, $term_of_payment, $dry_run, $contentType);
    ...
    /**
     * Operation termOfPaymentIdIdPutAsync
     *
     * update a termOfPayment
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentIdIdPutAsync($id, $term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdPut'][0])
    {
        return $this->termOfPaymentIdIdPutAsyncWithHttpInfo($id, $term_of_payment, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation termOfPaymentIdIdPutAsyncWithHttpInfo
     *
     * update a termOfPayment
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentIdIdPutAsyncWithHttpInfo($id, $term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TermOfPayment';
        $request = $this->termOfPaymentIdIdPutRequest($id, $term_of_payment, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'termOfPaymentIdIdPut'
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\TermOfPayment $term_of_payment (required)
     * @param  bool|null $dry_run (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function termOfPaymentIdIdPutRequest($id, $term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentIdIdPut'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling termOfPaymentIdIdPut'
            );
        }

        // verify the required parameter 'term_of_payment' is set
        if ($term_of_payment === null || (is_array($term_of_payment) && count($term_of_payment) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $term_of_payment when calling termOfPaymentIdIdPut'
            );
        }
    ...
    /**
     * Operation termOfPaymentPost
     *
     * create a termOfPayment
     *
     * @param  \kruegge82\weclapp\Model\TermOfPayment $term_of_payment term_of_payment (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\TermOfPayment|\kruegge82\weclapp\Model\ApiProblem
     */
    public function termOfPaymentPost($term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentPost'][0])
    {
        list($response) = $this->termOfPaymentPostWithHttpInfo($term_of_payment, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation termOfPaymentPostWithHttpInfo
     *
     * create a termOfPayment
     *
     * @param  \kruegge82\weclapp\Model\TermOfPayment $term_of_payment (required)
     ...
     * @return array of \kruegge82\weclapp\Model\TermOfPayment|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function termOfPaymentPostWithHttpInfo($term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentPost'][0])
    {
        $request = $this->termOfPaymentPostRequest($term_of_payment, $dry_run, $contentType);
    ...
    /**
     * Operation termOfPaymentPostAsync
     *
     * create a termOfPayment
     *
     * @param  \kruegge82\weclapp\Model\TermOfPayment $term_of_payment (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentPostAsync($term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentPost'][0])
    {
        return $this->termOfPaymentPostAsyncWithHttpInfo($term_of_payment, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation termOfPaymentPostAsyncWithHttpInfo
     *
     * create a termOfPayment
     *
     * @param  \kruegge82\weclapp\Model\TermOfPayment $term_of_payment (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function termOfPaymentPostAsyncWithHttpInfo($term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TermOfPayment';
        $request = $this->termOfPaymentPostRequest($term_of_payment, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'termOfPaymentPost'
     *
     * @param  \kruegge82\weclapp\Model\TermOfPayment $term_of_payment (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['termOfPaymentPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function termOfPaymentPostRequest($term_of_payment, $dry_run = null, string $contentType = self::contentTypes['termOfPaymentPost'][0])
    {

        // verify the required parameter 'term_of_payment' is set
        if ($term_of_payment === null || (is_array($term_of_payment) && count($term_of_payment) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $term_of_payment when calling termOfPaymentPost'
            );
        }

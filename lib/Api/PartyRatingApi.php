...
class PartyRatingApi
{
     ...
     */
    public function partyRatingCountGet($filter = null, string $contentType = self::contentTypes['partyRatingCountGet'][0])
    {
        list($response) = $this->partyRatingCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function partyRatingCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['partyRatingCountGet'][0])
    {
        $request = $this->partyRatingCountGetRequest($filter, $contentType);
     ...
     */
    public function partyRatingCountGetAsync($filter = null, string $contentType = self::contentTypes['partyRatingCountGet'][0])
    {
        return $this->partyRatingCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partyRatingCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['partyRatingCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->partyRatingCountGetRequest($filter, $contentType);
     ...
     */
    public function partyRatingCountGetRequest($filter = null, string $contentType = self::contentTypes['partyRatingCountGet'][0])
    {
     ...
     */
    public function partyRatingGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['partyRatingGet'][0])
    {
        list($response) = $this->partyRatingGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function partyRatingGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['partyRatingGet'][0])
    {
        $request = $this->partyRatingGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partyRatingGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['partyRatingGet'][0])
    {
        return $this->partyRatingGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partyRatingGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['partyRatingGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response';
        $request = $this->partyRatingGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function partyRatingGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['partyRatingGet'][0])
    {
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function partyRatingIdIdPut($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingIdIdPut'][0])
    {
        list($response) = $this->partyRatingIdIdPutWithHttpInfo($id, $custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function partyRatingIdIdPutWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingIdIdPut'][0])
    {
        $request = $this->partyRatingIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partyRatingIdIdPutAsync($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingIdIdPut'][0])
    {
        return $this->partyRatingIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partyRatingIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->partyRatingIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function partyRatingIdIdPutRequest($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingIdIdPut'][0])
    {
        ...
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling partyRatingIdIdPut'
            );
        }
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function partyRatingPost($custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingPost'][0])
    {
        list($response) = $this->partyRatingPostWithHttpInfo($custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function partyRatingPostWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingPost'][0])
    {
        $request = $this->partyRatingPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partyRatingPostAsync($custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingPost'][0])
    {
        return $this->partyRatingPostAsyncWithHttpInfo($custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partyRatingPostAsyncWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->partyRatingPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function partyRatingPostRequest($custom_value, $dry_run = null, string $contentType = self::contentTypes['partyRatingPost'][0])
    {

        // verify the required parameter 'custom_value' is set
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling partyRatingPost'
            );
        }

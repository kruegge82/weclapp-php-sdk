...
class SalesOrderApi
{
    ...
    /**
     * Operation salesOrderIdIdCreatePerformanceRecordPost
     *
     * @param  string $id id (required)
     * @param  object $body body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function salesOrderIdIdCreatePerformanceRecordPost($id, $body, string $contentType = self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'][0])
    {
        list($response) = $this->salesOrderIdIdCreatePerformanceRecordPostWithHttpInfo($id, $body, $contentType);
        return $response;
    }

    /**
     * Operation salesOrderIdIdCreatePerformanceRecordPostWithHttpInfo
     *
     * @param  string $id (required)
     * @param  object $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'] to see the possible values for this operation
     ...
     */
    public function salesOrderIdIdCreatePerformanceRecordPostWithHttpInfo($id, $body, string $contentType = self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'][0])
    {
        $request = $this->salesOrderIdIdCreatePerformanceRecordPostRequest($id, $body, $contentType);
    ...
    /**
     * Operation salesOrderIdIdCreatePerformanceRecordPostAsync
     *
     * @param  string $id (required)
     * @param  object $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function salesOrderIdIdCreatePerformanceRecordPostAsync($id, $body, string $contentType = self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'][0])
    {
        return $this->salesOrderIdIdCreatePerformanceRecordPostAsyncWithHttpInfo($id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation salesOrderIdIdCreatePerformanceRecordPostAsyncWithHttpInfo
     *
     * @param  string $id (required)
     * @param  object $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function salesOrderIdIdCreatePerformanceRecordPostAsyncWithHttpInfo($id, $body, string $contentType = self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'][0])
    {
    ...
    /**
     * Create request for operation 'salesOrderIdIdCreatePerformanceRecordPost'
     *
     * @param  string $id (required)
     * @param  object $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function salesOrderIdIdCreatePerformanceRecordPostRequest($id, $body, string $contentType = self::contentTypes['salesOrderIdIdCreatePerformanceRecordPost'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling salesOrderIdIdCreatePerformanceRecordPost'
            );
        }
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling salesOrderIdIdCreatePerformanceRecordPost'
            );
        }


        $resourcePath = '/salesOrder/id/{id}/createPerformanceRecord';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \kruegge82\weclapp\Model\SalesOrder|\kruegge82\weclapp\Model\ApiProblem
     */
    public function salesOrderIdIdPut($id, $sales_order, $dry_run = null, $ignore_missing_properties = null, string $contentType = self::contentTypes['salesOrderIdIdPut'][0])
    {
        list($response) = $this->salesOrderIdIdPutWithHttpInfo($id, $sales_order, $dry_run, $ignore_missing_properties, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\SalesOrder|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function salesOrderIdIdPutWithHttpInfo($id, $sales_order, $dry_run = null, $ignore_missing_properties = null, string $contentType = self::contentTypes['salesOrderIdIdPut'][0])
    {
        $request = $this->salesOrderIdIdPutRequest($id, $sales_order, $dry_run, $ignore_missing_properties, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function salesOrderIdIdPutAsync($id, $sales_order, $dry_run = null, $ignore_missing_properties = null, string $contentType = self::contentTypes['salesOrderIdIdPut'][0])
    {
        return $this->salesOrderIdIdPutAsyncWithHttpInfo($id, $sales_order, $dry_run, $ignore_missing_properties, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function salesOrderIdIdPutAsyncWithHttpInfo($id, $sales_order, $dry_run = null, $ignore_missing_properties = null, string $contentType = self::contentTypes['salesOrderIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\SalesOrder';
        $request = $this->salesOrderIdIdPutRequest($id, $sales_order, $dry_run, $ignore_missing_properties, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function salesOrderIdIdPutRequest($id, $sales_order, $dry_run = null, $ignore_missing_properties = null, string $contentType = self::contentTypes['salesOrderIdIdPut'][0])
    {

...
class CustomerLeadLossReasonApi
{
     ...
     */
    public function customerLeadLossReasonCountGet($filter = null, string $contentType = self::contentTypes['customerLeadLossReasonCountGet'][0])
    {
        list($response) = $this->customerLeadLossReasonCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function customerLeadLossReasonCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['customerLeadLossReasonCountGet'][0])
    {
        $request = $this->customerLeadLossReasonCountGetRequest($filter, $contentType);
     ...
     */
    public function customerLeadLossReasonCountGetAsync($filter = null, string $contentType = self::contentTypes['customerLeadLossReasonCountGet'][0])
    {
        return $this->customerLeadLossReasonCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerLeadLossReasonCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['customerLeadLossReasonCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->customerLeadLossReasonCountGetRequest($filter, $contentType);
     ...
     */
    public function customerLeadLossReasonCountGetRequest($filter = null, string $contentType = self::contentTypes['customerLeadLossReasonCountGet'][0])
    {
     ...
     */
    public function customerLeadLossReasonGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerLeadLossReasonGet'][0])
    {
        list($response) = $this->customerLeadLossReasonGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function customerLeadLossReasonGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerLeadLossReasonGet'][0])
    {
        $request = $this->customerLeadLossReasonGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerLeadLossReasonGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerLeadLossReasonGet'][0])
    {
        return $this->customerLeadLossReasonGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerLeadLossReasonGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerLeadLossReasonGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response';
        $request = $this->customerLeadLossReasonGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerLeadLossReasonGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerLeadLossReasonGet'][0])
    {
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function customerLeadLossReasonIdIdPut($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonIdIdPut'][0])
    {
        list($response) = $this->customerLeadLossReasonIdIdPutWithHttpInfo($id, $custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerLeadLossReasonIdIdPutWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonIdIdPut'][0])
    {
        $request = $this->customerLeadLossReasonIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerLeadLossReasonIdIdPutAsync($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonIdIdPut'][0])
    {
        return $this->customerLeadLossReasonIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerLeadLossReasonIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->customerLeadLossReasonIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerLeadLossReasonIdIdPutRequest($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonIdIdPut'][0])
    {
        ...
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling customerLeadLossReasonIdIdPut'
            );
        }
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function customerLeadLossReasonPost($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonPost'][0])
    {
        list($response) = $this->customerLeadLossReasonPostWithHttpInfo($custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerLeadLossReasonPostWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonPost'][0])
    {
        $request = $this->customerLeadLossReasonPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerLeadLossReasonPostAsync($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonPost'][0])
    {
        return $this->customerLeadLossReasonPostAsyncWithHttpInfo($custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerLeadLossReasonPostAsyncWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->customerLeadLossReasonPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerLeadLossReasonPostRequest($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerLeadLossReasonPost'][0])
    {

        // verify the required parameter 'custom_value' is set
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling customerLeadLossReasonPost'
            );
        }

...
class CurrencyApi
{
    ...
    public function currencyCompanyCurrencyGetWithHttpInfo(string $contentType = self::contentTypes['currencyCompanyCurrencyGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\CurrencyCompanyCurrencyGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\CurrencyCompanyCurrencyGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\CurrencyCompanyCurrencyGet200Response', []),
     ...
     */
    public function currencyCountGet($filter = null, string $contentType = self::contentTypes['currencyCountGet'][0])
    {
        list($response) = $this->currencyCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function currencyCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['currencyCountGet'][0])
    {
        $request = $this->currencyCountGetRequest($filter, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currencyCountGetAsync($filter = null, string $contentType = self::contentTypes['currencyCountGet'][0])
    {
        return $this->currencyCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currencyCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['currencyCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->currencyCountGetRequest($filter, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function currencyCountGetRequest($filter = null, string $contentType = self::contentTypes['currencyCountGet'][0])
    {
     ...
     */
    public function currencyGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['currencyGet'][0])
    {
        list($response) = $this->currencyGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function currencyGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['currencyGet'][0])
    {
        $request = $this->currencyGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\CurrencyGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\CurrencyGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\CurrencyGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currencyGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['currencyGet'][0])
    {
        return $this->currencyGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currencyGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['currencyGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CurrencyGet200Response';
        $request = $this->currencyGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function currencyGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['currencyGet'][0])
    {
    ...
    public function currencyIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['currencyIdIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\Currency' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\Currency' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\Currency', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\Currency $currency currency (required)
     * @param  bool|null $dry_run dry_run (optional)
     ...
     * @return \kruegge82\weclapp\Model\Currency|\kruegge82\weclapp\Model\ApiProblem
     */
    public function currencyIdIdPut($id, $currency, $dry_run = null, string $contentType = self::contentTypes['currencyIdIdPut'][0])
    {
        list($response) = $this->currencyIdIdPutWithHttpInfo($id, $currency, $dry_run, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\Currency $currency (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['currencyIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\Currency|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function currencyIdIdPutWithHttpInfo($id, $currency, $dry_run = null, string $contentType = self::contentTypes['currencyIdIdPut'][0])
    {
        $request = $this->currencyIdIdPutRequest($id, $currency, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currencyIdIdPutAsync($id, $currency, $dry_run = null, string $contentType = self::contentTypes['currencyIdIdPut'][0])
    {
        return $this->currencyIdIdPutAsyncWithHttpInfo($id, $currency, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currencyIdIdPutAsyncWithHttpInfo($id, $currency, $dry_run = null, string $contentType = self::contentTypes['currencyIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\Currency';
        $request = $this->currencyIdIdPutRequest($id, $currency, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function currencyIdIdPutRequest($id, $currency, $dry_run = null, string $contentType = self::contentTypes['currencyIdIdPut'][0])
    {
        ...
        if ($currency === null || (is_array($currency) && count($currency) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency when calling currencyIdIdPut'
            );
        }
     ...
     * @return \kruegge82\weclapp\Model\Currency|\kruegge82\weclapp\Model\ApiProblem
     */
    public function currencyPost($currency, $dry_run = null, string $contentType = self::contentTypes['currencyPost'][0])
    {
        list($response) = $this->currencyPostWithHttpInfo($currency, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\Currency|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function currencyPostWithHttpInfo($currency, $dry_run = null, string $contentType = self::contentTypes['currencyPost'][0])
    {
        $request = $this->currencyPostRequest($currency, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currencyPostAsync($currency, $dry_run = null, string $contentType = self::contentTypes['currencyPost'][0])
    {
        return $this->currencyPostAsyncWithHttpInfo($currency, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currencyPostAsyncWithHttpInfo($currency, $dry_run = null, string $contentType = self::contentTypes['currencyPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\Currency';
        $request = $this->currencyPostRequest($currency, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function currencyPostRequest($currency, $dry_run = null, string $contentType = self::contentTypes['currencyPost'][0])
    {

        // verify the required parameter 'currency' is set
        if ($currency === null || (is_array($currency) && count($currency) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency when calling currencyPost'
            );
        }

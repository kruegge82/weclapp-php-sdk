...
/**
 * InventoryGroupApi Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
...
class InventoryGroupApi
{
    ...
    public const contentTypes = [
        'inventoryGroupCountGet' => [
            'application/json',
        ],
        'inventoryGroupGet' => [
            'application/json',
        ],
        'inventoryGroupIdIdGet' => [
            'application/json',
        ],
    ];
    ...
    /**
     * Operation inventoryGroupCountGet
     *
     * count inventoryGroup
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['inventoryGroupCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function inventoryGroupCountGet($filter = null, string $contentType = self::contentTypes['inventoryGroupCountGet'][0])
    {
        list($response) = $this->inventoryGroupCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation inventoryGroupCountGetWithHttpInfo
     *
     * count inventoryGroup
     *
     ...
     */
    public function inventoryGroupCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['inventoryGroupCountGet'][0])
    {
        $request = $this->inventoryGroupCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation inventoryGroupCountGetAsync
     *
     * count inventoryGroup
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function inventoryGroupCountGetAsync($filter = null, string $contentType = self::contentTypes['inventoryGroupCountGet'][0])
    {
        return $this->inventoryGroupCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation inventoryGroupCountGetAsyncWithHttpInfo
     *
     * count inventoryGroup
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryGroupCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['inventoryGroupCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->inventoryGroupCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'inventoryGroupCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['inventoryGroupCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function inventoryGroupCountGetRequest($filter = null, string $contentType = self::contentTypes['inventoryGroupCountGet'][0])
    {



        $resourcePath = '/inventoryGroup/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['inventoryGroupGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\InventoryGroupGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function inventoryGroupGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['inventoryGroupGet'][0])
    {
        list($response) = $this->inventoryGroupGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation inventoryGroupGetWithHttpInfo
     *
     * query inventoryGroup
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\InventoryGroupGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function inventoryGroupGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['inventoryGroupGet'][0])
    {
        $request = $this->inventoryGroupGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\InventoryGroupGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\InventoryGroupGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\InventoryGroupGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\InventoryGroupGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\InventoryGroupGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation inventoryGroupGetAsync
     *
     * query inventoryGroup
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryGroupGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['inventoryGroupGet'][0])
    {
        return $this->inventoryGroupGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation inventoryGroupGetAsyncWithHttpInfo
     *
     * query inventoryGroup
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryGroupGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['inventoryGroupGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\InventoryGroupGet200Response';
        $request = $this->inventoryGroupGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'inventoryGroupGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function inventoryGroupGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['inventoryGroupGet'][0])
    {
    ...
    /**
     * Operation inventoryGroupIdIdGet
     *
     * query a specific inventoryGroup
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['inventoryGroupIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\InventoryGroup|\kruegge82\weclapp\Model\ApiProblem
     */
    public function inventoryGroupIdIdGet($id, string $contentType = self::contentTypes['inventoryGroupIdIdGet'][0])
    {
        list($response) = $this->inventoryGroupIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation inventoryGroupIdIdGetWithHttpInfo
     *
     * query a specific inventoryGroup
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\InventoryGroup|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function inventoryGroupIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['inventoryGroupIdIdGet'][0])
    {
        $request = $this->inventoryGroupIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\InventoryGroup' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\InventoryGroup' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\InventoryGroup', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\InventoryGroup';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\InventoryGroup',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation inventoryGroupIdIdGetAsync
     *
     * query a specific inventoryGroup
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryGroupIdIdGetAsync($id, string $contentType = self::contentTypes['inventoryGroupIdIdGet'][0])
    {
        return $this->inventoryGroupIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation inventoryGroupIdIdGetAsyncWithHttpInfo
     *
     * query a specific inventoryGroup
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryGroupIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['inventoryGroupIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\InventoryGroup';
        $request = $this->inventoryGroupIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'inventoryGroupIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['inventoryGroupIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function inventoryGroupIdIdGetRequest($id, string $contentType = self::contentTypes['inventoryGroupIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling inventoryGroupIdIdGet'
            );
        }


        $resourcePath = '/inventoryGroup/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

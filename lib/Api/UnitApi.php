...
class UnitApi
{
    ...
    /**
     * Operation unitCountGet
     *
     * count unit
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function unitCountGet($filter = null, string $contentType = self::contentTypes['unitCountGet'][0])
    {
        list($response) = $this->unitCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation unitCountGetWithHttpInfo
     *
     * count unit
     *
     ...
     */
    public function unitCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['unitCountGet'][0])
    {
        $request = $this->unitCountGetRequest($filter, $contentType);
     ...
     */
    public function unitCountGetAsync($filter = null, string $contentType = self::contentTypes['unitCountGet'][0])
    {
        return $this->unitCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unitCountGetAsyncWithHttpInfo
     *
     * count unit
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['unitCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->unitCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'unitCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function unitCountGetRequest($filter = null, string $contentType = self::contentTypes['unitCountGet'][0])
    {



        $resourcePath = '/unit/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\UnitGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function unitGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['unitGet'][0])
    {
        list($response) = $this->unitGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\UnitGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function unitGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['unitGet'][0])
    {
        $request = $this->unitGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\UnitGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\UnitGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\UnitGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\UnitGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\UnitGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['unitGet'][0])
    {
        return $this->unitGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unitGetAsyncWithHttpInfo
     *
     * query unit
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['unitGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\UnitGet200Response';
        $request = $this->unitGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'unitGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unitGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['unitGet'][0])
    {
    ...
    /**
     * Operation unitIdIdDelete
     *
     * delete a unit
     *
     * @param  string $id id (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitIdIdDelete'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function unitIdIdDelete($id, $dry_run = null, string $contentType = self::contentTypes['unitIdIdDelete'][0])
    {
        $this->unitIdIdDeleteWithHttpInfo($id, $dry_run, $contentType);
    }

    /**
     * Operation unitIdIdDeleteWithHttpInfo
     *
     * delete a unit
     *
     ...
     */
    public function unitIdIdDeleteWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['unitIdIdDelete'][0])
    {
        $request = $this->unitIdIdDeleteRequest($id, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitIdIdDeleteAsync($id, $dry_run = null, string $contentType = self::contentTypes['unitIdIdDelete'][0])
    {
        return $this->unitIdIdDeleteAsyncWithHttpInfo($id, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unitIdIdDeleteAsyncWithHttpInfo
     *
     * delete a unit
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitIdIdDeleteAsyncWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['unitIdIdDelete'][0])
    {
        $returnType = '';
        $request = $this->unitIdIdDeleteRequest($id, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'unitIdIdDelete'
     *
     * @param  string $id (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitIdIdDelete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unitIdIdDeleteRequest($id, $dry_run = null, string $contentType = self::contentTypes['unitIdIdDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling unitIdIdDelete'
            );
        }



        $resourcePath = '/unit/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation unitIdIdGet
     *
     * query a specific unit
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\Unit|\kruegge82\weclapp\Model\ApiProblem
     */
    public function unitIdIdGet($id, string $contentType = self::contentTypes['unitIdIdGet'][0])
    {
        list($response) = $this->unitIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation unitIdIdGetWithHttpInfo
     *
     * query a specific unit
     *
     * @param  string $id (required)
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\Unit|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function unitIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['unitIdIdGet'][0])
    {
        $request = $this->unitIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\Unit' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\Unit' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\Unit', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\Unit';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitIdIdGetAsync($id, string $contentType = self::contentTypes['unitIdIdGet'][0])
    {
        return $this->unitIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unitIdIdGetAsyncWithHttpInfo
     *
     * query a specific unit
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['unitIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\Unit';
        $request = $this->unitIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'unitIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unitIdIdGetRequest($id, string $contentType = self::contentTypes['unitIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling unitIdIdGet'
            );
        }
    ...
    /**
     * Operation unitIdIdPut
     *
     * update a unit
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\Unit $unit unit (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\Unit|\kruegge82\weclapp\Model\ApiProblem
     */
    public function unitIdIdPut($id, $unit, $dry_run = null, string $contentType = self::contentTypes['unitIdIdPut'][0])
    {
        list($response) = $this->unitIdIdPutWithHttpInfo($id, $unit, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation unitIdIdPutWithHttpInfo
     *
     * update a unit
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\Unit $unit (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\Unit|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function unitIdIdPutWithHttpInfo($id, $unit, $dry_run = null, string $contentType = self::contentTypes['unitIdIdPut'][0])
    {
        $request = $this->unitIdIdPutRequest($id, $unit, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitIdIdPutAsync($id, $unit, $dry_run = null, string $contentType = self::contentTypes['unitIdIdPut'][0])
    {
        return $this->unitIdIdPutAsyncWithHttpInfo($id, $unit, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unitIdIdPutAsyncWithHttpInfo
     *
     * update a unit
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitIdIdPutAsyncWithHttpInfo($id, $unit, $dry_run = null, string $contentType = self::contentTypes['unitIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\Unit';
        $request = $this->unitIdIdPutRequest($id, $unit, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'unitIdIdPut'
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\Unit $unit (required)
     * @param  bool|null $dry_run (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unitIdIdPutRequest($id, $unit, $dry_run = null, string $contentType = self::contentTypes['unitIdIdPut'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling unitIdIdPut'
            );
        }
        ...
        if ($unit === null || (is_array($unit) && count($unit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unit when calling unitIdIdPut'
            );
        }
     ...
     * @param  \kruegge82\weclapp\Model\Unit $unit unit (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\Unit|\kruegge82\weclapp\Model\ApiProblem
     */
    public function unitPost($unit, $dry_run = null, string $contentType = self::contentTypes['unitPost'][0])
    {
        list($response) = $this->unitPostWithHttpInfo($unit, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation unitPostWithHttpInfo
     *
     * create a unit
     *
     * @param  \kruegge82\weclapp\Model\Unit $unit (required)
     ...
     * @return array of \kruegge82\weclapp\Model\Unit|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function unitPostWithHttpInfo($unit, $dry_run = null, string $contentType = self::contentTypes['unitPost'][0])
    {
        $request = $this->unitPostRequest($unit, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitPostAsync($unit, $dry_run = null, string $contentType = self::contentTypes['unitPost'][0])
    {
        return $this->unitPostAsyncWithHttpInfo($unit, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unitPostAsyncWithHttpInfo
     *
     * create a unit
     *
     * @param  \kruegge82\weclapp\Model\Unit $unit (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitPostAsyncWithHttpInfo($unit, $dry_run = null, string $contentType = self::contentTypes['unitPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\Unit';
        $request = $this->unitPostRequest($unit, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'unitPost'
     *
     * @param  \kruegge82\weclapp\Model\Unit $unit (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unitPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unitPostRequest($unit, $dry_run = null, string $contentType = self::contentTypes['unitPost'][0])
    {

        // verify the required parameter 'unit' is set
        if ($unit === null || (is_array($unit) && count($unit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unit when calling unitPost'
            );
        }

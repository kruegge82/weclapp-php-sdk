...
class StoragePlaceBlockingReasonApi
{
     ...
     */
    public function storagePlaceBlockingReasonCountGet($filter = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonCountGet'][0])
    {
        list($response) = $this->storagePlaceBlockingReasonCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function storagePlaceBlockingReasonCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonCountGet'][0])
    {
        $request = $this->storagePlaceBlockingReasonCountGetRequest($filter, $contentType);
     ...
     */
    public function storagePlaceBlockingReasonCountGetAsync($filter = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonCountGet'][0])
    {
        return $this->storagePlaceBlockingReasonCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storagePlaceBlockingReasonCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->storagePlaceBlockingReasonCountGetRequest($filter, $contentType);
     ...
     */
    public function storagePlaceBlockingReasonCountGetRequest($filter = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonCountGet'][0])
    {
     ...
     */
    public function storagePlaceBlockingReasonGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonGet'][0])
    {
        list($response) = $this->storagePlaceBlockingReasonGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function storagePlaceBlockingReasonGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonGet'][0])
    {
        $request = $this->storagePlaceBlockingReasonGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storagePlaceBlockingReasonGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonGet'][0])
    {
        return $this->storagePlaceBlockingReasonGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storagePlaceBlockingReasonGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response';
        $request = $this->storagePlaceBlockingReasonGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function storagePlaceBlockingReasonGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonGet'][0])
    {
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function storagePlaceBlockingReasonIdIdPut($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonIdIdPut'][0])
    {
        list($response) = $this->storagePlaceBlockingReasonIdIdPutWithHttpInfo($id, $custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function storagePlaceBlockingReasonIdIdPutWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonIdIdPut'][0])
    {
        $request = $this->storagePlaceBlockingReasonIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storagePlaceBlockingReasonIdIdPutAsync($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonIdIdPut'][0])
    {
        return $this->storagePlaceBlockingReasonIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storagePlaceBlockingReasonIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->storagePlaceBlockingReasonIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function storagePlaceBlockingReasonIdIdPutRequest($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonIdIdPut'][0])
    {
        ...
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling storagePlaceBlockingReasonIdIdPut'
            );
        }
     ...
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function storagePlaceBlockingReasonPost($custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonPost'][0])
    {
        list($response) = $this->storagePlaceBlockingReasonPostWithHttpInfo($custom_value, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function storagePlaceBlockingReasonPostWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonPost'][0])
    {
        $request = $this->storagePlaceBlockingReasonPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storagePlaceBlockingReasonPostAsync($custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonPost'][0])
    {
        return $this->storagePlaceBlockingReasonPostAsyncWithHttpInfo($custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storagePlaceBlockingReasonPostAsyncWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->storagePlaceBlockingReasonPostRequest($custom_value, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function storagePlaceBlockingReasonPostRequest($custom_value, $dry_run = null, string $contentType = self::contentTypes['storagePlaceBlockingReasonPost'][0])
    {

        // verify the required parameter 'custom_value' is set
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling storagePlaceBlockingReasonPost'
            );
        }

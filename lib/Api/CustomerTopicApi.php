...
/**
 * CustomerTopicApi Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
...
class CustomerTopicApi
{
    ...
    /**
     * Operation customerTopicCountGet
     *
     * count customerTopic
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function customerTopicCountGet($filter = null, string $contentType = self::contentTypes['customerTopicCountGet'][0])
    {
        list($response) = $this->customerTopicCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation customerTopicCountGetWithHttpInfo
     *
     * count customerTopic
     *
     ...
     */
    public function customerTopicCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['customerTopicCountGet'][0])
    {
        $request = $this->customerTopicCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation customerTopicCountGetAsync
     *
     * count customerTopic
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function customerTopicCountGetAsync($filter = null, string $contentType = self::contentTypes['customerTopicCountGet'][0])
    {
        return $this->customerTopicCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerTopicCountGetAsyncWithHttpInfo
     *
     * count customerTopic
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['customerTopicCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->customerTopicCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'customerTopicCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function customerTopicCountGetRequest($filter = null, string $contentType = self::contentTypes['customerTopicCountGet'][0])
    {



        $resourcePath = '/customerTopic/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function customerTopicGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerTopicGet'][0])
    {
        list($response) = $this->customerTopicGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation customerTopicGetWithHttpInfo
     *
     * query customerTopic
     *
     ...
     */
    public function customerTopicGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerTopicGet'][0])
    {
        $request = $this->customerTopicGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Operation customerTopicGetAsync
     *
     * query customerTopic
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerTopicGet'][0])
    {
        return $this->customerTopicGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerTopicGetAsyncWithHttpInfo
     *
     * query customerTopic
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerTopicGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\ArticleAccountingCodeGet200Response';
        $request = $this->customerTopicGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'customerTopicGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerTopicGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['customerTopicGet'][0])
    {
    ...
    /**
     * Operation customerTopicIdIdDelete
     *
     * delete a customerTopic
     *
     * @param  string $id id (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicIdIdDelete'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function customerTopicIdIdDelete($id, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdDelete'][0])
    {
        $this->customerTopicIdIdDeleteWithHttpInfo($id, $dry_run, $contentType);
    }

    /**
     * Operation customerTopicIdIdDeleteWithHttpInfo
     *
     * delete a customerTopic
     *
     ...
     */
    public function customerTopicIdIdDeleteWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdDelete'][0])
    {
        $request = $this->customerTopicIdIdDeleteRequest($id, $dry_run, $contentType);
    ...
    /**
     * Operation customerTopicIdIdDeleteAsync
     *
     * delete a customerTopic
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicIdIdDeleteAsync($id, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdDelete'][0])
    {
        return $this->customerTopicIdIdDeleteAsyncWithHttpInfo($id, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerTopicIdIdDeleteAsyncWithHttpInfo
     *
     * delete a customerTopic
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicIdIdDeleteAsyncWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdDelete'][0])
    {
        $returnType = '';
        $request = $this->customerTopicIdIdDeleteRequest($id, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'customerTopicIdIdDelete'
     *
     * @param  string $id (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicIdIdDelete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerTopicIdIdDeleteRequest($id, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling customerTopicIdIdDelete'
            );
        }



        $resourcePath = '/customerTopic/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation customerTopicIdIdGet
     *
     * query a specific customerTopic
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function customerTopicIdIdGet($id, string $contentType = self::contentTypes['customerTopicIdIdGet'][0])
    {
        list($response) = $this->customerTopicIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation customerTopicIdIdGetWithHttpInfo
     *
     * query a specific customerTopic
     *
     * @param  string $id (required)
     ...
     */
    public function customerTopicIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['customerTopicIdIdGet'][0])
    {
        $request = $this->customerTopicIdIdGetRequest($id, $contentType);
    ...
    /**
     * Operation customerTopicIdIdGetAsync
     *
     * query a specific customerTopic
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicIdIdGetAsync($id, string $contentType = self::contentTypes['customerTopicIdIdGet'][0])
    {
        return $this->customerTopicIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerTopicIdIdGetAsyncWithHttpInfo
     *
     * query a specific customerTopic
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['customerTopicIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->customerTopicIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'customerTopicIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerTopicIdIdGetRequest($id, string $contentType = self::contentTypes['customerTopicIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling customerTopicIdIdGet'
            );
        }
    ...
    /**
     * Operation customerTopicIdIdPut
     *
     ...
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function customerTopicIdIdPut($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdPut'][0])
    {
        list($response) = $this->customerTopicIdIdPutWithHttpInfo($id, $custom_value, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation customerTopicIdIdPutWithHttpInfo
     *
     * update a customerTopic
     *
     * @param  string $id (required)
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerTopicIdIdPutWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdPut'][0])
    {
        $request = $this->customerTopicIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
    ...
    /**
     * Operation customerTopicIdIdPutAsync
     *
     * update a customerTopic
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicIdIdPutAsync($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdPut'][0])
    {
        return $this->customerTopicIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerTopicIdIdPutAsyncWithHttpInfo
     *
     * update a customerTopic
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicIdIdPutAsyncWithHttpInfo($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->customerTopicIdIdPutRequest($id, $custom_value, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'customerTopicIdIdPut'
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value (required)
     * @param  bool|null $dry_run (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerTopicIdIdPutRequest($id, $custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicIdIdPut'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling customerTopicIdIdPut'
            );
        }
        ...
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling customerTopicIdIdPut'
            );
        }
    ...
    /**
     * Operation customerTopicPost
     *
     * create a customerTopic
     *
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value custom_value (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem
     */
    public function customerTopicPost($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicPost'][0])
    {
        list($response) = $this->customerTopicPostWithHttpInfo($custom_value, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation customerTopicPostWithHttpInfo
     *
     * create a customerTopic
     *
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value (required)
     ...
     * @return array of \kruegge82\weclapp\Model\CustomValue|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerTopicPostWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicPost'][0])
    {
        $request = $this->customerTopicPostRequest($custom_value, $dry_run, $contentType);
    ...
    /**
     * Operation customerTopicPostAsync
     *
     * create a customerTopic
     *
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicPostAsync($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicPost'][0])
    {
        return $this->customerTopicPostAsyncWithHttpInfo($custom_value, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerTopicPostAsyncWithHttpInfo
     *
     * create a customerTopic
     *
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerTopicPostAsyncWithHttpInfo($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\CustomValue';
        $request = $this->customerTopicPostRequest($custom_value, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'customerTopicPost'
     *
     * @param  \kruegge82\weclapp\Model\CustomValue $custom_value (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerTopicPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerTopicPostRequest($custom_value, $dry_run = null, string $contentType = self::contentTypes['customerTopicPost'][0])
    {

        // verify the required parameter 'custom_value' is set
        if ($custom_value === null || (is_array($custom_value) && count($custom_value) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_value when calling customerTopicPost'
            );
        }

...
/**
 * AccountingTransactionApi Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccountingTransactionApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation accountingTransactionBatchBookingPost
     *
     * Creates an accounting transaction of type &#39;impersonal&#39;
     *
     * @param  \kruegge82\weclapp\Model\AccountingTransactionBatchBookingPostRequest $accounting_transaction_batch_booking_post_request accounting_transaction_batch_booking_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountingTransactionBatchBookingPost'] to see the possible values for this operation
     *
     ...
     */
    public function accountingTransactionBatchBookingPost($accounting_transaction_batch_booking_post_request, string $contentType = self::contentTypes['accountingTransactionBatchBookingPost'][0])
    {
        list($response) = $this->accountingTransactionBatchBookingPostWithHttpInfo($accounting_transaction_batch_booking_post_request, $contentType);
        return $response;
    }

    /**
     * Operation accountingTransactionBatchBookingPostWithHttpInfo
     *
     * Creates an accounting transaction of type &#39;impersonal&#39;
     *
     * @param  \kruegge82\weclapp\Model\AccountingTransactionBatchBookingPostRequest $accounting_transaction_batch_booking_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountingTransactionBatchBookingPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function accountingTransactionBatchBookingPostWithHttpInfo($accounting_transaction_batch_booking_post_request, string $contentType = self::contentTypes['accountingTransactionBatchBookingPost'][0])
    {
        $request = $this->accountingTransactionBatchBookingPostRequest($accounting_transaction_batch_booking_post_request, $contentType);
    ...
    /**
     * Operation accountingTransactionBatchBookingPostAsync
     *
     * Creates an accounting transaction of type &#39;impersonal&#39;
     *
     * @param  \kruegge82\weclapp\Model\AccountingTransactionBatchBookingPostRequest $accounting_transaction_batch_booking_post_request (required)
     ...
     */
    public function accountingTransactionBatchBookingPostAsync($accounting_transaction_batch_booking_post_request, string $contentType = self::contentTypes['accountingTransactionBatchBookingPost'][0])
    {
        return $this->accountingTransactionBatchBookingPostAsyncWithHttpInfo($accounting_transaction_batch_booking_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountingTransactionBatchBookingPostAsyncWithHttpInfo
     *
     * Creates an accounting transaction of type &#39;impersonal&#39;
     *
     * @param  \kruegge82\weclapp\Model\AccountingTransactionBatchBookingPostRequest $accounting_transaction_batch_booking_post_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountingTransactionBatchBookingPostAsyncWithHttpInfo($accounting_transaction_batch_booking_post_request, string $contentType = self::contentTypes['accountingTransactionBatchBookingPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionBatchBookingPost200Response';
        $request = $this->accountingTransactionBatchBookingPostRequest($accounting_transaction_batch_booking_post_request, $contentType);
    ...
    /**
     * Create request for operation 'accountingTransactionBatchBookingPost'
     *
     * @param  \kruegge82\weclapp\Model\AccountingTransactionBatchBookingPostRequest $accounting_transaction_batch_booking_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountingTransactionBatchBookingPost'] to see the possible values for this operation
     *
     ...
     */
    public function accountingTransactionBatchBookingPostRequest($accounting_transaction_batch_booking_post_request, string $contentType = self::contentTypes['accountingTransactionBatchBookingPost'][0])
    {

        // verify the required parameter 'accounting_transaction_batch_booking_post_request' is set
        if ($accounting_transaction_batch_booking_post_request === null || (is_array($accounting_transaction_batch_booking_post_request) && count($accounting_transaction_batch_booking_post_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accounting_transaction_batch_booking_post_request when calling accountingTransactionBatchBookingPost'
            );
        }


        $resourcePath = '/accountingTransaction/batchBooking';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($accounting_transaction_batch_booking_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($accounting_transaction_batch_booking_post_request));
            } else {
                $httpBody = $accounting_transaction_batch_booking_post_request;
            }
    ...
    /**
     * Operation accountingTransactionCountGet
     *
     * count accountingTransaction
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountingTransactionCountGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\AccountingTransactionCountGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function accountingTransactionCountGet($filter = null, string $contentType = self::contentTypes['accountingTransactionCountGet'][0])
    {
        list($response) = $this->accountingTransactionCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation accountingTransactionCountGetWithHttpInfo
     *
     * count accountingTransaction
     *
     ...
     */
    public function accountingTransactionCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['accountingTransactionCountGet'][0])
    {
        $request = $this->accountingTransactionCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation accountingTransactionCountGetAsync
     *
     * count accountingTransaction
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountingTransactionCountGetAsync($filter = null, string $contentType = self::contentTypes['accountingTransactionCountGet'][0])
    {
        return $this->accountingTransactionCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountingTransactionCountGetAsyncWithHttpInfo
     *
     * count accountingTransaction
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountingTransactionCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['accountingTransactionCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->accountingTransactionCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'accountingTransactionCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountingTransactionCountGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountingTransactionCountGetRequest($filter = null, string $contentType = self::contentTypes['accountingTransactionCountGet'][0])
    {



        $resourcePath = '/accountingTransaction/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation accountingTransactionGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountingTransactionGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\AccountingTransactionGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function accountingTransactionGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['accountingTransactionGet'][0])
    {
        list($response) = $this->accountingTransactionGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation accountingTransactionGetWithHttpInfo
     *
     * query accountingTransaction
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\AccountingTransactionGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountingTransactionGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['accountingTransactionGet'][0])
    {
        $request = $this->accountingTransactionGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\AccountingTransactionGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\AccountingTransactionGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\AccountingTransactionGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\AccountingTransactionGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\AccountingTransactionGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation accountingTransactionGetAsync
     *
     * query accountingTransaction
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountingTransactionGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['accountingTransactionGet'][0])
    {
        return $this->accountingTransactionGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountingTransactionGetAsyncWithHttpInfo
     *
     * query accountingTransaction
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountingTransactionGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['accountingTransactionGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionGet200Response';
        $request = $this->accountingTransactionGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'accountingTransactionGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountingTransactionGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['accountingTransactionGet'][0])
    {
        ...
        $resourcePath = '/accountingTransaction';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation accountingTransactionIdIdGet
     *
     * query a specific accountingTransaction
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountingTransactionIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\AccountingTransaction|\kruegge82\weclapp\Model\ApiProblem
     */
    public function accountingTransactionIdIdGet($id, string $contentType = self::contentTypes['accountingTransactionIdIdGet'][0])
    {
        list($response) = $this->accountingTransactionIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation accountingTransactionIdIdGetWithHttpInfo
     *
     * query a specific accountingTransaction
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\AccountingTransaction|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountingTransactionIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['accountingTransactionIdIdGet'][0])
    {
        $request = $this->accountingTransactionIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\AccountingTransaction' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\AccountingTransaction' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\AccountingTransaction', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\AccountingTransaction';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\AccountingTransaction',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation accountingTransactionIdIdGetAsync
     *
     * query a specific accountingTransaction
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountingTransactionIdIdGetAsync($id, string $contentType = self::contentTypes['accountingTransactionIdIdGet'][0])
    {
        return $this->accountingTransactionIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountingTransactionIdIdGetAsyncWithHttpInfo
     *
     * query a specific accountingTransaction
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountingTransactionIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['accountingTransactionIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransaction';
        $request = $this->accountingTransactionIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'accountingTransactionIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountingTransactionIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountingTransactionIdIdGetRequest($id, string $contentType = self::contentTypes['accountingTransactionIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling accountingTransactionIdIdGet'
            );
        }


        $resourcePath = '/accountingTransaction/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

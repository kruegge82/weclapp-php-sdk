...
class TicketTypeApi
{
     ...
     */
    public function ticketTypeCountGet($filter = null, string $contentType = self::contentTypes['ticketTypeCountGet'][0])
    {
        list($response) = $this->ticketTypeCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function ticketTypeCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['ticketTypeCountGet'][0])
    {
        $request = $this->ticketTypeCountGetRequest($filter, $contentType);
     ...
     */
    public function ticketTypeCountGetAsync($filter = null, string $contentType = self::contentTypes['ticketTypeCountGet'][0])
    {
        return $this->ticketTypeCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketTypeCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['ticketTypeCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->ticketTypeCountGetRequest($filter, $contentType);
     ...
     */
    public function ticketTypeCountGetRequest($filter = null, string $contentType = self::contentTypes['ticketTypeCountGet'][0])
    {
     ...
     */
    public function ticketTypeGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketTypeGet'][0])
    {
        list($response) = $this->ticketTypeGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function ticketTypeGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketTypeGet'][0])
    {
        $request = $this->ticketTypeGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\TicketTypeGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\TicketTypeGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\TicketTypeGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketTypeGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketTypeGet'][0])
    {
        return $this->ticketTypeGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketTypeGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketTypeGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TicketTypeGet200Response';
        $request = $this->ticketTypeGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketTypeGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketTypeGet'][0])
    {
    ...
    public function ticketTypeIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['ticketTypeIdIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\TicketType' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\TicketType' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\TicketType', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\TicketType $ticket_type ticket_type (required)
     * @param  bool|null $dry_run dry_run (optional)
     ...
     * @return \kruegge82\weclapp\Model\TicketType|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ticketTypeIdIdPut($id, $ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypeIdIdPut'][0])
    {
        list($response) = $this->ticketTypeIdIdPutWithHttpInfo($id, $ticket_type, $dry_run, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\TicketType $ticket_type (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketTypeIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\TicketType|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ticketTypeIdIdPutWithHttpInfo($id, $ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypeIdIdPut'][0])
    {
        $request = $this->ticketTypeIdIdPutRequest($id, $ticket_type, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketTypeIdIdPutAsync($id, $ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypeIdIdPut'][0])
    {
        return $this->ticketTypeIdIdPutAsyncWithHttpInfo($id, $ticket_type, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketTypeIdIdPutAsyncWithHttpInfo($id, $ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypeIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TicketType';
        $request = $this->ticketTypeIdIdPutRequest($id, $ticket_type, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketTypeIdIdPutRequest($id, $ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypeIdIdPut'][0])
    {
        ...
        if ($ticket_type === null || (is_array($ticket_type) && count($ticket_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ticket_type when calling ticketTypeIdIdPut'
            );
        }
        ...
        if (isset($ticket_type)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ticket_type));
            } else {
                $httpBody = $ticket_type;
            }
     ...
     * @return \kruegge82\weclapp\Model\TicketType|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ticketTypePost($ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypePost'][0])
    {
        list($response) = $this->ticketTypePostWithHttpInfo($ticket_type, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\TicketType|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ticketTypePostWithHttpInfo($ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypePost'][0])
    {
        $request = $this->ticketTypePostRequest($ticket_type, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketTypePostAsync($ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypePost'][0])
    {
        return $this->ticketTypePostAsyncWithHttpInfo($ticket_type, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketTypePostAsyncWithHttpInfo($ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypePost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TicketType';
        $request = $this->ticketTypePostRequest($ticket_type, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketTypePostRequest($ticket_type, $dry_run = null, string $contentType = self::contentTypes['ticketTypePost'][0])
    {

        // verify the required parameter 'ticket_type' is set
        if ($ticket_type === null || (is_array($ticket_type) && count($ticket_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ticket_type when calling ticketTypePost'
            );
        }

...
class PropertyTranslationApi
{
    ...
    public function propertyTranslationReadPropertyTranslationsGetWithHttpInfo($entity_name, $entity_id, $locale = null, $property_names = null, string $contentType = self::contentTypes['propertyTranslationReadPropertyTranslationsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\PropertyTranslationReadPropertyTranslationsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\PropertyTranslationReadPropertyTranslationsGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\PropertyTranslationReadPropertyTranslationsGet200Response', []),

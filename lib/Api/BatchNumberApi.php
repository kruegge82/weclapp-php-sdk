...
/**
 * BatchNumberApi Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
...
class BatchNumberApi
{
    ...
    /**
     * Operation batchNumberCountGet
     *
     * count batchNumber
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['batchNumberCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function batchNumberCountGet($filter = null, string $contentType = self::contentTypes['batchNumberCountGet'][0])
    {
        list($response) = $this->batchNumberCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation batchNumberCountGetWithHttpInfo
     *
     * count batchNumber
     *
     ...
     */
    public function batchNumberCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['batchNumberCountGet'][0])
    {
        $request = $this->batchNumberCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation batchNumberCountGetAsync
     *
     * count batchNumber
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function batchNumberCountGetAsync($filter = null, string $contentType = self::contentTypes['batchNumberCountGet'][0])
    {
        return $this->batchNumberCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation batchNumberCountGetAsyncWithHttpInfo
     *
     * count batchNumber
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchNumberCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['batchNumberCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->batchNumberCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'batchNumberCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['batchNumberCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function batchNumberCountGetRequest($filter = null, string $contentType = self::contentTypes['batchNumberCountGet'][0])
    {



        $resourcePath = '/batchNumber/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['batchNumberGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\BatchNumberGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function batchNumberGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['batchNumberGet'][0])
    {
        list($response) = $this->batchNumberGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation batchNumberGetWithHttpInfo
     *
     * query batchNumber
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\BatchNumberGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchNumberGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['batchNumberGet'][0])
    {
        $request = $this->batchNumberGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\BatchNumberGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\BatchNumberGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\BatchNumberGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\BatchNumberGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\BatchNumberGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchNumberGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['batchNumberGet'][0])
    {
        return $this->batchNumberGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation batchNumberGetAsyncWithHttpInfo
     *
     * query batchNumber
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchNumberGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['batchNumberGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\BatchNumberGet200Response';
        $request = $this->batchNumberGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'batchNumberGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function batchNumberGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['batchNumberGet'][0])
    {
    ...
    /**
     * Operation batchNumberIdIdGet
     *
     * query a specific batchNumber
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['batchNumberIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\BatchNumber|\kruegge82\weclapp\Model\ApiProblem
     */
    public function batchNumberIdIdGet($id, string $contentType = self::contentTypes['batchNumberIdIdGet'][0])
    {
        list($response) = $this->batchNumberIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation batchNumberIdIdGetWithHttpInfo
     *
     * query a specific batchNumber
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\BatchNumber|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchNumberIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['batchNumberIdIdGet'][0])
    {
        $request = $this->batchNumberIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\BatchNumber' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\BatchNumber' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\BatchNumber', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\BatchNumber';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\BatchNumber',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation batchNumberIdIdGetAsync
     *
     * query a specific batchNumber
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchNumberIdIdGetAsync($id, string $contentType = self::contentTypes['batchNumberIdIdGet'][0])
    {
        return $this->batchNumberIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation batchNumberIdIdGetAsyncWithHttpInfo
     *
     * query a specific batchNumber
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchNumberIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['batchNumberIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\BatchNumber';
        $request = $this->batchNumberIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'batchNumberIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['batchNumberIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function batchNumberIdIdGetRequest($id, string $contentType = self::contentTypes['batchNumberIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling batchNumberIdIdGet'
            );
        }


        $resourcePath = '/batchNumber/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

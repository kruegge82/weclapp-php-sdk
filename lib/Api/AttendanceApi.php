...
class AttendanceApi
{
     ...
     */
    public function attendanceCountGet($filter = null, string $contentType = self::contentTypes['attendanceCountGet'][0])
    {
        list($response) = $this->attendanceCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }
     ...
     */
    public function attendanceCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['attendanceCountGet'][0])
    {
        $request = $this->attendanceCountGetRequest($filter, $contentType);
     ...
     */
    public function attendanceCountGetAsync($filter = null, string $contentType = self::contentTypes['attendanceCountGet'][0])
    {
        return $this->attendanceCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attendanceCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['attendanceCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->attendanceCountGetRequest($filter, $contentType);
     ...
     */
    public function attendanceCountGetRequest($filter = null, string $contentType = self::contentTypes['attendanceCountGet'][0])
    {
    ...
    public function attendanceCurrentAttendanceGetWithHttpInfo(string $contentType = self::contentTypes['attendanceCurrentAttendanceGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\AttendanceCurrentAttendanceGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\AttendanceCurrentAttendanceGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\AttendanceCurrentAttendanceGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     */
    public function attendanceGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['attendanceGet'][0])
    {
        list($response) = $this->attendanceGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }
     ...
     */
    public function attendanceGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['attendanceGet'][0])
    {
        $request = $this->attendanceGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\AttendanceGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\AttendanceGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\AttendanceGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attendanceGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['attendanceGet'][0])
    {
        return $this->attendanceGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attendanceGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['attendanceGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AttendanceGet200Response';
        $request = $this->attendanceGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function attendanceGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['attendanceGet'][0])
    {
    ...
    public function attendanceIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['attendanceIdIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\Attendance' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\Attendance' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\Attendance', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\Attendance $attendance attendance (required)
     * @param  bool|null $dry_run dry_run (optional)
     ...
     * @return \kruegge82\weclapp\Model\Attendance|\kruegge82\weclapp\Model\ApiProblem
     */
    public function attendanceIdIdPut($id, $attendance, $dry_run = null, string $contentType = self::contentTypes['attendanceIdIdPut'][0])
    {
        list($response) = $this->attendanceIdIdPutWithHttpInfo($id, $attendance, $dry_run, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\Attendance $attendance (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['attendanceIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\Attendance|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function attendanceIdIdPutWithHttpInfo($id, $attendance, $dry_run = null, string $contentType = self::contentTypes['attendanceIdIdPut'][0])
    {
        $request = $this->attendanceIdIdPutRequest($id, $attendance, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attendanceIdIdPutAsync($id, $attendance, $dry_run = null, string $contentType = self::contentTypes['attendanceIdIdPut'][0])
    {
        return $this->attendanceIdIdPutAsyncWithHttpInfo($id, $attendance, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attendanceIdIdPutAsyncWithHttpInfo($id, $attendance, $dry_run = null, string $contentType = self::contentTypes['attendanceIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\Attendance';
        $request = $this->attendanceIdIdPutRequest($id, $attendance, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function attendanceIdIdPutRequest($id, $attendance, $dry_run = null, string $contentType = self::contentTypes['attendanceIdIdPut'][0])
    {
        ...
        if ($attendance === null || (is_array($attendance) && count($attendance) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $attendance when calling attendanceIdIdPut'
            );
        }
        ...
        if (isset($attendance)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($attendance));
            } else {
                $httpBody = $attendance;
            }
     ...
     * @return \kruegge82\weclapp\Model\Attendance|\kruegge82\weclapp\Model\ApiProblem
     */
    public function attendancePost($attendance, $dry_run = null, string $contentType = self::contentTypes['attendancePost'][0])
    {
        list($response) = $this->attendancePostWithHttpInfo($attendance, $dry_run, $contentType);
        return $response;
    }
     ...
     * @return array of \kruegge82\weclapp\Model\Attendance|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function attendancePostWithHttpInfo($attendance, $dry_run = null, string $contentType = self::contentTypes['attendancePost'][0])
    {
        $request = $this->attendancePostRequest($attendance, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attendancePostAsync($attendance, $dry_run = null, string $contentType = self::contentTypes['attendancePost'][0])
    {
        return $this->attendancePostAsyncWithHttpInfo($attendance, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attendancePostAsyncWithHttpInfo($attendance, $dry_run = null, string $contentType = self::contentTypes['attendancePost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\Attendance';
        $request = $this->attendancePostRequest($attendance, $dry_run, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function attendancePostRequest($attendance, $dry_run = null, string $contentType = self::contentTypes['attendancePost'][0])
    {

        // verify the required parameter 'attendance' is set
        if ($attendance === null || (is_array($attendance) && count($attendance) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $attendance when calling attendancePost'
            );
        }

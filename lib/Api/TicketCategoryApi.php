...
/**
 * TicketCategoryApi Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
...
class TicketCategoryApi
{
    ...
    /**
     * Operation ticketCategoryCountGet
     *
     * count ticketCategory
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketCategoryCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function ticketCategoryCountGet($filter = null, string $contentType = self::contentTypes['ticketCategoryCountGet'][0])
    {
        list($response) = $this->ticketCategoryCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation ticketCategoryCountGetWithHttpInfo
     *
     * count ticketCategory
     *
     ...
     */
    public function ticketCategoryCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['ticketCategoryCountGet'][0])
    {
        $request = $this->ticketCategoryCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation ticketCategoryCountGetAsync
     *
     * count ticketCategory
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function ticketCategoryCountGetAsync($filter = null, string $contentType = self::contentTypes['ticketCategoryCountGet'][0])
    {
        return $this->ticketCategoryCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ticketCategoryCountGetAsyncWithHttpInfo
     *
     * count ticketCategory
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketCategoryCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['ticketCategoryCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->ticketCategoryCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'ticketCategoryCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketCategoryCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function ticketCategoryCountGetRequest($filter = null, string $contentType = self::contentTypes['ticketCategoryCountGet'][0])
    {



        $resourcePath = '/ticketCategory/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketCategoryGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\TicketCategoryGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ticketCategoryGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketCategoryGet'][0])
    {
        list($response) = $this->ticketCategoryGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation ticketCategoryGetWithHttpInfo
     *
     * query ticketCategory
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\TicketCategoryGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ticketCategoryGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketCategoryGet'][0])
    {
        $request = $this->ticketCategoryGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\TicketCategoryGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\TicketCategoryGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\TicketCategoryGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\TicketCategoryGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\TicketCategoryGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation ticketCategoryGetAsync
     *
     * query ticketCategory
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketCategoryGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketCategoryGet'][0])
    {
        return $this->ticketCategoryGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ticketCategoryGetAsyncWithHttpInfo
     *
     * query ticketCategory
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketCategoryGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketCategoryGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TicketCategoryGet200Response';
        $request = $this->ticketCategoryGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'ticketCategoryGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketCategoryGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketCategoryGet'][0])
    {
    ...
    /**
     * Operation ticketCategoryIdIdGet
     *
     * query a specific ticketCategory
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketCategoryIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\TicketCategory|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ticketCategoryIdIdGet($id, string $contentType = self::contentTypes['ticketCategoryIdIdGet'][0])
    {
        list($response) = $this->ticketCategoryIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation ticketCategoryIdIdGetWithHttpInfo
     *
     * query a specific ticketCategory
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\TicketCategory|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ticketCategoryIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['ticketCategoryIdIdGet'][0])
    {
        $request = $this->ticketCategoryIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\TicketCategory' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\TicketCategory' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\TicketCategory', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\TicketCategory';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\TicketCategory',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation ticketCategoryIdIdGetAsync
     *
     * query a specific ticketCategory
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketCategoryIdIdGetAsync($id, string $contentType = self::contentTypes['ticketCategoryIdIdGet'][0])
    {
        return $this->ticketCategoryIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ticketCategoryIdIdGetAsyncWithHttpInfo
     *
     * query a specific ticketCategory
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketCategoryIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['ticketCategoryIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TicketCategory';
        $request = $this->ticketCategoryIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'ticketCategoryIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketCategoryIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketCategoryIdIdGetRequest($id, string $contentType = self::contentTypes['ticketCategoryIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling ticketCategoryIdIdGet'
            );
        }


        $resourcePath = '/ticketCategory/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

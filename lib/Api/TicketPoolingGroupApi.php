...
/**
 * TicketPoolingGroupApi Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
...
class TicketPoolingGroupApi
{
    ...
    /**
     * Operation ticketPoolingGroupCountGet
     *
     * count ticketPoolingGroup
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketPoolingGroupCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function ticketPoolingGroupCountGet($filter = null, string $contentType = self::contentTypes['ticketPoolingGroupCountGet'][0])
    {
        list($response) = $this->ticketPoolingGroupCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation ticketPoolingGroupCountGetWithHttpInfo
     *
     * count ticketPoolingGroup
     *
     ...
     */
    public function ticketPoolingGroupCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['ticketPoolingGroupCountGet'][0])
    {
        $request = $this->ticketPoolingGroupCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation ticketPoolingGroupCountGetAsync
     *
     * count ticketPoolingGroup
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function ticketPoolingGroupCountGetAsync($filter = null, string $contentType = self::contentTypes['ticketPoolingGroupCountGet'][0])
    {
        return $this->ticketPoolingGroupCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ticketPoolingGroupCountGetAsyncWithHttpInfo
     *
     * count ticketPoolingGroup
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketPoolingGroupCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['ticketPoolingGroupCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->ticketPoolingGroupCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'ticketPoolingGroupCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketPoolingGroupCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function ticketPoolingGroupCountGetRequest($filter = null, string $contentType = self::contentTypes['ticketPoolingGroupCountGet'][0])
    {



        $resourcePath = '/ticketPoolingGroup/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation ticketPoolingGroupGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketPoolingGroupGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\TicketPoolingGroupGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ticketPoolingGroupGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketPoolingGroupGet'][0])
    {
        list($response) = $this->ticketPoolingGroupGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation ticketPoolingGroupGetWithHttpInfo
     *
     * query ticketPoolingGroup
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\TicketPoolingGroupGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ticketPoolingGroupGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketPoolingGroupGet'][0])
    {
        $request = $this->ticketPoolingGroupGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\TicketPoolingGroupGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\TicketPoolingGroupGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\TicketPoolingGroupGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\TicketPoolingGroupGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\TicketPoolingGroupGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation ticketPoolingGroupGetAsync
     *
     * query ticketPoolingGroup
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketPoolingGroupGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketPoolingGroupGet'][0])
    {
        return $this->ticketPoolingGroupGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ticketPoolingGroupGetAsyncWithHttpInfo
     *
     * query ticketPoolingGroup
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketPoolingGroupGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketPoolingGroupGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TicketPoolingGroupGet200Response';
        $request = $this->ticketPoolingGroupGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'ticketPoolingGroupGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketPoolingGroupGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ticketPoolingGroupGet'][0])
    {
        ...
        $resourcePath = '/ticketPoolingGroup';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation ticketPoolingGroupIdIdGet
     *
     * query a specific ticketPoolingGroup
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketPoolingGroupIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\TicketPoolingGroup|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ticketPoolingGroupIdIdGet($id, string $contentType = self::contentTypes['ticketPoolingGroupIdIdGet'][0])
    {
        list($response) = $this->ticketPoolingGroupIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation ticketPoolingGroupIdIdGetWithHttpInfo
     *
     * query a specific ticketPoolingGroup
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\TicketPoolingGroup|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ticketPoolingGroupIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['ticketPoolingGroupIdIdGet'][0])
    {
        $request = $this->ticketPoolingGroupIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\TicketPoolingGroup' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\TicketPoolingGroup' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\TicketPoolingGroup', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\TicketPoolingGroup';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\TicketPoolingGroup',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation ticketPoolingGroupIdIdGetAsync
     *
     * query a specific ticketPoolingGroup
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketPoolingGroupIdIdGetAsync($id, string $contentType = self::contentTypes['ticketPoolingGroupIdIdGet'][0])
    {
        return $this->ticketPoolingGroupIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ticketPoolingGroupIdIdGetAsyncWithHttpInfo
     *
     * query a specific ticketPoolingGroup
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ticketPoolingGroupIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['ticketPoolingGroupIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\TicketPoolingGroup';
        $request = $this->ticketPoolingGroupIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'ticketPoolingGroupIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ticketPoolingGroupIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ticketPoolingGroupIdIdGetRequest($id, string $contentType = self::contentTypes['ticketPoolingGroupIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling ticketPoolingGroupIdIdGet'
            );
        }


        $resourcePath = '/ticketPoolingGroup/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

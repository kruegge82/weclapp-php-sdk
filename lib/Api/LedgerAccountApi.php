...
class LedgerAccountApi
{
    ...
    /**
     * Operation ledgerAccountCountGet
     *
     * count ledgerAccount
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function ledgerAccountCountGet($filter = null, string $contentType = self::contentTypes['ledgerAccountCountGet'][0])
    {
        list($response) = $this->ledgerAccountCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation ledgerAccountCountGetWithHttpInfo
     *
     * count ledgerAccount
     *
     ...
     */
    public function ledgerAccountCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['ledgerAccountCountGet'][0])
    {
        $request = $this->ledgerAccountCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation ledgerAccountCountGetAsync
     *
     * count ledgerAccount
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function ledgerAccountCountGetAsync($filter = null, string $contentType = self::contentTypes['ledgerAccountCountGet'][0])
    {
        return $this->ledgerAccountCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ledgerAccountCountGetAsyncWithHttpInfo
     *
     * count ledgerAccount
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['ledgerAccountCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->ledgerAccountCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'ledgerAccountCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function ledgerAccountCountGetRequest($filter = null, string $contentType = self::contentTypes['ledgerAccountCountGet'][0])
    {



        $resourcePath = '/ledgerAccount/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\LedgerAccountGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ledgerAccountGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ledgerAccountGet'][0])
    {
        list($response) = $this->ledgerAccountGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation ledgerAccountGetWithHttpInfo
     *
     * query ledgerAccount
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\LedgerAccountGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ledgerAccountGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ledgerAccountGet'][0])
    {
        $request = $this->ledgerAccountGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\LedgerAccountGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\LedgerAccountGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\LedgerAccountGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\LedgerAccountGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\LedgerAccountGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation ledgerAccountGetAsync
     *
     * query ledgerAccount
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ledgerAccountGet'][0])
    {
        return $this->ledgerAccountGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ledgerAccountGetAsyncWithHttpInfo
     *
     * query ledgerAccount
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ledgerAccountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\LedgerAccountGet200Response';
        $request = $this->ledgerAccountGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'ledgerAccountGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ledgerAccountGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['ledgerAccountGet'][0])
    {
    ...
    /**
     * Operation ledgerAccountIdIdDelete
     *
     * delete a ledgerAccount
     *
     * @param  string $id id (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountIdIdDelete'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function ledgerAccountIdIdDelete($id, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdDelete'][0])
    {
        $this->ledgerAccountIdIdDeleteWithHttpInfo($id, $dry_run, $contentType);
    }

    /**
     * Operation ledgerAccountIdIdDeleteWithHttpInfo
     *
     * delete a ledgerAccount
     *
     ...
     */
    public function ledgerAccountIdIdDeleteWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdDelete'][0])
    {
        $request = $this->ledgerAccountIdIdDeleteRequest($id, $dry_run, $contentType);
    ...
    /**
     * Operation ledgerAccountIdIdDeleteAsync
     *
     * delete a ledgerAccount
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountIdIdDeleteAsync($id, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdDelete'][0])
    {
        return $this->ledgerAccountIdIdDeleteAsyncWithHttpInfo($id, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ledgerAccountIdIdDeleteAsyncWithHttpInfo
     *
     * delete a ledgerAccount
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountIdIdDeleteAsyncWithHttpInfo($id, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdDelete'][0])
    {
        $returnType = '';
        $request = $this->ledgerAccountIdIdDeleteRequest($id, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'ledgerAccountIdIdDelete'
     *
     * @param  string $id (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountIdIdDelete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ledgerAccountIdIdDeleteRequest($id, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling ledgerAccountIdIdDelete'
            );
        }



        $resourcePath = '/ledgerAccount/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation ledgerAccountIdIdGet
     *
     * query a specific ledgerAccount
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\LedgerAccount|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ledgerAccountIdIdGet($id, string $contentType = self::contentTypes['ledgerAccountIdIdGet'][0])
    {
        list($response) = $this->ledgerAccountIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation ledgerAccountIdIdGetWithHttpInfo
     *
     * query a specific ledgerAccount
     *
     * @param  string $id (required)
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\LedgerAccount|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ledgerAccountIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['ledgerAccountIdIdGet'][0])
    {
        $request = $this->ledgerAccountIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\LedgerAccount' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\LedgerAccount' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\LedgerAccount', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\LedgerAccount';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\LedgerAccount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation ledgerAccountIdIdGetAsync
     *
     * query a specific ledgerAccount
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountIdIdGetAsync($id, string $contentType = self::contentTypes['ledgerAccountIdIdGet'][0])
    {
        return $this->ledgerAccountIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ledgerAccountIdIdGetAsyncWithHttpInfo
     *
     * query a specific ledgerAccount
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['ledgerAccountIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\LedgerAccount';
        $request = $this->ledgerAccountIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'ledgerAccountIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ledgerAccountIdIdGetRequest($id, string $contentType = self::contentTypes['ledgerAccountIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling ledgerAccountIdIdGet'
            );
        }
    ...
    /**
     * Operation ledgerAccountIdIdPut
     *
     * update a ledgerAccount
     *
     * @param  string $id id (required)
     * @param  \kruegge82\weclapp\Model\LedgerAccount $ledger_account ledger_account (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\LedgerAccount|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ledgerAccountIdIdPut($id, $ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdPut'][0])
    {
        list($response) = $this->ledgerAccountIdIdPutWithHttpInfo($id, $ledger_account, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation ledgerAccountIdIdPutWithHttpInfo
     *
     * update a ledgerAccount
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\LedgerAccount $ledger_account (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountIdIdPut'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \kruegge82\weclapp\Model\LedgerAccount|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ledgerAccountIdIdPutWithHttpInfo($id, $ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdPut'][0])
    {
        $request = $this->ledgerAccountIdIdPutRequest($id, $ledger_account, $dry_run, $contentType);
    ...
    /**
     * Operation ledgerAccountIdIdPutAsync
     *
     * update a ledgerAccount
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountIdIdPutAsync($id, $ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdPut'][0])
    {
        return $this->ledgerAccountIdIdPutAsyncWithHttpInfo($id, $ledger_account, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ledgerAccountIdIdPutAsyncWithHttpInfo
     *
     * update a ledgerAccount
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountIdIdPutAsyncWithHttpInfo($id, $ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdPut'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\LedgerAccount';
        $request = $this->ledgerAccountIdIdPutRequest($id, $ledger_account, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'ledgerAccountIdIdPut'
     *
     * @param  string $id (required)
     * @param  \kruegge82\weclapp\Model\LedgerAccount $ledger_account (required)
     * @param  bool|null $dry_run (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ledgerAccountIdIdPutRequest($id, $ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountIdIdPut'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling ledgerAccountIdIdPut'
            );
        }
        ...
        if ($ledger_account === null || (is_array($ledger_account) && count($ledger_account) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ledger_account when calling ledgerAccountIdIdPut'
            );
        }
        ...
        if (isset($ledger_account)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ledger_account));
            } else {
    ...
    /**
     * Operation ledgerAccountPost
     *
     * create a ledgerAccount
     *
     * @param  \kruegge82\weclapp\Model\LedgerAccount $ledger_account ledger_account (required)
     * @param  bool|null $dry_run dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\LedgerAccount|\kruegge82\weclapp\Model\ApiProblem
     */
    public function ledgerAccountPost($ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountPost'][0])
    {
        list($response) = $this->ledgerAccountPostWithHttpInfo($ledger_account, $dry_run, $contentType);
        return $response;
    }

    /**
     * Operation ledgerAccountPostWithHttpInfo
     *
     * create a ledgerAccount
     *
     * @param  \kruegge82\weclapp\Model\LedgerAccount $ledger_account (required)
     ...
     * @return array of \kruegge82\weclapp\Model\LedgerAccount|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function ledgerAccountPostWithHttpInfo($ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountPost'][0])
    {
        $request = $this->ledgerAccountPostRequest($ledger_account, $dry_run, $contentType);
    ...
    /**
     * Operation ledgerAccountPostAsync
     *
     * create a ledgerAccount
     *
     * @param  \kruegge82\weclapp\Model\LedgerAccount $ledger_account (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountPostAsync($ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountPost'][0])
    {
        return $this->ledgerAccountPostAsyncWithHttpInfo($ledger_account, $dry_run, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ledgerAccountPostAsyncWithHttpInfo
     *
     * create a ledgerAccount
     *
     * @param  \kruegge82\weclapp\Model\LedgerAccount $ledger_account (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ledgerAccountPostAsyncWithHttpInfo($ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountPost'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\LedgerAccount';
        $request = $this->ledgerAccountPostRequest($ledger_account, $dry_run, $contentType);
    ...
    /**
     * Create request for operation 'ledgerAccountPost'
     *
     * @param  \kruegge82\weclapp\Model\LedgerAccount $ledger_account (required)
     * @param  bool|null $dry_run (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ledgerAccountPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ledgerAccountPostRequest($ledger_account, $dry_run = null, string $contentType = self::contentTypes['ledgerAccountPost'][0])
    {

        // verify the required parameter 'ledger_account' is set
        if ($ledger_account === null || (is_array($ledger_account) && count($ledger_account) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ledger_account when calling ledgerAccountPost'
            );
        }

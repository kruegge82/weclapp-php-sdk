...
class WarehouseStockApi
{
    ...
    /**
     * Operation warehouseStockCountGet
     *
     * count warehouseStock
     *
     * @param  string|null $filter filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehouseStockCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function warehouseStockCountGet($filter = null, string $contentType = self::contentTypes['warehouseStockCountGet'][0])
    {
        list($response) = $this->warehouseStockCountGetWithHttpInfo($filter, $contentType);
        return $response;
    }

    /**
     * Operation warehouseStockCountGetWithHttpInfo
     *
     * count warehouseStock
     *
     ...
     */
    public function warehouseStockCountGetWithHttpInfo($filter = null, string $contentType = self::contentTypes['warehouseStockCountGet'][0])
    {
        $request = $this->warehouseStockCountGetRequest($filter, $contentType);
    ...
    /**
     * Operation warehouseStockCountGetAsync
     *
     * count warehouseStock
     *
     * @param  string|null $filter (optional)
     ...
     */
    public function warehouseStockCountGetAsync($filter = null, string $contentType = self::contentTypes['warehouseStockCountGet'][0])
    {
        return $this->warehouseStockCountGetAsyncWithHttpInfo($filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation warehouseStockCountGetAsyncWithHttpInfo
     *
     * count warehouseStock
     *
     * @param  string|null $filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehouseStockCountGetAsyncWithHttpInfo($filter = null, string $contentType = self::contentTypes['warehouseStockCountGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\AccountingTransactionCountGet200Response';
        $request = $this->warehouseStockCountGetRequest($filter, $contentType);
    ...
    /**
     * Create request for operation 'warehouseStockCountGet'
     *
     * @param  string|null $filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehouseStockCountGet'] to see the possible values for this operation
     *
     ...
     */
    public function warehouseStockCountGetRequest($filter = null, string $contentType = self::contentTypes['warehouseStockCountGet'][0])
    {



        $resourcePath = '/warehouseStock/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehouseStockGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\WarehouseStockGet200Response|\kruegge82\weclapp\Model\ApiProblem
     */
    public function warehouseStockGet($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['warehouseStockGet'][0])
    {
        list($response) = $this->warehouseStockGetWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        return $response;
    }

    /**
     * Operation warehouseStockGetWithHttpInfo
     *
     * query warehouseStock
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\WarehouseStockGet200Response|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function warehouseStockGetWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['warehouseStockGet'][0])
    {
        $request = $this->warehouseStockGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\WarehouseStockGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\WarehouseStockGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\WarehouseStockGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\WarehouseStockGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\WarehouseStockGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation warehouseStockGetAsync
     *
     * query warehouseStock
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehouseStockGetAsync($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['warehouseStockGet'][0])
    {
        return $this->warehouseStockGetAsyncWithHttpInfo($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation warehouseStockGetAsyncWithHttpInfo
     *
     * query warehouseStock
     *
     * @param  int|null $page (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehouseStockGetAsyncWithHttpInfo($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['warehouseStockGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\WarehouseStockGet200Response';
        $request = $this->warehouseStockGetRequest($page, $page_size, $serialize_nulls, $sort, $filter, $properties, $include_referenced_entities, $contentType);
    ...
    /**
     * Create request for operation 'warehouseStockGet'
     *
     * @param  int|null $page (optional)
     * @param  int|null $page_size (optional)
     * @param  bool|null $serialize_nulls (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function warehouseStockGetRequest($page = null, $page_size = null, $serialize_nulls = null, $sort = null, $filter = null, $properties = null, $include_referenced_entities = null, string $contentType = self::contentTypes['warehouseStockGet'][0])
    {
    ...
    /**
     * Operation warehouseStockIdIdGet
     *
     * query a specific warehouseStock
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehouseStockIdIdGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\weclapp\Model\WarehouseStock|\kruegge82\weclapp\Model\ApiProblem
     */
    public function warehouseStockIdIdGet($id, string $contentType = self::contentTypes['warehouseStockIdIdGet'][0])
    {
        list($response) = $this->warehouseStockIdIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation warehouseStockIdIdGetWithHttpInfo
     *
     * query a specific warehouseStock
     *
     ...
     * @throws \kruegge82\weclapp\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\weclapp\Model\WarehouseStock|\kruegge82\weclapp\Model\ApiProblem, HTTP status code, HTTP response headers (array of strings)
     */
    public function warehouseStockIdIdGetWithHttpInfo($id, string $contentType = self::contentTypes['warehouseStockIdIdGet'][0])
    {
        $request = $this->warehouseStockIdIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\weclapp\Model\WarehouseStock' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\weclapp\Model\WarehouseStock' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\weclapp\Model\WarehouseStock', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\kruegge82\weclapp\Model\WarehouseStock';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\weclapp\Model\WarehouseStock',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation warehouseStockIdIdGetAsync
     *
     * query a specific warehouseStock
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehouseStockIdIdGetAsync($id, string $contentType = self::contentTypes['warehouseStockIdIdGet'][0])
    {
        return $this->warehouseStockIdIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation warehouseStockIdIdGetAsyncWithHttpInfo
     *
     * query a specific warehouseStock
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehouseStockIdIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['warehouseStockIdIdGet'][0])
    {
        $returnType = '\kruegge82\weclapp\Model\WarehouseStock';
        $request = $this->warehouseStockIdIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'warehouseStockIdIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehouseStockIdIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function warehouseStockIdIdGetRequest($id, string $contentType = self::contentTypes['warehouseStockIdIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling warehouseStockIdIdGet'
            );
        }


        $resourcePath = '/warehouseStock/id/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

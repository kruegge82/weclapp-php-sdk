...
/**
 * TicketCategory Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class TicketCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ticketCategory';
    ...
    protected static $openAPITypes = [
        ...
        'active' => 'bool',
        'name' => 'string',
        'parent_ticket_category_id' => 'string',
        'pseudo_category' => 'bool',
        'published' => 'bool',
        'visible_in_customer_portal' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'active' => null,
        'name' => null,
        'parent_ticket_category_id' => null,
        'pseudo_category' => null,
        'published' => null,
        'visible_in_customer_portal' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'active' => false,
        'name' => false,
        'parent_ticket_category_id' => false,
        'pseudo_category' => false,
        'published' => false,
        'visible_in_customer_portal' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'active' => 'active',
        'name' => 'name',
        'parent_ticket_category_id' => 'parentTicketCategoryId',
        'pseudo_category' => 'pseudoCategory',
        'published' => 'published',
        'visible_in_customer_portal' => 'visibleInCustomerPortal'
    ];
    ...
    protected static $setters = [
        ...
        'active' => 'setActive',
        'name' => 'setName',
        'parent_ticket_category_id' => 'setParentTicketCategoryId',
        'pseudo_category' => 'setPseudoCategory',
        'published' => 'setPublished',
        'visible_in_customer_portal' => 'setVisibleInCustomerPortal'
    ];
    ...
    protected static $getters = [
        ...
        'active' => 'getActive',
        'name' => 'getName',
        'parent_ticket_category_id' => 'getParentTicketCategoryId',
        'pseudo_category' => 'getPseudoCategory',
        'published' => 'getPublished',
        'visible_in_customer_portal' => 'getVisibleInCustomerPortal'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('parent_ticket_category_id', $data ?? [], null);
        $this->setIfExists('pseudo_category', $data ?? [], null);
        $this->setIfExists('published', $data ?? [], null);
        $this->setIfExists('visible_in_customer_portal', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets parent_ticket_category_id
     *
     * @return string|null
     */
    public function getParentTicketCategoryId()
    {
        return $this->container['parent_ticket_category_id'];
    }

    /**
     * Sets parent_ticket_category_id
     *
     * @param string|null $parent_ticket_category_id parent_ticket_category_id
     *
     * @return self
     */
    public function setParentTicketCategoryId($parent_ticket_category_id)
    {
        if (is_null($parent_ticket_category_id)) {
            throw new \InvalidArgumentException('non-nullable parent_ticket_category_id cannot be null');
        }
        $this->container['parent_ticket_category_id'] = $parent_ticket_category_id;

        return $this;
    }

    /**
     * Gets pseudo_category
     *
     * @return bool|null
     */
    public function getPseudoCategory()
    {
        return $this->container['pseudo_category'];
    }

    /**
     * Sets pseudo_category
     *
     * @param bool|null $pseudo_category pseudo_category
     *
     * @return self
     */
    public function setPseudoCategory($pseudo_category)
    {
        if (is_null($pseudo_category)) {
            throw new \InvalidArgumentException('non-nullable pseudo_category cannot be null');
        }
        $this->container['pseudo_category'] = $pseudo_category;
    ...
    /**
     * Gets visible_in_customer_portal
     *
     * @return bool|null
     */
    public function getVisibleInCustomerPortal()
    {
        return $this->container['visible_in_customer_portal'];
    }

    /**
     * Sets visible_in_customer_portal
     *
     * @param bool|null $visible_in_customer_portal visible_in_customer_portal
     *
     * @return self
     */
    public function setVisibleInCustomerPortal($visible_in_customer_portal)
    {
        if (is_null($visible_in_customer_portal)) {
            throw new \InvalidArgumentException('non-nullable visible_in_customer_portal cannot be null');
        }
        $this->container['visible_in_customer_portal'] = $visible_in_customer_portal;

...
/**
 * SalesOrderIdIdCreatePurchaseOrderPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class SalesOrderIdIdCreatePurchaseOrderPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_salesOrder_id__id__createPurchaseOrder_post_request';
    ...
    protected static array $openAPINullables = [
        'multiple_purchase_orders' => false,
        'supplier_id' => false,
        'warehouse_id' => false
    ];
    ...
    protected static $attributeMap = [
        'multiple_purchase_orders' => 'multiplePurchaseOrders',
    ...
    protected static $setters = [
        'multiple_purchase_orders' => 'setMultiplePurchaseOrders',
    ...
    protected static $getters = [
        'multiple_purchase_orders' => 'getMultiplePurchaseOrders',
    ...
    {
        $this->setIfExists('multiple_purchase_orders', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets multiple_purchase_orders
     *
     * @return bool|null
     */
    public function getMultiplePurchaseOrders()
    {
        return $this->container['multiple_purchase_orders'];
    }

    /**
     * Sets multiple_purchase_orders
     *
     * @param bool|null $multiple_purchase_orders multiple_purchase_orders
     *
     * @return self
     */
    public function setMultiplePurchaseOrders($multiple_purchase_orders)
    {
        if (is_null($multiple_purchase_orders)) {
            throw new \InvalidArgumentException('non-nullable multiple_purchase_orders cannot be null');
        }
        $this->container['multiple_purchase_orders'] = $multiple_purchase_orders;

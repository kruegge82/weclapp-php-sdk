...
/**
 * ReductionAddition Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class ReductionAddition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reductionAddition';
    ...
    protected static $openAPITypes = [
        ...
        'version' => 'string',
        'name' => 'string',
        'type' => '\kruegge82\weclapp\Model\PriceConditionType',
        'value' => 'float'
    ];
    ...
    */
     ...
     * Gets type
     *
     * @return \kruegge82\weclapp\Model\PriceConditionType|null
     */
     ...
     * Sets type
     *
     * @param \kruegge82\weclapp\Model\PriceConditionType|null $type type
     *
     * @return self
     */
    ...
    public function setValue($value)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling ReductionAddition., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }

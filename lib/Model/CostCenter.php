...
class CostCenter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'cost_center_type' => '\kruegge82\weclapp\Model\ProductionCostCenterType',
        'description' => 'string'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'version' => false,
        'cost_center_group_id' => false,
        'cost_center_number' => false,
        'cost_center_type' => false,
        'description' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'version' => 'version',
        'cost_center_group_id' => 'costCenterGroupId',
    ...
    protected static $setters = [
        ...
        'version' => 'setVersion',
        'cost_center_group_id' => 'setCostCenterGroupId',
        'cost_center_number' => 'setCostCenterNumber',
        'cost_center_type' => 'setCostCenterType',
    ...
    protected static $getters = [
        ...
        'version' => 'getVersion',
        'cost_center_group_id' => 'getCostCenterGroupId',
        'cost_center_number' => 'getCostCenterNumber',
        'cost_center_type' => 'getCostCenterType',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cost_center_group_id', $data ?? [], null);
        $this->setIfExists('cost_center_number', $data ?? [], null);
        $this->setIfExists('cost_center_type', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets cost_center_group_id
     *
     * @return string|null
     */
    public function getCostCenterGroupId()
    {
        return $this->container['cost_center_group_id'];
    }

    /**
     * Sets cost_center_group_id
     *
     * @param string|null $cost_center_group_id cost_center_group_id
     *
     * @return self
     */
    public function setCostCenterGroupId($cost_center_group_id)
    {
        if (is_null($cost_center_group_id)) {
            throw new \InvalidArgumentException('non-nullable cost_center_group_id cannot be null');
        }
        $this->container['cost_center_group_id'] = $cost_center_group_id;
    ...
    /**
     * Gets cost_center_type
     *
     * @return \kruegge82\weclapp\Model\ProductionCostCenterType|null
     */
    public function getCostCenterType()
    {
        return $this->container['cost_center_type'];
    }

    /**
     * Sets cost_center_type
     *
     * @param \kruegge82\weclapp\Model\ProductionCostCenterType|null $cost_center_type cost_center_type
     *
     * @return self
     */
    public function setCostCenterType($cost_center_type)
    {
        if (is_null($cost_center_type)) {
            throw new \InvalidArgumentException('non-nullable cost_center_type cannot be null');
        }
        $this->container['cost_center_type'] = $cost_center_type;

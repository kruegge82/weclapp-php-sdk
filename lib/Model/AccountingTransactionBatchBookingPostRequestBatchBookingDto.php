<?php
/**
 * AccountingTransactionBatchBookingPostRequestBatchBookingDto
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AccountingTransactionBatchBookingPostRequestBatchBookingDto Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class AccountingTransactionBatchBookingPostRequestBatchBookingDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_accountingTransaction_batchBooking_post_request_batchBookingDto';
    ...
    protected static $openAPITypes = [
        'batch_booking_records' => '\kruegge82\weclapp\Model\BatchBookingRecord[]',
        'booking_text' => 'string',
    ...
    protected static $attributeMap = [
        'batch_booking_records' => 'batchBookingRecords',
    ...
    protected static $setters = [
        'batch_booking_records' => 'setBatchBookingRecords',
    ...
    protected static $getters = [
        'batch_booking_records' => 'getBatchBookingRecords',
    ...
    {
        $this->setIfExists('batch_booking_records', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets batch_booking_records
     *
     * @return \kruegge82\weclapp\Model\BatchBookingRecord[]|null
     */
    public function getBatchBookingRecords()
    {
        return $this->container['batch_booking_records'];
    }

    /**
     * Sets batch_booking_records
     *
     * @param \kruegge82\weclapp\Model\BatchBookingRecord[]|null $batch_booking_records batch_booking_records
     *
     * @return self
     */
    public function setBatchBookingRecords($batch_booking_records)
    {
        if (is_null($batch_booking_records)) {
            throw new \InvalidArgumentException('non-nullable batch_booking_records cannot be null');
        }
        $this->container['batch_booking_records'] = $batch_booking_records;

...
/**
 * CustomAttributeDefinitionPermission Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class CustomAttributeDefinitionPermission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customAttributeDefinitionPermission';
    ...
    protected static $openAPITypes = [
        ...
        'version' => 'string',
        'permission_type' => '\kruegge82\weclapp\Model\CustomAttributeDefinitionPermissionType',
        'user_role_id' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('user_role_id', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \kruegge82\weclapp\Model\CustomAttributeDefinitionPermissionType|null
     */
     ...
     *
     * @param \kruegge82\weclapp\Model\CustomAttributeDefinitionPermissionType|null $permission_type permission_type
     *
     * @return self
     */
     ...
     * Sets user_role_id
     *
     * @param string|null $user_role_id user_role_id
     *
     * @return self
     */
    public function setUserRoleId($user_role_id)
    {
        if (is_null($user_role_id)) {
            throw new \InvalidArgumentException('non-nullable user_role_id cannot be null');
        }

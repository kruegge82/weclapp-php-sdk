    ...
    */
    ...
    public function setRecommendedRetailPrice($recommended_retail_price)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($recommended_retail_price)))) {
            throw new \InvalidArgumentException("invalid value for \$recommended_retail_price when calling BaseSalesRecordItemWithService., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }

    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StoragePlace., must be smaller than or equal to 256.');
        }
    ...
    public function setBarcode($barcode)
    {
        ...
        if ((mb_strlen($barcode) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $barcode when calling StoragePlace., must be smaller than or equal to 4000.');
        }

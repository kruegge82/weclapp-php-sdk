...
class TicketAssignmentRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TICKET_ASSIGNEE_TYPE_CUSTOMER_RESPONSIBLE_PERSON = 'CUSTOMER_RESPONSIBLE_PERSON';
    public const TICKET_ASSIGNEE_TYPE_POOL = 'POOL';
    public const TICKET_ASSIGNEE_TYPE_TICKET_AGENT = 'TICKET_AGENT';
     ...
     * @return string[]
     */
    public function getTicketAssigneeTypeAllowableValues()
    {
        return [
            self::TICKET_ASSIGNEE_TYPE_CUSTOMER_RESPONSIBLE_PERSON,
            self::TICKET_ASSIGNEE_TYPE_POOL,
            self::TICKET_ASSIGNEE_TYPE_TICKET_AGENT,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getTicketAssigneeTypeAllowableValues();
        if (!is_null($this->container['ticket_assignee_type']) && !in_array($this->container['ticket_assignee_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'ticket_assignee_type', must be one of '%s'",
                $this->container['ticket_assignee_type'],
     ...
     *
     * @param string|null $ticket_assignee_type ticket_assignee_type
     *
     * @return self
     */
    public function setTicketAssigneeType($ticket_assignee_type)
    {
        ...
        $allowedValues = $this->getTicketAssigneeTypeAllowableValues();
        if (!in_array($ticket_assignee_type, $allowedValues, true)) {

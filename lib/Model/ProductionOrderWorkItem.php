    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ProductionOrderWorkItem., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling ProductionOrderWorkItem., must be smaller than or equal to 255.');
        }

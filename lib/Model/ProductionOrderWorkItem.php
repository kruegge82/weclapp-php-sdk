...
class ProductionOrderWorkItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\kruegge82\weclapp\Model\ProductionOrderItemStatus',
        'target_end_date' => 'int',
    ...
    */
     ...
     * Gets status
     *
     * @return \kruegge82\weclapp\Model\ProductionOrderItemStatus|null
     */
     ...
     * Sets status
     *
     * @param \kruegge82\weclapp\Model\ProductionOrderItemStatus|null $status status
     *
     * @return self
     */
    ...
    public function setUnitTime($unit_time)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($unit_time)))) {
            throw new \InvalidArgumentException("invalid value for \$unit_time when calling ProductionOrderWorkItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }

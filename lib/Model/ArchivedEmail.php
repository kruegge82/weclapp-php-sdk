...
/**
 * ArchivedEmail Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class ArchivedEmail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'archivedEmail';
    ...
    protected static $setters = [
        ...
        'message_identifier' => 'setMessageIdentifier',
    ...
    protected static $getters = [
        ...
        'message_identifier' => 'getMessageIdentifier',
    ...
    */
    ...
    /**
     * Gets message_identifier
     *
     * @return string|null
     */
    public function getMessageIdentifier()
    {
        return $this->container['message_identifier'];
    }

    /**
     * Sets message_identifier
     *
     * @param string|null $message_identifier message_identifier
     *
     * @return self
     */
    public function setMessageIdentifier($message_identifier)
    {
        if (is_null($message_identifier)) {
            throw new \InvalidArgumentException('non-nullable message_identifier cannot be null');
        }
        $this->container['message_identifier'] = $message_identifier;
     ...
     * Sets received_date
     *
     * @param int|null $received_date received_date
     *
     * @return self
     */
     ...
     * Sets to_addresses
     *
     * @param string[]|null $to_addresses to_addresses
     *
     * @return self
     */
    public function setToAddresses($to_addresses)
    {
        if (is_null($to_addresses)) {
            throw new \InvalidArgumentException('non-nullable to_addresses cannot be null');
        }

<?php
/**
 * SalesOrderIdIdCalculateSalesPricesPostRequest
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * SalesOrderIdIdCalculateSalesPricesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class SalesOrderIdIdCalculateSalesPricesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_salesOrder_id__id__calculateSalesPrices_post_request';
    ...
    protected static $setters = [
        ...
        'order_item_ids' => 'setOrderItemIds',
    ...
    protected static $getters = [
        ...
        'order_item_ids' => 'getOrderItemIds',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('order_item_ids', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['order_item_ids'];
    }

    /**
     * Sets order_item_ids
     *
     * @param string[]|null $order_item_ids order_item_ids
     *
     * @return self
     */
    public function setOrderItemIds($order_item_ids)
    {
        if (is_null($order_item_ids)) {
            throw new \InvalidArgumentException('non-nullable order_item_ids cannot be null');
        }
        $this->container['order_item_ids'] = $order_item_ids;

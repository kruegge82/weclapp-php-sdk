...
/**
 * ArticleCalculationPrice Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class ArticleCalculationPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'articleCalculationPrice';
    ...
    protected static $openAPITypes = [
        ...
        'version' => 'string',
        'article_calculation_price_type' => '\kruegge82\weclapp\Model\ArticleCalculationPriceType',
        'end_date' => 'int',
        'price' => 'float',
    ...
    protected static $openAPIFormats = [
        ...
        'version' => null,
        'article_calculation_price_type' => null,
        'end_date' => 'timestamp',
        'price' => 'decimal',
        'sales_channel' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'version' => false,
        'article_calculation_price_type' => false,
        'end_date' => false,
        'price' => false,
        'sales_channel' => false,
        'start_date' => false
    ...
    protected static $setters = [
        ...
        'version' => 'setVersion',
        'article_calculation_price_type' => 'setArticleCalculationPriceType',
        'end_date' => 'setEndDate',
        'price' => 'setPrice',
    ...
    protected static $getters = [
        ...
        'version' => 'getVersion',
        'article_calculation_price_type' => 'getArticleCalculationPriceType',
        'end_date' => 'getEndDate',
        'price' => 'getPrice',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('article_calculation_price_type', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets article_calculation_price_type
     *
     * @return \kruegge82\weclapp\Model\ArticleCalculationPriceType|null
     */
    public function getArticleCalculationPriceType()
    {
        return $this->container['article_calculation_price_type'];
    }

    /**
     * Sets article_calculation_price_type
     *
     * @param \kruegge82\weclapp\Model\ArticleCalculationPriceType|null $article_calculation_price_type article_calculation_price_type
     *
     * @return self
     */
    public function setArticleCalculationPriceType($article_calculation_price_type)
    {
        if (is_null($article_calculation_price_type)) {
            throw new \InvalidArgumentException('non-nullable article_calculation_price_type cannot be null');
        }
        $this->container['article_calculation_price_type'] = $article_calculation_price_type;

...
class VariantArticle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'primary_article_number' => 'primaryArticleNumber',
    ...
    protected static $setters = [
        ...
        'primary_article_number' => 'setPrimaryArticleNumber',
    ...
    protected static $getters = [
        ...
        'primary_article_number' => 'getPrimaryArticleNumber',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('primary_article_number', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets primary_article_number
     *
     * @return string|null
     * @deprecated
     */
    public function getPrimaryArticleNumber()
    {
        return $this->container['primary_article_number'];
    }

    /**
     * Sets primary_article_number
     *
     * @param string|null $primary_article_number primary_article_number
     *
     * @return self
     * @deprecated
     */
    public function setPrimaryArticleNumber($primary_article_number)
    {
        if (is_null($primary_article_number)) {
            throw new \InvalidArgumentException('non-nullable primary_article_number cannot be null');
        }
        $this->container['primary_article_number'] = $primary_article_number;
     ...
     *
     * @param string|null $variant_article_number variant_article_number
     *
     * @return self
     */

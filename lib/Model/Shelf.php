 ...
 */
class Shelf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shelf';
    ...
    protected static $openAPITypes = [
        ...
        'storage_places' => '\kruegge82\weclapp\Model\NestedStoragePlace[]'
    ];
    ...
    protected static $setters = [
        ...
        'storage_places' => 'setStoragePlaces'
    ];
    ...
    protected static $getters = [
        ...
        'storage_places' => 'getStoragePlaces'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('storage_places', $data ?? [], null);
    }
    ...
    */
     ...
     */
    public function getStoragePlaces()
    {
        return $this->container['storage_places'];
    }

    /**
     * Sets storage_places
     *
     * @param \kruegge82\weclapp\Model\NestedStoragePlace[]|null $storage_places storage_places
     *
     * @return self
     */
    public function setStoragePlaces($storage_places)
    {
        if (is_null($storage_places)) {
            throw new \InvalidArgumentException('non-nullable storage_places cannot be null');
        }
        $this->container['storage_places'] = $storage_places;

...
class Shelf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['storage_places'] === null) {
            $invalidProperties[] = "'storage_places' can't be null";
        }
     ...
     *
     * @param string $storage_location_id storage_location_id
     *
     * @return self
     */
     ...
     * Gets storage_places
     *
     * @return \kruegge82\weclapp\Model\NestedStoragePlace[]
     */
     ...
     * Sets storage_places
     *
     * @param \kruegge82\weclapp\Model\NestedStoragePlace[] $storage_places storage_places
     *
     * @return self
     */

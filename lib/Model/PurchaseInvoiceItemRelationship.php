...
/**
 * PurchaseInvoiceItemRelationship Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseInvoiceItemRelationship implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'purchaseInvoiceItemRelationship';
    ...
    protected static $setters = [
        ...
        'supplier_order_item_id' => 'setSupplierOrderItemId'
    ];
    ...
    protected static $getters = [
        ...
        'supplier_order_item_id' => 'getSupplierOrderItemId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('supplier_order_item_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($quantity)))) {
            throw new \InvalidArgumentException("invalid value for \$quantity when calling PurchaseInvoiceItemRelationship., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    {
        return $this->container['supplier_order_item_id'];
    }

    /**
     * Sets supplier_order_item_id
     *
     * @param string|null $supplier_order_item_id supplier_order_item_id
     *
     * @return self
     * @deprecated
     */
    public function setSupplierOrderItemId($supplier_order_item_id)
    {
        if (is_null($supplier_order_item_id)) {
            throw new \InvalidArgumentException('non-nullable supplier_order_item_id cannot be null');
        }
        $this->container['supplier_order_item_id'] = $supplier_order_item_id;

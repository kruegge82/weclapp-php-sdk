...
class TermOfPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'due_date_option' => '\kruegge82\weclapp\Model\DueDateOption',
        'fixed_day' => 'int',
        'name' => 'string',
        'number_of_days' => 'int',
        'reference' => 'string',
    ...
    */
     ...
     *
     * @return \kruegge82\weclapp\Model\DueDateOption|null
     */
     ...
     *
     * @param \kruegge82\weclapp\Model\DueDateOption|null $due_date_option due_date_option
     *
     * @return self
     */

...
class TermOfPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['reference']) && (mb_strlen($this->container['reference']) > 30)) {
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TermOfPayment., must be smaller than or equal to 255.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TermOfPayment., must be smaller than or equal to 255.');
        }
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 30)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling TermOfPayment., must be smaller than or equal to 30.');
        }

...
class BankAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const AUTOMATIC_PROCESSING_BOOK = 'BOOK';
    public const AUTOMATIC_PROCESSING_CLEAR = 'CLEAR';
    public const AUTOMATIC_PROCESSING_NONE = 'NONE';
    public const AUTOMATIC_PROCESSING_PROCESS = 'PROCESS';
     ...
     * @return string[]
     */
    public function getAutomaticProcessingAllowableValues()
    {
        return [
            self::AUTOMATIC_PROCESSING_BOOK,
            self::AUTOMATIC_PROCESSING_CLEAR,
            self::AUTOMATIC_PROCESSING_NONE,
            self::AUTOMATIC_PROCESSING_PROCESS,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAutomaticProcessingAllowableValues();
        if (!is_null($this->container['automatic_processing']) && !in_array($this->container['automatic_processing'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'automatic_processing', must be one of '%s'",
                $this->container['automatic_processing'],
     ...
     *
     * @param string|null $automatic_processing automatic_processing
     *
     * @return self
     */
    public function setAutomaticProcessing($automatic_processing)
    {
        ...
        $allowedValues = $this->getAutomaticProcessingAllowableValues();
        if (!in_array($automatic_processing, $allowedValues, true)) {

    ...
    */
    ...
    public function setCounter($counter)
    {
        ...
        if ((mb_strlen($counter) > 255)) {
            throw new \InvalidArgumentException('invalid length for $counter when calling InventoryCreatePostRequestInventory., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InventoryCreatePostRequestInventory., must be smaller than or equal to 255.');
        }
    ...
    public function setInventoryNumber($inventory_number)
    {
        ...
        if ((mb_strlen($inventory_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_number when calling InventoryCreatePostRequestInventory., must be smaller than or equal to 255.');
        }
    ...
    public function setRecorder($recorder)
    {
        ...
        if ((mb_strlen($recorder) > 255)) {
            throw new \InvalidArgumentException('invalid length for $recorder when calling InventoryCreatePostRequestInventory., must be smaller than or equal to 255.');
        }

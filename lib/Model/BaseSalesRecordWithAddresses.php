    ...
    */
    ...
    public function setCommercialLanguage($commercial_language)
    {
        ...
        if ((mb_strlen($commercial_language) > 255)) {
            throw new \InvalidArgumentException('invalid length for $commercial_language when calling BaseSalesRecordWithAddresses., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BaseSalesRecordWithAddresses., must be smaller than or equal to 255.');
        }
    ...
    public function setRecordComment($record_comment)
    {
        ...
        if ((mb_strlen($record_comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $record_comment when calling BaseSalesRecordWithAddresses., must be smaller than or equal to 255.');
        }
    ...
    public function setRecordFreeText($record_free_text)
    {
        ...
        if ((mb_strlen($record_free_text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $record_free_text when calling BaseSalesRecordWithAddresses., must be smaller than or equal to 255.');
        }
    ...
    public function setRecordOpening($record_opening)
    {
        ...
        if ((mb_strlen($record_opening) > 255)) {
            throw new \InvalidArgumentException('invalid length for $record_opening when calling BaseSalesRecordWithAddresses., must be smaller than or equal to 255.');
        }
    ...
    public function setCommission($commission)
    {
        ...
        if ((mb_strlen($commission) > 255)) {
            throw new \InvalidArgumentException('invalid length for $commission when calling BaseSalesRecordWithAddresses., must be smaller than or equal to 255.');
        }

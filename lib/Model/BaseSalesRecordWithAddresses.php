    ...
    */
    ...
    public function setDispatchCountryCode($dispatch_country_code)
    {
        ...
        if ((mb_strlen($dispatch_country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $dispatch_country_code when calling BaseSalesRecordWithAddresses., must be smaller than or equal to 5.');
        }

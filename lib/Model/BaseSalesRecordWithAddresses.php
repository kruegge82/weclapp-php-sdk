...
/**
 * BaseSalesRecordWithAddresses Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class BaseSalesRecordWithAddresses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'baseSalesRecordWithAddresses';
    ...
    */
    ...
    public function setCurrencyConversionRate($currency_conversion_rate)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($currency_conversion_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$currency_conversion_rate when calling BaseSalesRecordWithAddresses., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setGrossAmount($gross_amount)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($gross_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$gross_amount when calling BaseSalesRecordWithAddresses., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setGrossAmountInCompanyCurrency($gross_amount_in_company_currency)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($gross_amount_in_company_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$gross_amount_in_company_currency when calling BaseSalesRecordWithAddresses., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setHeaderDiscount($header_discount)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($header_discount)))) {
            throw new \InvalidArgumentException("invalid value for \$header_discount when calling BaseSalesRecordWithAddresses., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setHeaderSurcharge($header_surcharge)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($header_surcharge)))) {
            throw new \InvalidArgumentException("invalid value for \$header_surcharge when calling BaseSalesRecordWithAddresses., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setNetAmount($net_amount)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($net_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$net_amount when calling BaseSalesRecordWithAddresses., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setNetAmountInCompanyCurrency($net_amount_in_company_currency)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($net_amount_in_company_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$net_amount_in_company_currency when calling BaseSalesRecordWithAddresses., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }

...
class Period implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'version' => 'setVersion',
        'financial_year_id' => 'setFinancialYearId',
        'name' => 'setName',
        'open' => 'setOpen',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('financial_year_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets financial_year_id
     *
     * @return string|null
     */
    public function getFinancialYearId()
    {
        return $this->container['financial_year_id'];
    }

    /**
     * Sets financial_year_id
     *
     * @param string|null $financial_year_id financial_year_id
     *
     * @return self
     */
    public function setFinancialYearId($financial_year_id)
    {
        if (is_null($financial_year_id)) {
            throw new \InvalidArgumentException('non-nullable financial_year_id cannot be null');
        }
        $this->container['financial_year_id'] = $financial_year_id;

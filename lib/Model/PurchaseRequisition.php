    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['requisition_number']) && (mb_strlen($this->container['requisition_number']) > 30)) {
            $invalidProperties[] = "invalid value for 'requisition_number', the character length must be smaller than or equal to 30.";
        }
    ...
    public function setRequisitionNumber($requisition_number)
    {
        ...
        if ((mb_strlen($requisition_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $requisition_number when calling PurchaseRequisition., must be smaller than or equal to 30.');
        }

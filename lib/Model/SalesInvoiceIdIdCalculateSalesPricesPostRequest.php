<?php
/**
 * SalesInvoiceIdIdCalculateSalesPricesPostRequest
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * SalesInvoiceIdIdCalculateSalesPricesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class SalesInvoiceIdIdCalculateSalesPricesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_salesInvoice_id__id__calculateSalesPrices_post_request';
    ...
    protected static $setters = [
        ...
        'invoice_item_ids' => 'setInvoiceItemIds',
    ...
    protected static $getters = [
        ...
        'invoice_item_ids' => 'getInvoiceItemIds',
    ...
    public const CALCULATION_MODE_COST_SURCHARGE = 'COST_SURCHARGE';
    public const CALCULATION_MODE_TARGET_MARGIN = 'TARGET_MARGIN';
    ...
    {
        return [
            self::CALCULATION_MODE_COST_SURCHARGE,
            self::CALCULATION_MODE_TARGET_MARGIN,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('invoice_item_ids', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string $calculation_mode calculation_mode
     *
     * @return self
     */
    public function setCalculationMode($calculation_mode)
    {
        ...
        $allowedValues = $this->getCalculationModeAllowableValues();
        if (!in_array($calculation_mode, $allowedValues, true)) {
    ...
    /**
     * Gets invoice_item_ids
     *
     * @return string[]|null
     */
    public function getInvoiceItemIds()
    {
        return $this->container['invoice_item_ids'];
    }

    /**
     * Sets invoice_item_ids
     *
     * @param string[]|null $invoice_item_ids invoice_item_ids
     *
     * @return self
     */
    public function setInvoiceItemIds($invoice_item_ids)
    {
        if (is_null($invoice_item_ids)) {
            throw new \InvalidArgumentException('non-nullable invoice_item_ids cannot be null');
        }
        $this->container['invoice_item_ids'] = $invoice_item_ids;

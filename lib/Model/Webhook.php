...
class Webhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['entity_name']) && (mb_strlen($this->container['entity_name']) > 255)) {
            $invalidProperties[] = "invalid value for 'entity_name', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['error_message']) && (mb_strlen($this->container['error_message']) > 255)) {
            $invalidProperties[] = "invalid value for 'error_message', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['url']) && (mb_strlen($this->container['url']) > 1000)) {
    ...
    public function setEntityName($entity_name)
    {
        ...
        if ((mb_strlen($entity_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $entity_name when calling Webhook., must be smaller than or equal to 255.');
        }
    ...
    public function setErrorMessage($error_message)
    {
        ...
        if ((mb_strlen($error_message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $error_message when calling Webhook., must be smaller than or equal to 255.');
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $url when calling Webhook., must be smaller than or equal to 1000.');
        }

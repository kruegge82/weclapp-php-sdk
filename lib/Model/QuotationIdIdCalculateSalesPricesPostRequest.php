<?php
/**
 * QuotationIdIdCalculateSalesPricesPostRequest
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * QuotationIdIdCalculateSalesPricesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class QuotationIdIdCalculateSalesPricesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_quotation_id__id__calculateSalesPrices_post_request';

...
class WarehouseStockMovement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const STOCK_MOVEMENT_TYPE_IN = 'IN';
    public const STOCK_MOVEMENT_TYPE_IN_CUSTOMER_RETURN = 'IN_CUSTOMER_RETURN';
    public const STOCK_MOVEMENT_TYPE_IN_DISABLE_TRANSPORT_REFERENCE = 'IN_DISABLE_TRANSPORT_REFERENCE';
    public const STOCK_MOVEMENT_TYPE_IN_INVENTORY = 'IN_INVENTORY';
    public const STOCK_MOVEMENT_TYPE_IN_PACKAGING_UNIT_TRANSFORMATION = 'IN_PACKAGING_UNIT_TRANSFORMATION';
    public const STOCK_MOVEMENT_TYPE_IN_PRODUCTION_ORDER = 'IN_PRODUCTION_ORDER';
    public const STOCK_MOVEMENT_TYPE_IN_PURCHASE_ORDER = 'IN_PURCHASE_ORDER';
    public const STOCK_MOVEMENT_TYPE_IN_REPACK_ON_TRANSPORT_REFERENCE = 'IN_REPACK_ON_TRANSPORT_REFERENCE';
    public const STOCK_MOVEMENT_TYPE_IN_SHIPMENT = 'IN_SHIPMENT';
    public const STOCK_MOVEMENT_TYPE_IN_SHIPMENT_CANCELLATION = 'IN_SHIPMENT_CANCELLATION';
    public const STOCK_MOVEMENT_TYPE_IN_SHIPMENT_CONSIGNMENT = 'IN_SHIPMENT_CONSIGNMENT';
    public const STOCK_MOVEMENT_TYPE_IN_SHIPMENT_INTERNAL = 'IN_SHIPMENT_INTERNAL';
    public const STOCK_MOVEMENT_TYPE_IN_THIRD_PARTY_DEAL = 'IN_THIRD_PARTY_DEAL';
    public const STOCK_MOVEMENT_TYPE_IN_TRANSFER = 'IN_TRANSFER';
    public const STOCK_MOVEMENT_TYPE_OUT = 'OUT';
    public const STOCK_MOVEMENT_TYPE_OUT_DISABLE_TRANSPORT_REFERENCE = 'OUT_DISABLE_TRANSPORT_REFERENCE';
    public const STOCK_MOVEMENT_TYPE_OUT_INVENTORY = 'OUT_INVENTORY';
    public const STOCK_MOVEMENT_TYPE_OUT_PACKAGING_UNIT_TRANSFORMATION = 'OUT_PACKAGING_UNIT_TRANSFORMATION';
    public const STOCK_MOVEMENT_TYPE_OUT_PRODUCTION_ORDER = 'OUT_PRODUCTION_ORDER';
    public const STOCK_MOVEMENT_TYPE_OUT_REPACK_ON_TRANSPORT_REFERENCE = 'OUT_REPACK_ON_TRANSPORT_REFERENCE';
    public const STOCK_MOVEMENT_TYPE_OUT_SALES_ORDER = 'OUT_SALES_ORDER';
    public const STOCK_MOVEMENT_TYPE_OUT_SHIPMENT = 'OUT_SHIPMENT';
    public const STOCK_MOVEMENT_TYPE_OUT_SHIPMENT_CANCELLATION = 'OUT_SHIPMENT_CANCELLATION';
    public const STOCK_MOVEMENT_TYPE_OUT_SHIPMENT_CONSIGNMENT = 'OUT_SHIPMENT_CONSIGNMENT';
    public const STOCK_MOVEMENT_TYPE_OUT_SHIPMENT_INTERNAL = 'OUT_SHIPMENT_INTERNAL';
    public const STOCK_MOVEMENT_TYPE_OUT_THIRD_PARTY_DEAL = 'OUT_THIRD_PARTY_DEAL';
    public const STOCK_MOVEMENT_TYPE_OUT_TRANSFER = 'OUT_TRANSFER';
     ...
     * @return string[]
     */
    public function getStockMovementTypeAllowableValues()
    {
        return [
            self::STOCK_MOVEMENT_TYPE_IN,
            self::STOCK_MOVEMENT_TYPE_IN_CUSTOMER_RETURN,
            self::STOCK_MOVEMENT_TYPE_IN_DISABLE_TRANSPORT_REFERENCE,
            self::STOCK_MOVEMENT_TYPE_IN_INVENTORY,
            self::STOCK_MOVEMENT_TYPE_IN_PACKAGING_UNIT_TRANSFORMATION,
            self::STOCK_MOVEMENT_TYPE_IN_PRODUCTION_ORDER,
            self::STOCK_MOVEMENT_TYPE_IN_PURCHASE_ORDER,
            self::STOCK_MOVEMENT_TYPE_IN_REPACK_ON_TRANSPORT_REFERENCE,
            self::STOCK_MOVEMENT_TYPE_IN_SHIPMENT,
            self::STOCK_MOVEMENT_TYPE_IN_SHIPMENT_CANCELLATION,
            self::STOCK_MOVEMENT_TYPE_IN_SHIPMENT_CONSIGNMENT,
            self::STOCK_MOVEMENT_TYPE_IN_SHIPMENT_INTERNAL,
            self::STOCK_MOVEMENT_TYPE_IN_THIRD_PARTY_DEAL,
            self::STOCK_MOVEMENT_TYPE_IN_TRANSFER,
            self::STOCK_MOVEMENT_TYPE_OUT,
            self::STOCK_MOVEMENT_TYPE_OUT_DISABLE_TRANSPORT_REFERENCE,
            self::STOCK_MOVEMENT_TYPE_OUT_INVENTORY,
            self::STOCK_MOVEMENT_TYPE_OUT_PACKAGING_UNIT_TRANSFORMATION,
            self::STOCK_MOVEMENT_TYPE_OUT_PRODUCTION_ORDER,
            self::STOCK_MOVEMENT_TYPE_OUT_REPACK_ON_TRANSPORT_REFERENCE,
            self::STOCK_MOVEMENT_TYPE_OUT_SALES_ORDER,
            self::STOCK_MOVEMENT_TYPE_OUT_SHIPMENT,
            self::STOCK_MOVEMENT_TYPE_OUT_SHIPMENT_CANCELLATION,
            self::STOCK_MOVEMENT_TYPE_OUT_SHIPMENT_CONSIGNMENT,
            self::STOCK_MOVEMENT_TYPE_OUT_SHIPMENT_INTERNAL,
            self::STOCK_MOVEMENT_TYPE_OUT_THIRD_PARTY_DEAL,
            self::STOCK_MOVEMENT_TYPE_OUT_TRANSFER,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getStockMovementTypeAllowableValues();
        if (!is_null($this->container['stock_movement_type']) && !in_array($this->container['stock_movement_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'stock_movement_type', must be one of '%s'",
                $this->container['stock_movement_type'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['valuation_price'] === null) {
            $invalidProperties[] = "'valuation_price' can't be null";
        }
     ...
     * Sets posting_date
     *
     * @param int $posting_date posting_date
     *
     * @return self
     */
     ...
     *
     * @param string|null $stock_movement_type stock_movement_type
     *
     * @return self
     */
    public function setStockMovementType($stock_movement_type)
    {
        ...
        $allowedValues = $this->getStockMovementTypeAllowableValues();
        if (!in_array($stock_movement_type, $allowedValues, true)) {
     ...
     *
     * @param float $valuation_price valuation_price
     *
     * @return self
     */

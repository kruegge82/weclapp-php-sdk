...
class WarehouseStockMovement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['movement_note']) && (mb_strlen($this->container['movement_note']) > 255)) {
            $invalidProperties[] = "invalid value for 'movement_note', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setMovementNote($movement_note)
    {
        ...
        if ((mb_strlen($movement_note) > 255)) {
            throw new \InvalidArgumentException('invalid length for $movement_note when calling WarehouseStockMovement., must be smaller than or equal to 255.');
        }

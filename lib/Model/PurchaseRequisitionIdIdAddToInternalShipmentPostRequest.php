...
/**
 * PurchaseRequisitionIdIdAddToInternalShipmentPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseRequisitionIdIdAddToInternalShipmentPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_purchaseRequisition_id__id__addToInternalShipment_post_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['internal_shipment_id'] === null) {
            $invalidProperties[] = "'internal_shipment_id' can't be null";
        }
     ...
     *
     * @param string $internal_shipment_id internal_shipment_id
     *
     * @return self
     */

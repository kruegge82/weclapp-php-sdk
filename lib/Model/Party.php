...
class Party implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'supplier_merge_items_for_ocr_invoice_upload' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'supplier_merge_items_for_ocr_invoice_upload' => false,
    ...
    protected static $attributeMap = [
        ...
        'supplier_merge_items_for_ocr_invoice_upload' => 'supplierMergeItemsForOcrInvoiceUpload',
    ...
    protected static $setters = [
        ...
        'supplier_merge_items_for_ocr_invoice_upload' => 'setSupplierMergeItemsForOcrInvoiceUpload',
    ...
    protected static $getters = [
        ...
        'supplier_merge_items_for_ocr_invoice_upload' => 'getSupplierMergeItemsForOcrInvoiceUpload',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('supplier_merge_items_for_ocr_invoice_upload', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customer_block_notice']) && (mb_strlen($this->container['customer_block_notice']) > 1000)) {
            $invalidProperties[] = "invalid value for 'customer_block_notice', the character length must be smaller than or equal to 1000.";
        }
        ...
        if (!is_null($this->container['customer_internal_note']) && (mb_strlen($this->container['customer_internal_note']) > 4000)) {
            $invalidProperties[] = "invalid value for 'customer_internal_note', the character length must be smaller than or equal to 4000.";
        }
        ...
        if (!is_null($this->container['customer_number_old']) && (mb_strlen($this->container['customer_number_old']) > 1000)) {
            $invalidProperties[] = "invalid value for 'customer_number_old', the character length must be smaller than or equal to 1000.";
        }
        ...
        if (!is_null($this->container['eori_number']) && (mb_strlen($this->container['eori_number']) > 1000)) {
            $invalidProperties[] = "invalid value for 'eori_number', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['fix_phone2']) && (mb_strlen($this->container['fix_phone2']) > 1000)) {
            $invalidProperties[] = "invalid value for 'fix_phone2', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['mobile_phone2']) && (mb_strlen($this->container['mobile_phone2']) > 1000)) {
            $invalidProperties[] = "invalid value for 'mobile_phone2', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['phone_home']) && (mb_strlen($this->container['phone_home']) > 1000)) {
            $invalidProperties[] = "invalid value for 'phone_home', the character length must be smaller than or equal to 1000.";
        }
        ...
        if (!is_null($this->container['supplier_customer_number_at_supplier']) && (mb_strlen($this->container['supplier_customer_number_at_supplier']) > 64)) {
            $invalidProperties[] = "invalid value for 'supplier_customer_number_at_supplier', the character length must be smaller than or equal to 64.";
        }

        if (!is_null($this->container['supplier_internal_note']) && (mb_strlen($this->container['supplier_internal_note']) > 1000)) {
        ...
        if (!is_null($this->container['supplier_number_old']) && (mb_strlen($this->container['supplier_number_old']) > 1000)) {
            $invalidProperties[] = "invalid value for 'supplier_number_old', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['tax_id']) && (mb_strlen($this->container['tax_id']) > 1000)) {
            $invalidProperties[] = "invalid value for 'tax_id', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['vat_identification_number']) && (mb_strlen($this->container['vat_identification_number']) > 1000)) {
            $invalidProperties[] = "invalid value for 'vat_identification_number', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['x_rechnung_leitweg_id']) && (mb_strlen($this->container['x_rechnung_leitweg_id']) > 46)) {
            $invalidProperties[] = "invalid value for 'x_rechnung_leitweg_id', the character length must be smaller than or equal to 46.";
        }
    ...
    public function setCompany($company)
    {
        ...
        if ((mb_strlen($company) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $company when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setCompany2($company2)
    {
        ...
        if ((mb_strlen($company2) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $company2 when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setEmailHome($email_home)
    {
        ...
        if ((mb_strlen($email_home) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $email_home when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setFax($fax)
    {
        ...
        if ((mb_strlen($fax) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $fax when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setMiddleName($middle_name)
    {
        ...
        if ((mb_strlen($middle_name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setMobilePhone1($mobile_phone1)
    {
        ...
        if ((mb_strlen($mobile_phone1) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $mobile_phone1 when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setPersonCompany($person_company)
    {
        ...
        if ((mb_strlen($person_company) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $person_company when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setWebsite($website)
    {
        ...
        if ((mb_strlen($website) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $website when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setCustomerBlockNotice($customer_block_notice)
    {
        ...
        if ((mb_strlen($customer_block_notice) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $customer_block_notice when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setCustomerInternalNote($customer_internal_note)
    {
        ...
        if ((mb_strlen($customer_internal_note) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $customer_internal_note when calling Party., must be smaller than or equal to 4000.');
        }
    ...
    public function setCustomerNumber($customer_number)
    {
        ...
        if ((mb_strlen($customer_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $customer_number when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setCustomerNumberOld($customer_number_old)
    {
        ...
        if ((mb_strlen($customer_number_old) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $customer_number_old when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setCustomerSupplierNumber($customer_supplier_number)
    {
        ...
        if ((mb_strlen($customer_supplier_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $customer_supplier_number when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setEoriNumber($eori_number)
    {
        ...
        if ((mb_strlen($eori_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $eori_number when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setFixPhone2($fix_phone2)
    {
        ...
        if ((mb_strlen($fix_phone2) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $fix_phone2 when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setMobilePhone2($mobile_phone2)
    {
        ...
        if ((mb_strlen($mobile_phone2) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $mobile_phone2 when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setPhoneHome($phone_home)
    {
        ...
        if ((mb_strlen($phone_home) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $phone_home when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setPublicPageUuid($public_page_uuid)
    {
        ...
        if ((mb_strlen($public_page_uuid) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $public_page_uuid when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setReferenceNumber($reference_number)
    {
        ...
        if ((mb_strlen($reference_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $reference_number when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setSupplierCustomerNumberAtSupplier($supplier_customer_number_at_supplier)
    {
        ...
        if ((mb_strlen($supplier_customer_number_at_supplier) > 64)) {
            throw new \InvalidArgumentException('invalid length for $supplier_customer_number_at_supplier when calling Party., must be smaller than or equal to 64.');
        }
    ...
    public function setSupplierInternalNote($supplier_internal_note)
    {
        ...
        if ((mb_strlen($supplier_internal_note) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $supplier_internal_note when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    /**
     * Gets supplier_merge_items_for_ocr_invoice_upload
     *
     * @return bool|null
     */
    public function getSupplierMergeItemsForOcrInvoiceUpload()
    {
        return $this->container['supplier_merge_items_for_ocr_invoice_upload'];
    }

    /**
     * Sets supplier_merge_items_for_ocr_invoice_upload
     *
     * @param bool|null $supplier_merge_items_for_ocr_invoice_upload supplier_merge_items_for_ocr_invoice_upload
     *
     * @return self
     */
    public function setSupplierMergeItemsForOcrInvoiceUpload($supplier_merge_items_for_ocr_invoice_upload)
    {
        if (is_null($supplier_merge_items_for_ocr_invoice_upload)) {
            throw new \InvalidArgumentException('non-nullable supplier_merge_items_for_ocr_invoice_upload cannot be null');
        }
        $this->container['supplier_merge_items_for_ocr_invoice_upload'] = $supplier_merge_items_for_ocr_invoice_upload;
    ...
    public function setSupplierNumber($supplier_number)
    {
        ...
        if ((mb_strlen($supplier_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $supplier_number when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setSupplierNumberOld($supplier_number_old)
    {
        ...
        if ((mb_strlen($supplier_number_old) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $supplier_number_old when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setTaxId($tax_id)
    {
        ...
        if ((mb_strlen($tax_id) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $tax_id when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setVatIdentificationNumber($vat_identification_number)
    {
        ...
        if ((mb_strlen($vat_identification_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $vat_identification_number when calling Party., must be smaller than or equal to 1000.');
        }
    ...
    public function setXRechnungLeitwegId($x_rechnung_leitweg_id)
    {
        ...
        if ((mb_strlen($x_rechnung_leitweg_id) > 46)) {
            throw new \InvalidArgumentException('invalid length for $x_rechnung_leitweg_id when calling Party., must be smaller than or equal to 46.');
        }

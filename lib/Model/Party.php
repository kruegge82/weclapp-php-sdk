...
class Party implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customer_loss_description']) && (mb_strlen($this->container['customer_loss_description']) > 255)) {
            $invalidProperties[] = "invalid value for 'customer_loss_description', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setCustomerLossDescription($customer_loss_description)
    {
        ...
        if ((mb_strlen($customer_loss_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_loss_description when calling Party., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Party., must be smaller than or equal to 255.');
        }

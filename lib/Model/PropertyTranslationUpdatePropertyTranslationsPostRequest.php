...
/**
 * PropertyTranslationUpdatePropertyTranslationsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class PropertyTranslationUpdatePropertyTranslationsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_propertyTranslation_updatePropertyTranslations_post_request';
    ...
    protected static $openAPITypes = [
        'entity_id' => 'string',
        'entity_name' => 'string',
        'property_translations' => '\kruegge82\weclapp\Model\PropertyTranslationUpdatePropertyTranslationsPostRequestPropertyTranslationsInner[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'property_translations' => 'propertyTranslations'
    ];
    ...
    protected static $setters = [
        ...
        'property_translations' => 'setPropertyTranslations'
    ];
    ...
    protected static $getters = [
        ...
        'property_translations' => 'getPropertyTranslations'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('property_translations', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['property_translations'] === null) {
            $invalidProperties[] = "'property_translations' can't be null";
        }
    ...
    /**
     * Gets property_translations
     *
     * @return \kruegge82\weclapp\Model\PropertyTranslationUpdatePropertyTranslationsPostRequestPropertyTranslationsInner[]
     */
    public function getPropertyTranslations()
    {
        return $this->container['property_translations'];
    }

    /**
     * Sets property_translations
     *
     * @param \kruegge82\weclapp\Model\PropertyTranslationUpdatePropertyTranslationsPostRequestPropertyTranslationsInner[] $property_translations property_translations
     *
     * @return self
     */
    public function setPropertyTranslations($property_translations)
    {
        if (is_null($property_translations)) {
            throw new \InvalidArgumentException('non-nullable property_translations cannot be null');
        }
        $this->container['property_translations'] = $property_translations;

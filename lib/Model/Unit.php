...
class Unit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'name' => 'name',
        'time_unit_amount' => 'timeUnitAmount'
    ];
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'time_unit_amount' => 'setTimeUnitAmount'
    ];
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'time_unit_amount' => 'getTimeUnitAmount'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('time_unit_amount', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets time_unit_amount
     *
     * @return int|null
     */
    public function getTimeUnitAmount()
    {
        return $this->container['time_unit_amount'];
    }

    /**
     * Sets time_unit_amount
     *
     * @param int|null $time_unit_amount time_unit_amount
     *
     * @return self
     */
    public function setTimeUnitAmount($time_unit_amount)
    {
        if (is_null($time_unit_amount)) {
            throw new \InvalidArgumentException('non-nullable time_unit_amount cannot be null');
        }
        $this->container['time_unit_amount'] = $time_unit_amount;

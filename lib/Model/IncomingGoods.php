...
class IncomingGoods implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sender_customer_number']) && (mb_strlen($this->container['sender_customer_number']) > 1000)) {
            $invalidProperties[] = "invalid value for 'sender_customer_number', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['sender_supplier_number']) && (mb_strlen($this->container['sender_supplier_number']) > 1000)) {
            $invalidProperties[] = "invalid value for 'sender_supplier_number', the character length must be smaller than or equal to 1000.";
        }
    ...
    public function setSenderCustomerNumber($sender_customer_number)
    {
        ...
        if ((mb_strlen($sender_customer_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $sender_customer_number when calling IncomingGoods., must be smaller than or equal to 1000.');
        }
    ...
    public function setSenderSupplierNumber($sender_supplier_number)
    {
        ...
        if ((mb_strlen($sender_supplier_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $sender_supplier_number when calling IncomingGoods., must be smaller than or equal to 1000.');
        }

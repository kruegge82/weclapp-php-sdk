...
/**
 * VariantArticleVariant Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class VariantArticleVariant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'variantArticleVariant';
    ...
    protected static $openAPITypes = [
        ...
        'attribute_options' => '\kruegge82\weclapp\Model\OnlyId[]',
        'position_number' => 'int',
        'variant_article_id' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'variant_article_id' => 'variantArticleId',
    ...
    protected static $setters = [
        ...
        'variant_article_id' => 'setVariantArticleId',
    ...
    protected static $getters = [
        ...
        'variant_article_id' => 'getVariantArticleId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('variant_article_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \kruegge82\weclapp\Model\OnlyId[]|null $attribute_options attribute_options
     *
     * @return self
     */
    ...
    /**
     * Gets variant_article_id
     *
     * @return string|null
     */
    public function getVariantArticleId()
    {
        return $this->container['variant_article_id'];
    }

    /**
     * Sets variant_article_id
     *
     * @param string|null $variant_article_id variant_article_id
     *
     * @return self
     */
    public function setVariantArticleId($variant_article_id)
    {
        if (is_null($variant_article_id)) {
            throw new \InvalidArgumentException('non-nullable variant_article_id cannot be null');
        }
        $this->container['variant_article_id'] = $variant_article_id;

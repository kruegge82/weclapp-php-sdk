    ...
    */
    ...
    public function setCurrencyConversionRate($currency_conversion_rate)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($currency_conversion_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$currency_conversion_rate when calling BlanketPurchaseOrder., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) > 512)) {
            throw new \InvalidArgumentException('invalid length for $note when calling BlanketPurchaseOrder., must be smaller than or equal to 512.');
        }
    ...
    public function setRecipientCountryCode($recipient_country_code)
    {
        ...
        if ((mb_strlen($recipient_country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $recipient_country_code when calling BlanketPurchaseOrder., must be smaller than or equal to 5.');
        }
    ...
    public function setSenderCountryCode($sender_country_code)
    {
        ...
        if ((mb_strlen($sender_country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $sender_country_code when calling BlanketPurchaseOrder., must be smaller than or equal to 5.');
        }

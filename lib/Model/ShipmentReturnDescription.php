...
/**
 * ShipmentReturnDescription Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentReturnDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipmentReturnDescription';
    ...
    protected static $setters = [
        ...
        'supplier_return' => 'setSupplierReturn'
    ];
    ...
    protected static $getters = [
        ...
        'supplier_return' => 'getSupplierReturn'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('supplier_return', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $customer_return customer_return
     *
     * @return self
     */
    ...
    /**
     * Gets supplier_return
     *
     * @return bool|null
     */
    public function getSupplierReturn()
    {
        return $this->container['supplier_return'];
    }

    /**
     * Sets supplier_return
     *
     * @param bool|null $supplier_return supplier_return
     *
     * @return self
     */
    public function setSupplierReturn($supplier_return)
    {
        if (is_null($supplier_return)) {
            throw new \InvalidArgumentException('non-nullable supplier_return cannot be null');
        }
        $this->container['supplier_return'] = $supplier_return;

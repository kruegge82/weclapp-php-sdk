...
/**
 * PurchaseInvoiceItem Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseInvoiceItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'purchaseInvoiceItem';
    ...
    protected static $openAPITypes = [
        ...
        'delivery_date' => 'int',
        'purchase_invoice_item_relationships' => '\kruegge82\weclapp\Model\PurchaseInvoiceItemRelationship[]',
    ...
    protected static $openAPIFormats = [
        ...
        'purchase_invoice_item_relationships' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'delivery_date' => false,
        'purchase_invoice_item_relationships' => false,
    ...
    protected static $attributeMap = [
        ...
        'purchase_invoice_item_relationships' => 'purchaseInvoiceItemRelationships',
    ...
    protected static $setters = [
        ...
        'purchase_invoice_item_relationships' => 'setPurchaseInvoiceItemRelationships',
    ...
    protected static $getters = [
        ...
        'purchase_invoice_item_relationships' => 'getPurchaseInvoiceItemRelationships',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('purchase_invoice_item_relationships', $data ?? [], null);
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($quantity)))) {
            throw new \InvalidArgumentException("invalid value for \$quantity when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setDiscountPercentage($discount_percentage)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($discount_percentage)))) {
            throw new \InvalidArgumentException("invalid value for \$discount_percentage when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setGrossAmount($gross_amount)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($gross_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$gross_amount when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setGrossAmountInCompanyCurrency($gross_amount_in_company_currency)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($gross_amount_in_company_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$gross_amount_in_company_currency when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setNetAmount($net_amount)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($net_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$net_amount when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setNetAmountForStatistics($net_amount_for_statistics)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($net_amount_for_statistics)))) {
            throw new \InvalidArgumentException("invalid value for \$net_amount_for_statistics when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setNetAmountForStatisticsInCompanyCurrency($net_amount_for_statistics_in_company_currency)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($net_amount_for_statistics_in_company_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$net_amount_for_statistics_in_company_currency when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setNetAmountInCompanyCurrency($net_amount_in_company_currency)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($net_amount_in_company_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$net_amount_in_company_currency when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($unit_price)))) {
            throw new \InvalidArgumentException("invalid value for \$unit_price when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setUnitPriceInCompanyCurrency($unit_price_in_company_currency)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($unit_price_in_company_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$unit_price_in_company_currency when calling PurchaseInvoiceItem., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    /**
     * Gets purchase_invoice_item_relationships
     *
     * @return \kruegge82\weclapp\Model\PurchaseInvoiceItemRelationship[]|null
     */
    public function getPurchaseInvoiceItemRelationships()
    {
        return $this->container['purchase_invoice_item_relationships'];
    }

    /**
     * Sets purchase_invoice_item_relationships
     *
     * @param \kruegge82\weclapp\Model\PurchaseInvoiceItemRelationship[]|null $purchase_invoice_item_relationships purchase_invoice_item_relationships
     *
     * @return self
     */
    public function setPurchaseInvoiceItemRelationships($purchase_invoice_item_relationships)
    {
        if (is_null($purchase_invoice_item_relationships)) {
            throw new \InvalidArgumentException('non-nullable purchase_invoice_item_relationships cannot be null');
        }
        $this->container['purchase_invoice_item_relationships'] = $purchase_invoice_item_relationships;

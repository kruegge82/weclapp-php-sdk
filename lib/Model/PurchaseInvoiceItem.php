...
class PurchaseInvoiceItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'delivery_date' => 'int',
        'purchase_invoice_item_relationship' => '\kruegge82\weclapp\Model\PurchaseInvoiceItemRelationship[]',
    ...
    protected static $openAPIFormats = [
        ...
        'purchase_invoice_item_relationship' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'delivery_date' => false,
        'purchase_invoice_item_relationship' => false,
    ...
    protected static $attributeMap = [
        ...
        'purchase_invoice_item_relationship' => 'purchaseInvoiceItemRelationship',
    ...
    protected static $setters = [
        ...
        'purchase_invoice_item_relationship' => 'setPurchaseInvoiceItemRelationship',
    ...
    protected static $getters = [
        ...
        'purchase_invoice_item_relationship' => 'getPurchaseInvoiceItemRelationship',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('purchase_invoice_item_relationship', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets purchase_invoice_item_relationship
     *
     * @return \kruegge82\weclapp\Model\PurchaseInvoiceItemRelationship[]|null
     * @deprecated
     */
    public function getPurchaseInvoiceItemRelationship()
    {
        return $this->container['purchase_invoice_item_relationship'];
    }

    /**
     * Sets purchase_invoice_item_relationship
     *
     * @param \kruegge82\weclapp\Model\PurchaseInvoiceItemRelationship[]|null $purchase_invoice_item_relationship purchase_invoice_item_relationship
     *
     * @return self
     * @deprecated
     */
    public function setPurchaseInvoiceItemRelationship($purchase_invoice_item_relationship)
    {
        if (is_null($purchase_invoice_item_relationship)) {
            throw new \InvalidArgumentException('non-nullable purchase_invoice_item_relationship cannot be null');
        }
        $this->container['purchase_invoice_item_relationship'] = $purchase_invoice_item_relationship;

...
/**
 * ConditionsForEntityType Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class ConditionsForEntityType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conditionsForEntityType';
    ...
    protected static $openAPITypes = [
        'entity_type' => '\kruegge82\weclapp\Model\CustomAttributeExtendableEntity',
        'property_conditions' => '\kruegge82\weclapp\Model\CustomAttributeDefinitionPropertyCondition[]'
    ];
    ...
    protected static $setters = [
        ...
        'property_conditions' => 'setPropertyConditions'
    ];
    ...
    protected static $getters = [
        ...
        'property_conditions' => 'getPropertyConditions'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('property_conditions', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets entity_type
     *
     * @return \kruegge82\weclapp\Model\CustomAttributeExtendableEntity|null
     */
     ...
     * Sets entity_type
     *
     * @param \kruegge82\weclapp\Model\CustomAttributeExtendableEntity|null $entity_type entity_type
     *
     * @return self
     */
    ...
    /**
     * Gets property_conditions
     *
     * @return \kruegge82\weclapp\Model\CustomAttributeDefinitionPropertyCondition[]|null
     */
    public function getPropertyConditions()
    {
        return $this->container['property_conditions'];
    }

    /**
     * Sets property_conditions
     *
     * @param \kruegge82\weclapp\Model\CustomAttributeDefinitionPropertyCondition[]|null $property_conditions property_conditions
     *
     * @return self
     */
    public function setPropertyConditions($property_conditions)
    {
        if (is_null($property_conditions)) {
            throw new \InvalidArgumentException('non-nullable property_conditions cannot be null');
        }
        $this->container['property_conditions'] = $property_conditions;

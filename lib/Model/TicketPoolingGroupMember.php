...
/**
 * TicketPoolingGroupMember Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class TicketPoolingGroupMember implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ticketPoolingGroupMember';
    ...
    protected static $openAPITypes = [
        ...
        'version' => 'string',
        'ticket_pooling_group_id' => 'string',
        'user_id' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'version' => 'version',
        'ticket_pooling_group_id' => 'ticketPoolingGroupId',
        'user_id' => 'userId'
    ];
    ...
    protected static $setters = [
        ...
        'version' => 'setVersion',
        'ticket_pooling_group_id' => 'setTicketPoolingGroupId',
        'user_id' => 'setUserId'
    ];
    ...
    protected static $getters = [
        ...
        'version' => 'getVersion',
        'ticket_pooling_group_id' => 'getTicketPoolingGroupId',
        'user_id' => 'getUserId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ticket_pooling_group_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets ticket_pooling_group_id
     *
     * @return string|null
     */
    public function getTicketPoolingGroupId()
    {
        return $this->container['ticket_pooling_group_id'];
    }

    /**
     * Sets ticket_pooling_group_id
     *
     * @param string|null $ticket_pooling_group_id ticket_pooling_group_id
     *
     * @return self
     */
    public function setTicketPoolingGroupId($ticket_pooling_group_id)
    {
        if (is_null($ticket_pooling_group_id)) {
            throw new \InvalidArgumentException('non-nullable ticket_pooling_group_id cannot be null');
        }
        $this->container['ticket_pooling_group_id'] = $ticket_pooling_group_id;

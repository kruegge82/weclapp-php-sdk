...
class PartyHabitualExporterLetterOfIntent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_MULTIPLE_ACCOUNTING_EVENTS = 'MULTIPLE_ACCOUNTING_EVENTS';
    public const TYPE_SINGLE_ACCOUNTING_EVENT = 'SINGLE_ACCOUNTING_EVENT';
    ...
    {
        return [
            self::TYPE_MULTIPLE_ACCOUNTING_EVENTS,
            self::TYPE_SINGLE_ACCOUNTING_EVENT,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['number_declarer'] === null) {
            $invalidProperties[] = "'number_declarer' can't be null";
        }
     ...
     *
     * @param string $number_declarer number_declarer
     *
     * @return self
     */

...
/**
 * TransportationOrderIdIdPutDownInternalTransportReferencePostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class TransportationOrderIdIdPutDownInternalTransportReferencePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_transportationOrder_id__id__putDownInternalTransportReference_post_request';
    ...
    protected static $openAPITypes = [
        'target_loading_equipment_identifier_id' => 'string',
        'target_storage_place_id' => 'string',
        'target_transport_reference_id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'target_loading_equipment_identifier_id' => null,
        'target_storage_place_id' => null,
        'target_transport_reference_id' => null
    ];
    ...
    protected static array $openAPINullables = [
        'target_loading_equipment_identifier_id' => false,
        'target_storage_place_id' => false,
        'target_transport_reference_id' => false
    ];
    ...
    protected static $attributeMap = [
        'target_loading_equipment_identifier_id' => 'targetLoadingEquipmentIdentifierId',
        'target_storage_place_id' => 'targetStoragePlaceId',
        'target_transport_reference_id' => 'targetTransportReferenceId'
    ];
    ...
    protected static $setters = [
        'target_loading_equipment_identifier_id' => 'setTargetLoadingEquipmentIdentifierId',
        'target_storage_place_id' => 'setTargetStoragePlaceId',
        'target_transport_reference_id' => 'setTargetTransportReferenceId'
    ];
    ...
    protected static $getters = [
        'target_loading_equipment_identifier_id' => 'getTargetLoadingEquipmentIdentifierId',
        'target_storage_place_id' => 'getTargetStoragePlaceId',
        'target_transport_reference_id' => 'getTargetTransportReferenceId'
    ];
    ...
    {
        $this->setIfExists('target_loading_equipment_identifier_id', $data ?? [], null);
        $this->setIfExists('target_storage_place_id', $data ?? [], null);
        $this->setIfExists('target_transport_reference_id', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets target_loading_equipment_identifier_id
     *
     * @return string|null
     */
    public function getTargetLoadingEquipmentIdentifierId()
    {
        return $this->container['target_loading_equipment_identifier_id'];
    }

    /**
     * Sets target_loading_equipment_identifier_id
     *
     * @param string|null $target_loading_equipment_identifier_id target_loading_equipment_identifier_id
     *
     * @return self
     */
    public function setTargetLoadingEquipmentIdentifierId($target_loading_equipment_identifier_id)
    {
        if (is_null($target_loading_equipment_identifier_id)) {
            throw new \InvalidArgumentException('non-nullable target_loading_equipment_identifier_id cannot be null');
        }
        $this->container['target_loading_equipment_identifier_id'] = $target_loading_equipment_identifier_id;
    ...
    /**
     * Gets target_transport_reference_id
     *
     * @return string|null
     */
    public function getTargetTransportReferenceId()
    {
        return $this->container['target_transport_reference_id'];
    }

    /**
     * Sets target_transport_reference_id
     *
     * @param string|null $target_transport_reference_id target_transport_reference_id
     *
     * @return self
     */
    public function setTargetTransportReferenceId($target_transport_reference_id)
    {
        if (is_null($target_transport_reference_id)) {
            throw new \InvalidArgumentException('non-nullable target_transport_reference_id cannot be null');
        }
        $this->container['target_transport_reference_id'] = $target_transport_reference_id;

...
class EcommerceOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ecommerce_id'] === null) {
            $invalidProperties[] = "'ecommerce_id' can't be null";
        }
        if ($this->container['external_connection_id'] === null) {
            $invalidProperties[] = "'external_connection_id' can't be null";
        }
     ...
     * Sets ecommerce_id
     *
     * @param string $ecommerce_id ecommerce_id
     *
     * @return self
     */
     ...
     *
     * @param string $external_connection_id external_connection_id
     *
     * @return self
     */

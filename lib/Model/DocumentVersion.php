...
class DocumentVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['document_version']) && (mb_strlen($this->container['document_version']) > 60)) {
            $invalidProperties[] = "invalid value for 'document_version', the character length must be smaller than or equal to 60.";
        }
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling DocumentVersion., must be smaller than or equal to 255.');
        }
    ...
    public function setDocumentVersion($document_version)
    {
        ...
        if ((mb_strlen($document_version) > 60)) {
            throw new \InvalidArgumentException('invalid length for $document_version when calling DocumentVersion., must be smaller than or equal to 60.');
        }

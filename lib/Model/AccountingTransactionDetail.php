...
/**
 * AccountingTransactionDetail Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class AccountingTransactionDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'accountingTransactionDetail';
    ...
    protected static $openAPITypes = [
        'account_id' => 'string',
        'amount' => 'float',
        'debit_credit' => '\kruegge82\weclapp\Model\DebitCreditIndicator',
        'description' => 'string',
        'tax_id' => 'string'
    ];
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling AccountingTransactionDetail., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
     ...
     * Gets debit_credit
     *
     * @return \kruegge82\weclapp\Model\DebitCreditIndicator|null
     */
     ...
     * Sets debit_credit
     *
     * @param \kruegge82\weclapp\Model\DebitCreditIndicator|null $debit_credit debit_credit
     *
     * @return self
     */

...
class PartyGet200ResponseAdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        'customer_children_sales_order_volume_current_year' => 'number',
        'customer_children_sales_order_volume_previous_year' => 'number',
        'customer_children_sales_revenue_current_year' => 'number',
        'customer_children_sales_revenue_previous_year' => 'number',
        'customer_quotation_acceptance_percentage' => 'number',
        'customer_quotation_acceptance_time_in_days' => 'int64',
        'customer_return_percentage_current_year' => 'number',
        'customer_return_percentage_previous_year' => 'number',
        'customer_sales_open_item_overdue_sum' => 'number',
        'customer_sales_open_item_sum' => 'number',
        'customer_sales_order_volume_current_year' => 'number',
        'customer_sales_order_volume_previous_year' => 'number',
        'customer_sales_revenue_current_year' => 'number',
        'customer_sales_revenue_previous_year' => 'number',
        'lead_children_expected_revenue_opportunities' => 'number',
        'lead_children_expected_revenue_quotations' => 'number',
        'lead_children_quotation_volume' => 'number',
        'lead_expected_revenue_opportunities' => 'number',
        'lead_expected_revenue_quotations' => 'number',
        'lead_quotation_volume' => 'number',
        'supplier_children_purchase_order_volume_current_year' => 'number',
        'supplier_children_purchase_order_volume_previous_year' => 'number',
        'supplier_children_purchase_revenue_current_year' => 'number',
        'supplier_children_purchase_revenue_previous_year' => 'number',
        'supplier_purchase_order_volume_current_year' => 'number',
        'supplier_purchase_order_volume_previous_year' => 'number',
        'supplier_purchase_revenue_current_year' => 'number',
        'supplier_purchase_revenue_previous_year' => 'number'
    ];

 ...
 */
class SalesOrderPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'salesOrderPayment';
    ...
    protected static $openAPITypes = [
        ...
        'sales_invoices' => '\kruegge82\weclapp\Model\OnlyId[]'
    ];
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling SalesOrderPayment., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    {
        return $this->container['condition_met'];
    }

    /**
     * Sets condition_met
     *
     * @param bool|null $condition_met condition_met
     *
     * @return self
     */
    public function setConditionMet($condition_met)
    {
        if (is_null($condition_met)) {
            throw new \InvalidArgumentException('non-nullable condition_met cannot be null');
        }
        $this->container['condition_met'] = $condition_met;
     ...
     * Sets sales_invoices
     *
     * @param \kruegge82\weclapp\Model\OnlyId[]|null $sales_invoices sales_invoices
     *
     * @return self
     */
    public function setSalesInvoices($sales_invoices)
    {
        if (is_null($sales_invoices)) {
            throw new \InvalidArgumentException('non-nullable sales_invoices cannot be null');
        }

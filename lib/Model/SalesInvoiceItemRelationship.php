...
/**
 * SalesInvoiceItemRelationship Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class SalesInvoiceItemRelationship implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'salesInvoiceItemRelationship';
    ...
    protected static $openAPITypes = [
        'performance_record_item_id' => 'string',
        'quantity' => 'float',
    ...
    protected static $openAPIFormats = [
        'performance_record_item_id' => null,
        'quantity' => 'decimal',
    ...
    protected static array $openAPINullables = [
        'performance_record_item_id' => false,
        'quantity' => false,
        'sales_invoice_item_id' => false,
    ...
    protected static $attributeMap = [
        'performance_record_item_id' => 'performanceRecordItemId',
        'quantity' => 'quantity',
    ...
    protected static $setters = [
        'performance_record_item_id' => 'setPerformanceRecordItemId',
        'quantity' => 'setQuantity',
        'sales_invoice_item_id' => 'setSalesInvoiceItemId',
    ...
    protected static $getters = [
        'performance_record_item_id' => 'getPerformanceRecordItemId',
        'quantity' => 'getQuantity',
        'sales_invoice_item_id' => 'getSalesInvoiceItemId',
    ...
    {
        $this->setIfExists('performance_record_item_id', $data ?? [], null);
        $this->setIfExists('quantity', $data ?? [], null);
        $this->setIfExists('sales_invoice_item_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets performance_record_item_id
     *
     * @return string|null
     */
    public function getPerformanceRecordItemId()
    {
        return $this->container['performance_record_item_id'];
    }

    /**
     * Sets performance_record_item_id
     *
     * @param string|null $performance_record_item_id performance_record_item_id
     *
     * @return self
     */
    public function setPerformanceRecordItemId($performance_record_item_id)
    {
        if (is_null($performance_record_item_id)) {
            throw new \InvalidArgumentException('non-nullable performance_record_item_id cannot be null');
        }
        $this->container['performance_record_item_id'] = $performance_record_item_id;
    ...
    public function setQuantity($quantity)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($quantity)))) {
            throw new \InvalidArgumentException("invalid value for \$quantity when calling SalesInvoiceItemRelationship., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    {
        return $this->container['sales_invoice_item_id'];
    }

    /**
     * Sets sales_invoice_item_id
     *
     * @param string|null $sales_invoice_item_id sales_invoice_item_id
     *
     * @return self
     * @deprecated
     */
    public function setSalesInvoiceItemId($sales_invoice_item_id)
    {
        if (is_null($sales_invoice_item_id)) {
            throw new \InvalidArgumentException('non-nullable sales_invoice_item_id cannot be null');
        }
        $this->container['sales_invoice_item_id'] = $sales_invoice_item_id;

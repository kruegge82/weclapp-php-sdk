...
/**
 * TransportPick Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class TransportPick implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'transportPick';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($quantity)))) {
            throw new \InvalidArgumentException("invalid value for \$quantity when calling TransportPick., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }

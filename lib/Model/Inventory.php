...
class Inventory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const LEVEL_OF_DETAIL_ARTICLE = 'ARTICLE';
    public const LEVEL_OF_DETAIL_SERIAL_NUMBER = 'SERIAL_NUMBER';
    public const LEVEL_OF_DETAIL_STORAGE_PLACE = 'STORAGE_PLACE';
    public const LEVEL_OF_DETAIL_WAREHOUSE = 'WAREHOUSE';
    public const STATUS_BOOKED = 'BOOKED';
    public const STATUS_CANCELLED = 'CANCELLED';
    public const STATUS_CLOSED = 'CLOSED';
    public const STATUS_COMPLETE = 'COMPLETE';
    public const STATUS_DIFFERENCE_CHECKED = 'DIFFERENCE_CHECKED';
    public const STATUS_DOCUMENTS_PRINTED = 'DOCUMENTS_PRINTED';
     ...
     * @return string[]
     */
    public function getLevelOfDetailAllowableValues()
    {
        return [
            self::LEVEL_OF_DETAIL_ARTICLE,
            self::LEVEL_OF_DETAIL_SERIAL_NUMBER,
            self::LEVEL_OF_DETAIL_STORAGE_PLACE,
            self::LEVEL_OF_DETAIL_WAREHOUSE,
        ];
    }
    ...
    public function getStatusAllowableValues()
    {
        return [
            ...
            self::STATUS_DIFFERENCE_CHECKED,
            self::STATUS_DOCUMENTS_PRINTED,
            self::STATUS__NEW,
            self::STATUS_PLANNED,
            self::STATUS_STARTED,
        ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inventory_group_id'] === null) {
            $invalidProperties[] = "'inventory_group_id' can't be null";
        }
        $allowedValues = $this->getLevelOfDetailAllowableValues();
        if (!is_null($this->container['level_of_detail']) && !in_array($this->container['level_of_detail'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'level_of_detail', must be one of '%s'",
                $this->container['level_of_detail'],
     ...
     *
     * @param string $inventory_group_id inventory_group_id
     *
     * @return self
     */
     ...
     *
     * @param string|null $level_of_detail level_of_detail
     *
     * @return self
     */
    public function setLevelOfDetail($level_of_detail)
    {
        ...
        $allowedValues = $this->getLevelOfDetailAllowableValues();
        if (!in_array($level_of_detail, $allowedValues, true)) {

...
/**
 * TicketIdIdLinkSalesOrderPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class TicketIdIdLinkSalesOrderPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_ticket_id__id__linkSalesOrder_post_request';
    ...
    protected static $openAPITypes = [
        'sales_order_id' => 'int',
        'task_id_to_order_item_id' => 'object'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'task_id_to_order_item_id' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'task_id_to_order_item_id' => 'taskIdToOrderItemId'
    ];
    ...
    protected static $setters = [
        ...
        'task_id_to_order_item_id' => 'setTaskIdToOrderItemId'
    ];
    ...
    protected static $getters = [
        ...
        'task_id_to_order_item_id' => 'getTaskIdToOrderItemId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('task_id_to_order_item_id', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets task_id_to_order_item_id
     *
     * @return object|null
     */
    public function getTaskIdToOrderItemId()
    {
        return $this->container['task_id_to_order_item_id'];
    }

    /**
     * Sets task_id_to_order_item_id
     *
     * @param object|null $task_id_to_order_item_id task_id_to_order_item_id
     *
     * @return self
     */
    public function setTaskIdToOrderItemId($task_id_to_order_item_id)
    {
        if (is_null($task_id_to_order_item_id)) {
            throw new \InvalidArgumentException('non-nullable task_id_to_order_item_id cannot be null');
        }
        $this->container['task_id_to_order_item_id'] = $task_id_to_order_item_id;

<?php
/**
 * QuotationIdIdAcceptPostRequestAcceptQuotationItemsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * QuotationIdIdAcceptPostRequestAcceptQuotationItemsInner Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class QuotationIdIdAcceptPostRequestAcceptQuotationItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_quotation_id__id__accept_post_request_acceptQuotationItems_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('quotation_item_id', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $quotation_item_id quotation_item_id
     *
     * @return self
     */
    public function setQuotationItemId($quotation_item_id)
    {
        if (is_null($quotation_item_id)) {
            throw new \InvalidArgumentException('non-nullable quotation_item_id cannot be null');
        }

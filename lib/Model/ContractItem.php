    ...
    */
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $note when calling ContractItem., must be smaller than or equal to 1000.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ContractItem., must be smaller than or equal to 255.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ContractItem., must be smaller than or equal to 1000.');
        }
    ...
    public function setGroupName($group_name)
    {
        ...
        if ((mb_strlen($group_name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $group_name when calling ContractItem., must be smaller than or equal to 1000.');
        }

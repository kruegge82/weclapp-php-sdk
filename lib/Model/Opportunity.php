...
class Opportunity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'win_loss_reason_name' => 'winLossReasonName'
    ];
    ...
    protected static $setters = [
        ...
        'win_loss_reason_name' => 'setWinLossReasonName'
    ];
    ...
    protected static $getters = [
        ...
        'win_loss_reason_name' => 'getWinLossReasonName'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('win_loss_reason_name', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets win_loss_reason_name
     *
     * @return string|null
     * @deprecated
     */
    public function getWinLossReasonName()
    {
        return $this->container['win_loss_reason_name'];
    }

    /**
     * Sets win_loss_reason_name
     *
     * @param string|null $win_loss_reason_name win_loss_reason_name
     *
     * @return self
     * @deprecated
     */
    public function setWinLossReasonName($win_loss_reason_name)
    {
        if (is_null($win_loss_reason_name)) {
            throw new \InvalidArgumentException('non-nullable win_loss_reason_name cannot be null');
        }
        $this->container['win_loss_reason_name'] = $win_loss_reason_name;

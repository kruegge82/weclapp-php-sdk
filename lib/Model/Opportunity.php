...
class Opportunity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sales_probability'] === null) {
            $invalidProperties[] = "'sales_probability' can't be null";
        }
        if ($this->container['sales_stage_id'] === null) {
            $invalidProperties[] = "'sales_stage_id' can't be null";
        }
     ...
     *
     * @param int $sales_probability sales_probability
     *
     * @return self
     */

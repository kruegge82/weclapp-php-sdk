...
class PurchaseInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'payment_status' => '\kruegge82\weclapp\Model\PaymentStatus',
        'preceding_purchase_invoice_id' => 'string',
        'pricing_date' => 'int',
        'purchase_invoice_items' => '\kruegge82\weclapp\Model\PurchaseInvoiceItem[]',
        'purchase_invoice_type' => '\kruegge82\weclapp\Model\PurchaseInvoiceType',
        ...
        'shipping_date' => 'int',
        'status' => '\kruegge82\weclapp\Model\PurchaseInvoiceStatusType',
    ...
    protected static $openAPIFormats = [
        ...
        'due_date' => 'timestamp',
        'gross_amount_of_header_taxes' => 'decimal',
        'gross_amount_of_header_taxes_in_company_currency' => 'decimal',
        'gross_prices' => null,
        'import_sales_tax_amount' => 'decimal',
    ...
    protected static $setters = [
        ...
        'cost_center_number' => 'setCostCenterNumber',
    ...
    protected static $getters = [
        ...
        'cost_center_number' => 'getCostCenterNumber',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cost_center_number', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['gross_amount_of_header_taxes']) && !preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", $this->container['gross_amount_of_header_taxes'])) {
            $invalidProperties[] = "invalid value for 'gross_amount_of_header_taxes', must be conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.";
        }

        if (!is_null($this->container['gross_amount_of_header_taxes_in_company_currency']) && !preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", $this->container['gross_amount_of_header_taxes_in_company_currency'])) {
            $invalidProperties[] = "invalid value for 'gross_amount_of_header_taxes_in_company_currency', must be conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.";
        }

        if (!is_null($this->container['import_sales_tax_amount']) && !preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", $this->container['import_sales_tax_amount'])) {
            $invalidProperties[] = "invalid value for 'import_sales_tax_amount', must be conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.";
        }
    ...
    public function setCurrencyConversionRate($currency_conversion_rate)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($currency_conversion_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$currency_conversion_rate when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setGrossAmount($gross_amount)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($gross_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$gross_amount when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setGrossAmountInCompanyCurrency($gross_amount_in_company_currency)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($gross_amount_in_company_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$gross_amount_in_company_currency when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setHeaderDiscount($header_discount)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($header_discount)))) {
            throw new \InvalidArgumentException("invalid value for \$header_discount when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setHeaderSurcharge($header_surcharge)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($header_surcharge)))) {
            throw new \InvalidArgumentException("invalid value for \$header_surcharge when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setNetAmount($net_amount)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($net_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$net_amount when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setNetAmountInCompanyCurrency($net_amount_in_company_currency)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($net_amount_in_company_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$net_amount_in_company_currency when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    {
        return $this->container['cost_center_number'];
    }

    /**
     * Sets cost_center_number
     *
     * @param string|null $cost_center_number cost_center_number
     *
     * @return self
     * @deprecated
     */
    public function setCostCenterNumber($cost_center_number)
    {
        if (is_null($cost_center_number)) {
            throw new \InvalidArgumentException('non-nullable cost_center_number cannot be null');
        }
        $this->container['cost_center_number'] = $cost_center_number;
    ...
    public function setGrossAmountOfHeaderTaxes($gross_amount_of_header_taxes)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($gross_amount_of_header_taxes)))) {
            throw new \InvalidArgumentException("invalid value for \$gross_amount_of_header_taxes when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setGrossAmountOfHeaderTaxesInCompanyCurrency($gross_amount_of_header_taxes_in_company_currency)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($gross_amount_of_header_taxes_in_company_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$gross_amount_of_header_taxes_in_company_currency when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setImportSalesTaxAmount($import_sales_tax_amount)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($import_sales_tax_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$import_sales_tax_amount when calling PurchaseInvoice., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
     ...
     * Gets payment_status
     *
     * @return \kruegge82\weclapp\Model\PaymentStatus|null
     */
     ...
     * Sets payment_status
     *
     * @param \kruegge82\weclapp\Model\PaymentStatus|null $payment_status payment_status
     *
     * @return self
     */
     ...
     *
     * @return \kruegge82\weclapp\Model\PurchaseInvoiceType|null
     */
     ...
     *
     * @param \kruegge82\weclapp\Model\PurchaseInvoiceType|null $purchase_invoice_type purchase_invoice_type
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \kruegge82\weclapp\Model\PurchaseInvoiceStatusType|null
     */
     ...
     * Sets status
     *
     * @param \kruegge82\weclapp\Model\PurchaseInvoiceStatusType|null $status status
     *
     * @return self
     */

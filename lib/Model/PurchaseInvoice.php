...
class PurchaseInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['booking_text']) && (mb_strlen($this->container['booking_text']) > 768)) {
            $invalidProperties[] = "invalid value for 'booking_text', the character length must be smaller than or equal to 768.";
        }
        ...
        if (!is_null($this->container['internal_invoice_number']) && (mb_strlen($this->container['internal_invoice_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'internal_invoice_number', the character length must be smaller than or equal to 255.";
        }
        ...
        if (!is_null($this->container['payment_block_note']) && (mb_strlen($this->container['payment_block_note']) > 1000)) {
            $invalidProperties[] = "invalid value for 'payment_block_note', the character length must be smaller than or equal to 1000.";
        }
        ...
        if (!is_null($this->container['sender_country_code']) && (mb_strlen($this->container['sender_country_code']) > 5)) {
            $invalidProperties[] = "invalid value for 'sender_country_code', the character length must be smaller than or equal to 5.";
        }
    ...
    public function setCommercialLanguage($commercial_language)
    {
        ...
        if ((mb_strlen($commercial_language) > 255)) {
            throw new \InvalidArgumentException('invalid length for $commercial_language when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setRecordComment($record_comment)
    {
        ...
        if ((mb_strlen($record_comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $record_comment when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setRecordFreeText($record_free_text)
    {
        ...
        if ((mb_strlen($record_free_text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $record_free_text when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setRecordOpening($record_opening)
    {
        ...
        if ((mb_strlen($record_opening) > 255)) {
            throw new \InvalidArgumentException('invalid length for $record_opening when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setBookingText($booking_text)
    {
        ...
        if ((mb_strlen($booking_text) > 768)) {
            throw new \InvalidArgumentException('invalid length for $booking_text when calling PurchaseInvoice., must be smaller than or equal to 768.');
        }
    ...
    public function setInternalInvoiceNumber($internal_invoice_number)
    {
        ...
        if ((mb_strlen($internal_invoice_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $internal_invoice_number when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setInvoiceNumber($invoice_number)
    {
        ...
        if ((mb_strlen($invoice_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_number when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setPaymentBlockNote($payment_block_note)
    {
        ...
        if ((mb_strlen($payment_block_note) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $payment_block_note when calling PurchaseInvoice., must be smaller than or equal to 1000.');
        }
    ...
    public function setRecipientCountryCode($recipient_country_code)
    {
        ...
        if ((mb_strlen($recipient_country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $recipient_country_code when calling PurchaseInvoice., must be smaller than or equal to 5.');
        }
    ...
    public function setSenderCountryCode($sender_country_code)
    {
        ...
        if ((mb_strlen($sender_country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $sender_country_code when calling PurchaseInvoice., must be smaller than or equal to 5.');
        }
    ...
    public function setVatRegistrationNumber($vat_registration_number)
    {
        ...
        if ((mb_strlen($vat_registration_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $vat_registration_number when calling PurchaseInvoice., must be smaller than or equal to 1000.');
        }

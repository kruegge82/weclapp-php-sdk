...
class Currency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['currency_symbol']) && (mb_strlen($this->container['currency_symbol']) > 8)) {
            $invalidProperties[] = "invalid value for 'currency_symbol', the character length must be smaller than or equal to 8.";
        }
    ...
    public function setCurrencySymbol($currency_symbol)
    {
        ...
        if ((mb_strlen($currency_symbol) > 8)) {
            throw new \InvalidArgumentException('invalid length for $currency_symbol when calling Currency., must be smaller than or equal to 8.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Currency., must be smaller than or equal to 150.');
        }

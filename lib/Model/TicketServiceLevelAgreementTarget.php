...
class TicketServiceLevelAgreementTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ASSIGNMENT_TIME_UNIT_DAYS = 'DAYS';
    public const ASSIGNMENT_TIME_UNIT_HOURS = 'HOURS';
    public const ASSIGNMENT_TIME_UNIT_MINUTES = 'MINUTES';
    public const ASSIGNMENT_TIME_UNIT_NONE = 'NONE';
    public const FIRST_REPLY_TIME_UNIT_DAYS = 'DAYS';
    public const FIRST_REPLY_TIME_UNIT_HOURS = 'HOURS';
    public const FIRST_REPLY_TIME_UNIT_MINUTES = 'MINUTES';
    public const FIRST_REPLY_TIME_UNIT_NONE = 'NONE';
    public const SOLUTION_TIME_UNIT_DAYS = 'DAYS';
    public const SOLUTION_TIME_UNIT_HOURS = 'HOURS';
    public const SOLUTION_TIME_UNIT_MINUTES = 'MINUTES';
    public const SOLUTION_TIME_UNIT_NONE = 'NONE';
     ...
     * @return string[]
     */
    public function getAssignmentTimeUnitAllowableValues()
    {
        return [
            self::ASSIGNMENT_TIME_UNIT_DAYS,
            self::ASSIGNMENT_TIME_UNIT_HOURS,
            self::ASSIGNMENT_TIME_UNIT_MINUTES,
            self::ASSIGNMENT_TIME_UNIT_NONE,
        ];
    }
     ...
     * @return string[]
     */
    public function getFirstReplyTimeUnitAllowableValues()
    {
        return [
            self::FIRST_REPLY_TIME_UNIT_DAYS,
            self::FIRST_REPLY_TIME_UNIT_HOURS,
            self::FIRST_REPLY_TIME_UNIT_MINUTES,
            self::FIRST_REPLY_TIME_UNIT_NONE,
        ];
    }
     ...
     * @return string[]
     */
    public function getSolutionTimeUnitAllowableValues()
    {
        return [
            self::SOLUTION_TIME_UNIT_DAYS,
            self::SOLUTION_TIME_UNIT_HOURS,
            self::SOLUTION_TIME_UNIT_MINUTES,
            self::SOLUTION_TIME_UNIT_NONE,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAssignmentTimeUnitAllowableValues();
        if (!is_null($this->container['assignment_time_unit']) && !in_array($this->container['assignment_time_unit'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'assignment_time_unit', must be one of '%s'",
                $this->container['assignment_time_unit'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getFirstReplyTimeUnitAllowableValues();
        if (!is_null($this->container['first_reply_time_unit']) && !in_array($this->container['first_reply_time_unit'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'first_reply_time_unit', must be one of '%s'",
                $this->container['first_reply_time_unit'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getSolutionTimeUnitAllowableValues();
        if (!is_null($this->container['solution_time_unit']) && !in_array($this->container['solution_time_unit'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'solution_time_unit', must be one of '%s'",
                $this->container['solution_time_unit'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string|null $assignment_time_unit assignment_time_unit
     *
     * @return self
     */
    public function setAssignmentTimeUnit($assignment_time_unit)
    {
        ...
        $allowedValues = $this->getAssignmentTimeUnitAllowableValues();
        if (!in_array($assignment_time_unit, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'assignment_time_unit', must be one of '%s'",
                    $assignment_time_unit,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     *
     * @param string|null $first_reply_time_unit first_reply_time_unit
     *
     * @return self
     */
    public function setFirstReplyTimeUnit($first_reply_time_unit)
    {
        ...
        $allowedValues = $this->getFirstReplyTimeUnitAllowableValues();
        if (!in_array($first_reply_time_unit, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'first_reply_time_unit', must be one of '%s'",
                    $first_reply_time_unit,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     *
     * @param string|null $solution_time_unit solution_time_unit
     *
     * @return self
     */
    public function setSolutionTimeUnit($solution_time_unit)
    {
        ...
        $allowedValues = $this->getSolutionTimeUnitAllowableValues();
        if (!in_array($solution_time_unit, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'solution_time_unit', must be one of '%s'",
                    $solution_time_unit,

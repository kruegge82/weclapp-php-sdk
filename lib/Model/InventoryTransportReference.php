...
/**
 * InventoryTransportReference Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class InventoryTransportReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inventoryTransportReference';
    ...
    protected static $openAPIFormats = [
        ...
        'version' => null,
        'internal_transport_number' => null,
        'inventory_id' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'version' => false,
        'internal_transport_number' => false,
        'inventory_id' => false,
    ...
    protected static $attributeMap = [
        ...
        'version' => 'version',
        'internal_transport_number' => 'internalTransportNumber',
    ...
    protected static $setters = [
        ...
        'version' => 'setVersion',
        'internal_transport_number' => 'setInternalTransportNumber',
        ...
        'manual_reference' => 'setManualReference'
    ];
    ...
    protected static $getters = [
        ...
        'version' => 'getVersion',
        'internal_transport_number' => 'getInternalTransportNumber',
        ...
        'manual_reference' => 'getManualReference'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('internal_transport_number', $data ?? [], null);
        ...
        $this->setIfExists('manual_reference', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets internal_transport_number
     *
     * @return string|null
     */
    public function getInternalTransportNumber()
    {
        return $this->container['internal_transport_number'];
    }

    /**
     * Sets internal_transport_number
     *
     * @param string|null $internal_transport_number internal_transport_number
     *
     * @return self
     */
    public function setInternalTransportNumber($internal_transport_number)
    {
        if (is_null($internal_transport_number)) {
            throw new \InvalidArgumentException('non-nullable internal_transport_number cannot be null');
        }
        $this->container['internal_transport_number'] = $internal_transport_number;
    ...
    /**
     * Gets manual_reference
     *
     * @return bool|null
     */
    public function getManualReference()
    {
        return $this->container['manual_reference'];
    }

    /**
     * Sets manual_reference
     *
     * @param bool|null $manual_reference manual_reference
     *
     * @return self
     */
    public function setManualReference($manual_reference)
    {
        if (is_null($manual_reference)) {
            throw new \InvalidArgumentException('non-nullable manual_reference cannot be null');
        }
        $this->container['manual_reference'] = $manual_reference;

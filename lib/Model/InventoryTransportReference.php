...
class InventoryTransportReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['internal_transport_number']) && (mb_strlen($this->container['internal_transport_number']) > 1000)) {
            $invalidProperties[] = "invalid value for 'internal_transport_number', the character length must be smaller than or equal to 1000.";
        }
    ...
    public function setInternalTransportNumber($internal_transport_number)
    {
        ...
        if ((mb_strlen($internal_transport_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $internal_transport_number when calling InventoryTransportReference., must be smaller than or equal to 1000.');
        }

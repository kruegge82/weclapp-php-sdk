...
class Region implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['match_code']) && (mb_strlen($this->container['match_code']) > 30)) {
            $invalidProperties[] = "invalid value for 'match_code', the character length must be smaller than or equal to 30.";
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Region., must be smaller than or equal to 5.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Region., must be smaller than or equal to 255.');
        }
    ...
    public function setMatchCode($match_code)
    {
        ...
        if ((mb_strlen($match_code) > 30)) {
            throw new \InvalidArgumentException('invalid length for $match_code when calling Region., must be smaller than or equal to 30.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Region., must be smaller than or equal to 30.');
        }

...
class SalesInvoiceItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'delivery_date' => 'int',
        'sales_invoice_item_relationship' => '\kruegge82\weclapp\Model\SalesInvoiceItemRelationship[]',
    ...
    protected static $openAPIFormats = [
        ...
        'sales_invoice_item_relationship' => null,
        'serial_numbers' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'delivery_date' => false,
        'sales_invoice_item_relationship' => false,
    ...
    protected static $attributeMap = [
        ...
        'sales_invoice_item_relationship' => 'salesInvoiceItemRelationship',
    ...
    protected static $setters = [
        ...
        'sales_invoice_item_relationship' => 'setSalesInvoiceItemRelationship',
    ...
    protected static $getters = [
        ...
        'sales_invoice_item_relationship' => 'getSalesInvoiceItemRelationship',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sales_invoice_item_relationship', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets sales_invoice_item_relationship
     *
     * @return \kruegge82\weclapp\Model\SalesInvoiceItemRelationship[]|null
     * @deprecated
     */
    public function getSalesInvoiceItemRelationship()
    {
        return $this->container['sales_invoice_item_relationship'];
    }

    /**
     * Sets sales_invoice_item_relationship
     *
     * @param \kruegge82\weclapp\Model\SalesInvoiceItemRelationship[]|null $sales_invoice_item_relationship sales_invoice_item_relationship
     *
     * @return self
     * @deprecated
     */
    public function setSalesInvoiceItemRelationship($sales_invoice_item_relationship)
    {
        if (is_null($sales_invoice_item_relationship)) {
            throw new \InvalidArgumentException('non-nullable sales_invoice_item_relationship cannot be null');
        }
        $this->container['sales_invoice_item_relationship'] = $sales_invoice_item_relationship;

 ...
 */
class TaskList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'taskList';
    ...
    protected static $openAPITypes = [
        ...
        'visibility_type' => '\kruegge82\weclapp\Model\TaskVisibilityType'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('visibility_type', $data ?? [], null);
    }
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TaskList., must be smaller than or equal to 1000.');
        }
     ...
     *
     * @param \kruegge82\weclapp\Model\TaskVisibilityType|null $visibility_type visibility_type
     *
     * @return self
     */
    public function setVisibilityType($visibility_type)
    {
        if (is_null($visibility_type)) {
            throw new \InvalidArgumentException('non-nullable visibility_type cannot be null');
        }

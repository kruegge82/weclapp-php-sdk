...
class ContractType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['icon_class']) && (mb_strlen($this->container['icon_class']) > 1000)) {
            $invalidProperties[] = "invalid value for 'icon_class', the character length must be smaller than or equal to 1000.";
        }
    ...
    public function setIconClass($icon_class)
    {
        ...
        if ((mb_strlen($icon_class) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $icon_class when calling ContractType., must be smaller than or equal to 1000.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContractType., must be smaller than or equal to 255.');
        }

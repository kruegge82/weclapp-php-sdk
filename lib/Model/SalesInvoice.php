...
class SalesInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cancellation_number']) && (mb_strlen($this->container['cancellation_number']) > 1000)) {
            $invalidProperties[] = "invalid value for 'cancellation_number', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['dunning_block_note']) && (mb_strlen($this->container['dunning_block_note']) > 1000)) {
            $invalidProperties[] = "invalid value for 'dunning_block_note', the character length must be smaller than or equal to 1000.";
        }
    ...
    public function setCommercialLanguage($commercial_language)
    {
        ...
        if ((mb_strlen($commercial_language) > 255)) {
            throw new \InvalidArgumentException('invalid length for $commercial_language when calling SalesInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SalesInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setRecordComment($record_comment)
    {
        ...
        if ((mb_strlen($record_comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $record_comment when calling SalesInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setRecordFreeText($record_free_text)
    {
        ...
        if ((mb_strlen($record_free_text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $record_free_text when calling SalesInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setRecordOpening($record_opening)
    {
        ...
        if ((mb_strlen($record_opening) > 255)) {
            throw new \InvalidArgumentException('invalid length for $record_opening when calling SalesInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setCommission($commission)
    {
        ...
        if ((mb_strlen($commission) > 255)) {
            throw new \InvalidArgumentException('invalid length for $commission when calling SalesInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setDispatchCountryCode($dispatch_country_code)
    {
        ...
        if ((mb_strlen($dispatch_country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $dispatch_country_code when calling SalesInvoice., must be smaller than or equal to 5.');
        }
    ...
    public function setBookingText($booking_text)
    {
        ...
        if ((mb_strlen($booking_text) > 768)) {
            throw new \InvalidArgumentException('invalid length for $booking_text when calling SalesInvoice., must be smaller than or equal to 768.');
        }
    ...
    public function setCancellationNumber($cancellation_number)
    {
        ...
        if ((mb_strlen($cancellation_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $cancellation_number when calling SalesInvoice., must be smaller than or equal to 1000.');
        }
    ...
    public function setDunningBlockNote($dunning_block_note)
    {
        ...
        if ((mb_strlen($dunning_block_note) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $dunning_block_note when calling SalesInvoice., must be smaller than or equal to 1000.');
        }
    ...
    public function setInvoiceNumber($invoice_number)
    {
        ...
        if ((mb_strlen($invoice_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_number when calling SalesInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setOrderNumberAtCustomer($order_number_at_customer)
    {
        ...
        if ((mb_strlen($order_number_at_customer) > 255)) {
            throw new \InvalidArgumentException('invalid length for $order_number_at_customer when calling SalesInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setVatRegistrationNumber($vat_registration_number)
    {
        ...
        if ((mb_strlen($vat_registration_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $vat_registration_number when calling SalesInvoice., must be smaller than or equal to 1000.');
        }

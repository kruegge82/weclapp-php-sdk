...
class Article implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'article_type' => 'string',
        'article_width' => 'float',
        'available_for_sales_channels' => 'string[]',
        ...
        'default_price_calculation_type' => 'string',
        ...
        'margin_calculation_price_type' => 'string',
        'match_code' => 'string',
        ...
        'production_configuration_rule' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'article_gross_weight' => 'number',
        'article_height' => 'number',
        'article_images' => null,
        'article_length' => 'number',
        'article_net_weight' => 'number',
        'article_number' => null,
        'article_prices' => null,
        'article_type' => null,
    ...
    public const ARTICLE_TYPE_BASIC = 'BASIC';
    public const ARTICLE_TYPE_LOADING_EQUIPMENT = 'LOADING_EQUIPMENT';
    public const ARTICLE_TYPE_LOADING_EQUIPMENT_STORABLE = 'LOADING_EQUIPMENT_STORABLE';
    public const ARTICLE_TYPE_PACKAGING_UNIT = 'PACKAGING_UNIT';
    public const ARTICLE_TYPE_SALES_BILL_OF_MATERIAL = 'SALES_BILL_OF_MATERIAL';
    public const ARTICLE_TYPE_SERVICE = 'SERVICE';
    public const ARTICLE_TYPE_SHIPPING_COST = 'SHIPPING_COST';
    public const ARTICLE_TYPE_STORABLE = 'STORABLE';
    public const CONTRACT_BILLING_CYCLE_DAILY = 'DAILY';
    public const CONTRACT_BILLING_CYCLE_FIVE_YEARLY = 'FIVE_YEARLY';
    public const CONTRACT_BILLING_CYCLE_FOUR_YEARLY = 'FOUR_YEARLY';
    public const CONTRACT_BILLING_CYCLE_HALF_YEARLY = 'HALF_YEARLY';
    public const CONTRACT_BILLING_CYCLE_MONTHLY = 'MONTHLY';
    public const CONTRACT_BILLING_CYCLE_NONE = 'NONE';
    public const CONTRACT_BILLING_CYCLE_QUARTER = 'QUARTER';
    public const CONTRACT_BILLING_CYCLE_THREE_YEARLY = 'THREE_YEARLY';
    public const CONTRACT_BILLING_CYCLE_TWO_YEARLY = 'TWO_YEARLY';
    public const CONTRACT_BILLING_CYCLE_WEEKLY = 'WEEKLY';
    public const CONTRACT_BILLING_CYCLE_YEARLY = 'YEARLY';
    public const CONTRACT_BILLING_MODE_NON_RECURRENT = 'NON_RECURRENT';
    public const CONTRACT_BILLING_MODE_RECURRENT = 'RECURRENT';
    public const DEFAULT_PRICE_CALCULATION_TYPE_MARGIN_CALCULATION = 'MARGIN_CALCULATION';
    public const DEFAULT_PRICE_CALCULATION_TYPE_PURCHASE = 'PURCHASE';
    public const DEFAULT_PRICE_CALCULATION_TYPE_RECOMMENDED_RETAIL_PRICE = 'RECOMMENDED_RETAIL_PRICE';
    public const DEFAULT_PRICE_CALCULATION_TYPE_SALES = 'SALES';
    public const INVOICING_TYPE_EFFORT = 'EFFORT';
    public const INVOICING_TYPE_FIXED_PRICE = 'FIXED_PRICE';
    public const MARGIN_CALCULATION_PRICE_TYPE_ARTICLE_CALCULATION_PRICE = 'ARTICLE_CALCULATION_PRICE';
    public const MARGIN_CALCULATION_PRICE_TYPE_EMPLOYEE_COST = 'EMPLOYEE_COST';
    public const MARGIN_CALCULATION_PRICE_TYPE_MOVING_AVERAGE = 'MOVING_AVERAGE';
    public const MARGIN_CALCULATION_PRICE_TYPE_PURCHASE_PRICE_PRODUCTION_COST = 'PURCHASE_PRICE_PRODUCTION_COST';
    public const PRODUCTION_CONFIGURATION_RULE_ALL_COMPONENTS = 'ALL_COMPONENTS';
    public const PRODUCTION_CONFIGURATION_RULE_AT_LEAST_ONE_COMPONENT = 'AT_LEAST_ONE_COMPONENT';
    public const PRODUCTION_CONFIGURATION_RULE_AT_LEAST_ONE_COMPONENT_WITH_VARIABLE_QUANTITY = 'AT_LEAST_ONE_COMPONENT_WITH_VARIABLE_QUANTITY';
    public const PRODUCTION_CONFIGURATION_RULE_ONE_COMPONENT = 'ONE_COMPONENT';
    public const PRODUCTION_CONFIGURATION_RULE_ONE_COMPONENT_WITH_VARIABLE_QUANTITY = 'ONE_COMPONENT_WITH_VARIABLE_QUANTITY';
     ...
     * @return string[]
     */
    public function getArticleTypeAllowableValues()
    {
        return [
            self::ARTICLE_TYPE_BASIC,
            self::ARTICLE_TYPE_LOADING_EQUIPMENT,
            self::ARTICLE_TYPE_LOADING_EQUIPMENT_STORABLE,
            self::ARTICLE_TYPE_PACKAGING_UNIT,
            self::ARTICLE_TYPE_SALES_BILL_OF_MATERIAL,
            self::ARTICLE_TYPE_SERVICE,
            self::ARTICLE_TYPE_SHIPPING_COST,
            self::ARTICLE_TYPE_STORABLE,
        ];
    }
     ...
     * @return string[]
     */
    public function getContractBillingCycleAllowableValues()
    {
        return [
            self::CONTRACT_BILLING_CYCLE_DAILY,
            self::CONTRACT_BILLING_CYCLE_FIVE_YEARLY,
            self::CONTRACT_BILLING_CYCLE_FOUR_YEARLY,
            self::CONTRACT_BILLING_CYCLE_HALF_YEARLY,
            self::CONTRACT_BILLING_CYCLE_MONTHLY,
            self::CONTRACT_BILLING_CYCLE_NONE,
            self::CONTRACT_BILLING_CYCLE_QUARTER,
            self::CONTRACT_BILLING_CYCLE_THREE_YEARLY,
            self::CONTRACT_BILLING_CYCLE_TWO_YEARLY,
            self::CONTRACT_BILLING_CYCLE_WEEKLY,
            self::CONTRACT_BILLING_CYCLE_YEARLY,
        ];
    }
     ...
     * @return string[]
     */
    public function getContractBillingModeAllowableValues()
    {
        return [
            self::CONTRACT_BILLING_MODE_NON_RECURRENT,
            self::CONTRACT_BILLING_MODE_RECURRENT,
        ];
    }
     ...
     * @return string[]
     */
    public function getDefaultPriceCalculationTypeAllowableValues()
    {
        return [
            self::DEFAULT_PRICE_CALCULATION_TYPE_MARGIN_CALCULATION,
            self::DEFAULT_PRICE_CALCULATION_TYPE_PURCHASE,
            self::DEFAULT_PRICE_CALCULATION_TYPE_RECOMMENDED_RETAIL_PRICE,
            self::DEFAULT_PRICE_CALCULATION_TYPE_SALES,
        ];
    }
     ...
     * @return string[]
     */
    public function getInvoicingTypeAllowableValues()
    {
        return [
            self::INVOICING_TYPE_EFFORT,
            self::INVOICING_TYPE_FIXED_PRICE,
        ];
    }
     ...
     * @return string[]
     */
    public function getMarginCalculationPriceTypeAllowableValues()
    {
        return [
            self::MARGIN_CALCULATION_PRICE_TYPE_ARTICLE_CALCULATION_PRICE,
            self::MARGIN_CALCULATION_PRICE_TYPE_EMPLOYEE_COST,
            self::MARGIN_CALCULATION_PRICE_TYPE_MOVING_AVERAGE,
            self::MARGIN_CALCULATION_PRICE_TYPE_PURCHASE_PRICE_PRODUCTION_COST,
        ];
    }
     ...
     * @return string[]
     */
    public function getProductionConfigurationRuleAllowableValues()
    {
        return [
            self::PRODUCTION_CONFIGURATION_RULE_ALL_COMPONENTS,
            self::PRODUCTION_CONFIGURATION_RULE_AT_LEAST_ONE_COMPONENT,
            self::PRODUCTION_CONFIGURATION_RULE_AT_LEAST_ONE_COMPONENT_WITH_VARIABLE_QUANTITY,
            self::PRODUCTION_CONFIGURATION_RULE_ONE_COMPONENT,
            self::PRODUCTION_CONFIGURATION_RULE_ONE_COMPONENT_WITH_VARIABLE_QUANTITY,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getArticleTypeAllowableValues();
        if (!is_null($this->container['article_type']) && !in_array($this->container['article_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'article_type', must be one of '%s'",
                $this->container['article_type'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getContractBillingCycleAllowableValues();
        if (!is_null($this->container['contract_billing_cycle']) && !in_array($this->container['contract_billing_cycle'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'contract_billing_cycle', must be one of '%s'",
                $this->container['contract_billing_cycle'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getContractBillingModeAllowableValues();
        if (!is_null($this->container['contract_billing_mode']) && !in_array($this->container['contract_billing_mode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'contract_billing_mode', must be one of '%s'",
                $this->container['contract_billing_mode'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getDefaultPriceCalculationTypeAllowableValues();
        if (!is_null($this->container['default_price_calculation_type']) && !in_array($this->container['default_price_calculation_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'default_price_calculation_type', must be one of '%s'",
                $this->container['default_price_calculation_type'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getInvoicingTypeAllowableValues();
        if (!is_null($this->container['invoicing_type']) && !in_array($this->container['invoicing_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'invoicing_type', must be one of '%s'",
                $this->container['invoicing_type'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getMarginCalculationPriceTypeAllowableValues();
        if (!is_null($this->container['margin_calculation_price_type']) && !in_array($this->container['margin_calculation_price_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'margin_calculation_price_type', must be one of '%s'",
                $this->container['margin_calculation_price_type'],
                implode("', '", $allowedValues)
            );
        }
        ...
        $allowedValues = $this->getProductionConfigurationRuleAllowableValues();
        if (!is_null($this->container['production_configuration_rule']) && !in_array($this->container['production_configuration_rule'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'production_configuration_rule', must be one of '%s'",
                $this->container['production_configuration_rule'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets article_type
     *
     * @param string|null $article_type article_type
     *
     * @return self
     */
    public function setArticleType($article_type)
    {
        ...
        $allowedValues = $this->getArticleTypeAllowableValues();
        if (!in_array($article_type, $allowedValues, true)) {
     ...
     *
     * @param string[]|null $available_for_sales_channels available_for_sales_channels
     *
     * @return self
     */
     ...
     *
     * @param string|null $contract_billing_cycle contract_billing_cycle
     *
     * @return self
     */
    public function setContractBillingCycle($contract_billing_cycle)
    {
        ...
        $allowedValues = $this->getContractBillingCycleAllowableValues();
        if (!in_array($contract_billing_cycle, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'contract_billing_cycle', must be one of '%s'",
     ...
     *
     * @param string|null $contract_billing_mode contract_billing_mode
     *
     * @return self
     */
    public function setContractBillingMode($contract_billing_mode)
    {
        ...
        $allowedValues = $this->getContractBillingModeAllowableValues();
        if (!in_array($contract_billing_mode, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'contract_billing_mode', must be one of '%s'",
                    $contract_billing_mode,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     *
     * @param string|null $default_price_calculation_type default_price_calculation_type
     *
     * @return self
     */
    public function setDefaultPriceCalculationType($default_price_calculation_type)
    {
        ...
        $allowedValues = $this->getDefaultPriceCalculationTypeAllowableValues();
        if (!in_array($default_price_calculation_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'default_price_calculation_type', must be one of '%s'",
                    $default_price_calculation_type,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     * Sets invoicing_type
     *
     * @param string|null $invoicing_type invoicing_type
     *
     * @return self
     */
    public function setInvoicingType($invoicing_type)
    {
        ...
        $allowedValues = $this->getInvoicingTypeAllowableValues();
        if (!in_array($invoicing_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'invoicing_type', must be one of '%s'",
                    $invoicing_type,
     ...
     *
     * @param string|null $margin_calculation_price_type margin_calculation_price_type
     *
     * @return self
     */
    public function setMarginCalculationPriceType($margin_calculation_price_type)
    {
        ...
        $allowedValues = $this->getMarginCalculationPriceTypeAllowableValues();
        if (!in_array($margin_calculation_price_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'margin_calculation_price_type', must be one of '%s'",
                    $margin_calculation_price_type,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     *
     * @param string|null $production_configuration_rule production_configuration_rule
     *
     * @return self
     */
    public function setProductionConfigurationRule($production_configuration_rule)
    {
        ...
        $allowedValues = $this->getProductionConfigurationRuleAllowableValues();
        if (!in_array($production_configuration_rule, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'production_configuration_rule', must be one of '%s'",
                    $production_configuration_rule,
                    implode("', '", $allowedValues)
                )
            );
        }

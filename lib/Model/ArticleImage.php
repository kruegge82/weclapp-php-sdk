...
class ArticleImage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['file_name']) && (mb_strlen($this->container['file_name']) > 1000)) {
            $invalidProperties[] = "invalid value for 'file_name', the character length must be smaller than or equal to 1000.";
        }
    ...
    public function setFileName($file_name)
    {
        ...
        if ((mb_strlen($file_name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling ArticleImage., must be smaller than or equal to 1000.');
        }

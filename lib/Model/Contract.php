...
class Contract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'bill_until' => 'string',
        'billing_day' => 'int',
        'billing_target_invoice_status' => 'string',
        'billing_type' => 'string',
        'cancellation_date' => 'int',
        'cancellation_period_quantity' => 'int',
        'cancellation_period_softframe' => 'string',
        'cancellation_period_unit' => 'string',
        ...
        'deposit_location_id' => 'string',
        'description' => 'string',
        'desired_sales_order_status' => 'string',
        ...
        'latest_cancellation_warning_unit' => 'string',
        ...
        'start_date' => 'int',
        'tags' => 'string[]',
        'technical_contact_person_id' => 'string',
        'template' => 'bool',
    ...
    protected static $openAPIFormats = [
        ...
        'description' => null,
        'desired_sales_order_status' => null,
        ...
        'tags' => null,
        'technical_contact_person_id' => null,
        'template' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'deposit_location_id' => false,
        'description' => false,
        'desired_sales_order_status' => false,
        ...
        'start_date' => false,
        'tags' => false,
        'technical_contact_person_id' => false,
        'template' => false,
    ...
    protected static $attributeMap = [
        ...
        'deposit_location_id' => 'depositLocationId',
        'description' => 'description',
        'desired_sales_order_status' => 'desiredSalesOrderStatus',
        ...
        'tags' => 'tags',
        'technical_contact_person_id' => 'technicalContactPersonId',
        'template' => 'template',
    ...
    protected static $setters = [
        ...
        'deposit_location_id' => 'setDepositLocationId',
        'description' => 'setDescription',
        'desired_sales_order_status' => 'setDesiredSalesOrderStatus',
        ...
        'form_variant_id' => 'setFormVariantId',
        ...
        'tags' => 'setTags',
        'technical_contact_person_id' => 'setTechnicalContactPersonId',
    ...
    protected static $getters = [
        ...
        'deposit_location_id' => 'getDepositLocationId',
        'description' => 'getDescription',
        'desired_sales_order_status' => 'getDesiredSalesOrderStatus',
        ...
        'form_variant_id' => 'getFormVariantId',
        ...
        'tags' => 'getTags',
        'technical_contact_person_id' => 'getTechnicalContactPersonId',
    ...
    public const BILL_UNTIL_CURRENT_MONTH_1 = 'CURRENT_MONTH_1';
    public const BILL_UNTIL_CURRENT_MONTH_10 = 'CURRENT_MONTH_10';
    public const BILL_UNTIL_CURRENT_MONTH_11 = 'CURRENT_MONTH_11';
    public const BILL_UNTIL_CURRENT_MONTH_12 = 'CURRENT_MONTH_12';
    public const BILL_UNTIL_CURRENT_MONTH_13 = 'CURRENT_MONTH_13';
    public const BILL_UNTIL_CURRENT_MONTH_14 = 'CURRENT_MONTH_14';
    public const BILL_UNTIL_CURRENT_MONTH_15 = 'CURRENT_MONTH_15';
    public const BILL_UNTIL_CURRENT_MONTH_16 = 'CURRENT_MONTH_16';
    public const BILL_UNTIL_CURRENT_MONTH_17 = 'CURRENT_MONTH_17';
    public const BILL_UNTIL_CURRENT_MONTH_18 = 'CURRENT_MONTH_18';
    public const BILL_UNTIL_CURRENT_MONTH_19 = 'CURRENT_MONTH_19';
    public const BILL_UNTIL_CURRENT_MONTH_2 = 'CURRENT_MONTH_2';
    public const BILL_UNTIL_CURRENT_MONTH_20 = 'CURRENT_MONTH_20';
    public const BILL_UNTIL_CURRENT_MONTH_21 = 'CURRENT_MONTH_21';
    public const BILL_UNTIL_CURRENT_MONTH_22 = 'CURRENT_MONTH_22';
    public const BILL_UNTIL_CURRENT_MONTH_23 = 'CURRENT_MONTH_23';
    public const BILL_UNTIL_CURRENT_MONTH_24 = 'CURRENT_MONTH_24';
    public const BILL_UNTIL_CURRENT_MONTH_25 = 'CURRENT_MONTH_25';
    public const BILL_UNTIL_CURRENT_MONTH_26 = 'CURRENT_MONTH_26';
    public const BILL_UNTIL_CURRENT_MONTH_27 = 'CURRENT_MONTH_27';
    public const BILL_UNTIL_CURRENT_MONTH_28 = 'CURRENT_MONTH_28';
    public const BILL_UNTIL_CURRENT_MONTH_29 = 'CURRENT_MONTH_29';
    public const BILL_UNTIL_CURRENT_MONTH_3 = 'CURRENT_MONTH_3';
    public const BILL_UNTIL_CURRENT_MONTH_30 = 'CURRENT_MONTH_30';
    public const BILL_UNTIL_CURRENT_MONTH_31 = 'CURRENT_MONTH_31';
    public const BILL_UNTIL_CURRENT_MONTH_4 = 'CURRENT_MONTH_4';
    public const BILL_UNTIL_CURRENT_MONTH_5 = 'CURRENT_MONTH_5';
    public const BILL_UNTIL_CURRENT_MONTH_6 = 'CURRENT_MONTH_6';
    public const BILL_UNTIL_CURRENT_MONTH_7 = 'CURRENT_MONTH_7';
    public const BILL_UNTIL_CURRENT_MONTH_8 = 'CURRENT_MONTH_8';
    public const BILL_UNTIL_CURRENT_MONTH_9 = 'CURRENT_MONTH_9';
    public const BILL_UNTIL_NEXT_MONTH_1 = 'NEXT_MONTH_1';
    public const BILL_UNTIL_NEXT_MONTH_10 = 'NEXT_MONTH_10';
    public const BILL_UNTIL_NEXT_MONTH_11 = 'NEXT_MONTH_11';
    public const BILL_UNTIL_NEXT_MONTH_12 = 'NEXT_MONTH_12';
    public const BILL_UNTIL_NEXT_MONTH_13 = 'NEXT_MONTH_13';
    public const BILL_UNTIL_NEXT_MONTH_14 = 'NEXT_MONTH_14';
    public const BILL_UNTIL_NEXT_MONTH_15 = 'NEXT_MONTH_15';
    public const BILL_UNTIL_NEXT_MONTH_16 = 'NEXT_MONTH_16';
    public const BILL_UNTIL_NEXT_MONTH_17 = 'NEXT_MONTH_17';
    public const BILL_UNTIL_NEXT_MONTH_18 = 'NEXT_MONTH_18';
    public const BILL_UNTIL_NEXT_MONTH_19 = 'NEXT_MONTH_19';
    public const BILL_UNTIL_NEXT_MONTH_2 = 'NEXT_MONTH_2';
    public const BILL_UNTIL_NEXT_MONTH_20 = 'NEXT_MONTH_20';
    public const BILL_UNTIL_NEXT_MONTH_21 = 'NEXT_MONTH_21';
    public const BILL_UNTIL_NEXT_MONTH_22 = 'NEXT_MONTH_22';
    public const BILL_UNTIL_NEXT_MONTH_23 = 'NEXT_MONTH_23';
    public const BILL_UNTIL_NEXT_MONTH_24 = 'NEXT_MONTH_24';
    public const BILL_UNTIL_NEXT_MONTH_25 = 'NEXT_MONTH_25';
    public const BILL_UNTIL_NEXT_MONTH_26 = 'NEXT_MONTH_26';
    public const BILL_UNTIL_NEXT_MONTH_27 = 'NEXT_MONTH_27';
    public const BILL_UNTIL_NEXT_MONTH_28 = 'NEXT_MONTH_28';
    public const BILL_UNTIL_NEXT_MONTH_29 = 'NEXT_MONTH_29';
    public const BILL_UNTIL_NEXT_MONTH_3 = 'NEXT_MONTH_3';
    public const BILL_UNTIL_NEXT_MONTH_30 = 'NEXT_MONTH_30';
    public const BILL_UNTIL_NEXT_MONTH_31 = 'NEXT_MONTH_31';
    public const BILL_UNTIL_NEXT_MONTH_4 = 'NEXT_MONTH_4';
    public const BILL_UNTIL_NEXT_MONTH_5 = 'NEXT_MONTH_5';
    public const BILL_UNTIL_NEXT_MONTH_6 = 'NEXT_MONTH_6';
    public const BILL_UNTIL_NEXT_MONTH_7 = 'NEXT_MONTH_7';
    public const BILL_UNTIL_NEXT_MONTH_8 = 'NEXT_MONTH_8';
    public const BILL_UNTIL_NEXT_MONTH_9 = 'NEXT_MONTH_9';
    public const BILLING_TARGET_INVOICE_STATUS_DOCUMENT_CREATED = 'DOCUMENT_CREATED';
    public const BILLING_TARGET_INVOICE_STATUS__NEW = 'NEW';
    public const BILLING_TARGET_INVOICE_STATUS_OPEN_ITEM_CREATED = 'OPEN_ITEM_CREATED';
    public const BILLING_TYPE_INVOICE_AFTER = 'INVOICE_AFTER';
    public const BILLING_TYPE_INVOICE_BEFORE = 'INVOICE_BEFORE';
    public const BILLING_TYPE_NONE = 'NONE';
    public const BILLING_TYPE_NOT_INVOICEABLE = 'NOT_INVOICEABLE';
    public const BILLING_TYPE_SALES_ORDER = 'SALES_ORDER';
    public const CANCELLATION_PERIOD_SOFTFRAME_CONTRACT_END = 'CONTRACT_END';
    public const CANCELLATION_PERIOD_SOFTFRAME_END_OF_CALENDAR_YEAR = 'END_OF_CALENDAR_YEAR';
    public const CANCELLATION_PERIOD_SOFTFRAME_END_OF_CONTRACT_YEAR = 'END_OF_CONTRACT_YEAR';
    public const CANCELLATION_PERIOD_SOFTFRAME_END_OF_MONTH = 'END_OF_MONTH';
    public const CANCELLATION_PERIOD_SOFTFRAME_END_OF_QUARTER = 'END_OF_QUARTER';
    public const CANCELLATION_PERIOD_SOFTFRAME_FIFTEENTH_OF_MONTH = 'FIFTEENTH_OF_MONTH';
    public const CANCELLATION_PERIOD_SOFTFRAME_FIFTEENTH_OR_END_OF_MONTH = 'FIFTEENTH_OR_END_OF_MONTH';
    public const CANCELLATION_PERIOD_SOFTFRAME_HALF_OF_CALENDAR_YEAR = 'HALF_OF_CALENDAR_YEAR';
    public const CANCELLATION_PERIOD_UNIT_DAY = 'DAY';
    public const CANCELLATION_PERIOD_UNIT_MONTH = 'MONTH';
    public const CANCELLATION_PERIOD_UNIT_WEEK = 'WEEK';
    public const CANCELLATION_PERIOD_UNIT_YEAR = 'YEAR';
    ...
    public const DESIRED_SALES_ORDER_STATUS_CANCELLED = 'CANCELLED';
    public const DESIRED_SALES_ORDER_STATUS_CLOSED = 'CLOSED';
    public const DESIRED_SALES_ORDER_STATUS_MANUALLY_CLOSED = 'MANUALLY_CLOSED';
    public const DESIRED_SALES_ORDER_STATUS_ORDER_CONFIRMATION_PRINTED = 'ORDER_CONFIRMATION_PRINTED';
    public const DESIRED_SALES_ORDER_STATUS_ORDER_ENTRY_IN_PROGRESS = 'ORDER_ENTRY_IN_PROGRESS';
    public const EXTENSION_UNIT_DAY = 'DAY';
    public const EXTENSION_UNIT_MONTH = 'MONTH';
    public const EXTENSION_UNIT_WEEK = 'WEEK';
    public const EXTENSION_UNIT_YEAR = 'YEAR';
    public const LATEST_CANCELLATION_WARNING_UNIT_DAY = 'DAY';
    public const LATEST_CANCELLATION_WARNING_UNIT_MONTH = 'MONTH';
    public const LATEST_CANCELLATION_WARNING_UNIT_WEEK = 'WEEK';
    public const LATEST_CANCELLATION_WARNING_UNIT_YEAR = 'YEAR';
    public const REMINDER_SEND_TYPE_MAIL = 'MAIL';
    public const REMINDER_SEND_TYPE_NOTIFICATION = 'NOTIFICATION';
    public const REMINDER_TYPE_AUTOMATIC_REMINDER = 'AUTOMATIC_REMINDER';
    public const REMINDER_TYPE_DATE_REMINDER = 'DATE_REMINDER';
    public const REMINDER_TYPE_NO_REMINDER = 'NO_REMINDER';
     ...
     * @return string[]
     */
    public function getBillUntilAllowableValues()
    {
        return [
            self::BILL_UNTIL_CURRENT_MONTH_1,
            self::BILL_UNTIL_CURRENT_MONTH_10,
            self::BILL_UNTIL_CURRENT_MONTH_11,
            self::BILL_UNTIL_CURRENT_MONTH_12,
            self::BILL_UNTIL_CURRENT_MONTH_13,
            self::BILL_UNTIL_CURRENT_MONTH_14,
            self::BILL_UNTIL_CURRENT_MONTH_15,
            self::BILL_UNTIL_CURRENT_MONTH_16,
            self::BILL_UNTIL_CURRENT_MONTH_17,
            self::BILL_UNTIL_CURRENT_MONTH_18,
            self::BILL_UNTIL_CURRENT_MONTH_19,
            self::BILL_UNTIL_CURRENT_MONTH_2,
            self::BILL_UNTIL_CURRENT_MONTH_20,
            self::BILL_UNTIL_CURRENT_MONTH_21,
            self::BILL_UNTIL_CURRENT_MONTH_22,
            self::BILL_UNTIL_CURRENT_MONTH_23,
            self::BILL_UNTIL_CURRENT_MONTH_24,
            self::BILL_UNTIL_CURRENT_MONTH_25,
            self::BILL_UNTIL_CURRENT_MONTH_26,
            self::BILL_UNTIL_CURRENT_MONTH_27,
            self::BILL_UNTIL_CURRENT_MONTH_28,
            self::BILL_UNTIL_CURRENT_MONTH_29,
            self::BILL_UNTIL_CURRENT_MONTH_3,
            self::BILL_UNTIL_CURRENT_MONTH_30,
            self::BILL_UNTIL_CURRENT_MONTH_31,
            self::BILL_UNTIL_CURRENT_MONTH_4,
            self::BILL_UNTIL_CURRENT_MONTH_5,
            self::BILL_UNTIL_CURRENT_MONTH_6,
            self::BILL_UNTIL_CURRENT_MONTH_7,
            self::BILL_UNTIL_CURRENT_MONTH_8,
            self::BILL_UNTIL_CURRENT_MONTH_9,
            self::BILL_UNTIL_NEXT_MONTH_1,
            self::BILL_UNTIL_NEXT_MONTH_10,
            self::BILL_UNTIL_NEXT_MONTH_11,
            self::BILL_UNTIL_NEXT_MONTH_12,
            self::BILL_UNTIL_NEXT_MONTH_13,
            self::BILL_UNTIL_NEXT_MONTH_14,
            self::BILL_UNTIL_NEXT_MONTH_15,
            self::BILL_UNTIL_NEXT_MONTH_16,
            self::BILL_UNTIL_NEXT_MONTH_17,
            self::BILL_UNTIL_NEXT_MONTH_18,
            self::BILL_UNTIL_NEXT_MONTH_19,
            self::BILL_UNTIL_NEXT_MONTH_2,
            self::BILL_UNTIL_NEXT_MONTH_20,
            self::BILL_UNTIL_NEXT_MONTH_21,
            self::BILL_UNTIL_NEXT_MONTH_22,
            self::BILL_UNTIL_NEXT_MONTH_23,
            self::BILL_UNTIL_NEXT_MONTH_24,
            self::BILL_UNTIL_NEXT_MONTH_25,
            self::BILL_UNTIL_NEXT_MONTH_26,
            self::BILL_UNTIL_NEXT_MONTH_27,
            self::BILL_UNTIL_NEXT_MONTH_28,
            self::BILL_UNTIL_NEXT_MONTH_29,
            self::BILL_UNTIL_NEXT_MONTH_3,
            self::BILL_UNTIL_NEXT_MONTH_30,
            self::BILL_UNTIL_NEXT_MONTH_31,
            self::BILL_UNTIL_NEXT_MONTH_4,
            self::BILL_UNTIL_NEXT_MONTH_5,
            self::BILL_UNTIL_NEXT_MONTH_6,
            self::BILL_UNTIL_NEXT_MONTH_7,
            self::BILL_UNTIL_NEXT_MONTH_8,
            self::BILL_UNTIL_NEXT_MONTH_9,
        ];
    }
     ...
     * @return string[]
     */
    public function getBillingTargetInvoiceStatusAllowableValues()
    {
        return [
            self::BILLING_TARGET_INVOICE_STATUS_DOCUMENT_CREATED,
            self::BILLING_TARGET_INVOICE_STATUS__NEW,
            self::BILLING_TARGET_INVOICE_STATUS_OPEN_ITEM_CREATED,
        ];
    }
    ...
    {
        return [
            self::BILLING_TYPE_INVOICE_AFTER,
            self::BILLING_TYPE_INVOICE_BEFORE,
            self::BILLING_TYPE_NONE,
            self::BILLING_TYPE_NOT_INVOICEABLE,
            self::BILLING_TYPE_SALES_ORDER,
        ];
    }
     ...
     * @return string[]
     */
    public function getCancellationPeriodSoftframeAllowableValues()
    {
        return [
            self::CANCELLATION_PERIOD_SOFTFRAME_CONTRACT_END,
            self::CANCELLATION_PERIOD_SOFTFRAME_END_OF_CALENDAR_YEAR,
            self::CANCELLATION_PERIOD_SOFTFRAME_END_OF_CONTRACT_YEAR,
            self::CANCELLATION_PERIOD_SOFTFRAME_END_OF_MONTH,
            self::CANCELLATION_PERIOD_SOFTFRAME_END_OF_QUARTER,
            self::CANCELLATION_PERIOD_SOFTFRAME_FIFTEENTH_OF_MONTH,
            self::CANCELLATION_PERIOD_SOFTFRAME_FIFTEENTH_OR_END_OF_MONTH,
            self::CANCELLATION_PERIOD_SOFTFRAME_HALF_OF_CALENDAR_YEAR,
        ];
    }
     ...
     * @return string[]
     */
    public function getCancellationPeriodUnitAllowableValues()
    {
        return [
            self::CANCELLATION_PERIOD_UNIT_DAY,
            self::CANCELLATION_PERIOD_UNIT_MONTH,
            self::CANCELLATION_PERIOD_UNIT_WEEK,
            self::CANCELLATION_PERIOD_UNIT_YEAR,
        ];
    }
     ...
     * @return string[]
     */
    public function getDesiredSalesOrderStatusAllowableValues()
    {
        return [
            self::DESIRED_SALES_ORDER_STATUS_CANCELLED,
            self::DESIRED_SALES_ORDER_STATUS_CLOSED,
            self::DESIRED_SALES_ORDER_STATUS_MANUALLY_CLOSED,
            self::DESIRED_SALES_ORDER_STATUS_ORDER_CONFIRMATION_PRINTED,
            self::DESIRED_SALES_ORDER_STATUS_ORDER_ENTRY_IN_PROGRESS,
        ];
    }
     ...
     * @return string[]
     */
    public function getExtensionUnitAllowableValues()
    {
        return [
            self::EXTENSION_UNIT_DAY,
            self::EXTENSION_UNIT_MONTH,
            self::EXTENSION_UNIT_WEEK,
            self::EXTENSION_UNIT_YEAR,
        ];
    }
     ...
     * @return string[]
     */
    public function getLatestCancellationWarningUnitAllowableValues()
    {
        return [
            self::LATEST_CANCELLATION_WARNING_UNIT_DAY,
            self::LATEST_CANCELLATION_WARNING_UNIT_MONTH,
            self::LATEST_CANCELLATION_WARNING_UNIT_WEEK,
            self::LATEST_CANCELLATION_WARNING_UNIT_YEAR,
        ];
    }
    ...
    {
        return [
            self::REMINDER_TYPE_AUTOMATIC_REMINDER,
            self::REMINDER_TYPE_DATE_REMINDER,
            self::REMINDER_TYPE_NO_REMINDER,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('deposit_location_id', $data ?? [], null);
        $this->setIfExists('description', $data ?? [], null);
        $this->setIfExists('desired_sales_order_status', $data ?? [], null);
        ...
        $this->setIfExists('form_variant_id', $data ?? [], null);
        ...
        $this->setIfExists('technical_contact_person_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getBillUntilAllowableValues();
        if (!is_null($this->container['bill_until']) && !in_array($this->container['bill_until'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'bill_until', must be one of '%s'",
                $this->container['bill_until'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getBillingTargetInvoiceStatusAllowableValues();
        if (!is_null($this->container['billing_target_invoice_status']) && !in_array($this->container['billing_target_invoice_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'billing_target_invoice_status', must be one of '%s'",
                $this->container['billing_target_invoice_status'],
                implode("', '", $allowedValues)
            );
        }
        ...
        $allowedValues = $this->getCancellationPeriodSoftframeAllowableValues();
        if (!is_null($this->container['cancellation_period_softframe']) && !in_array($this->container['cancellation_period_softframe'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'cancellation_period_softframe', must be one of '%s'",
                $this->container['cancellation_period_softframe'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getCancellationPeriodUnitAllowableValues();
        if (!is_null($this->container['cancellation_period_unit']) && !in_array($this->container['cancellation_period_unit'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'cancellation_period_unit', must be one of '%s'",
                $this->container['cancellation_period_unit'],
                implode("', '", $allowedValues)
            );
        }
        ...
        $allowedValues = $this->getDesiredSalesOrderStatusAllowableValues();
        if (!is_null($this->container['desired_sales_order_status']) && !in_array($this->container['desired_sales_order_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'desired_sales_order_status', must be one of '%s'",
                $this->container['desired_sales_order_status'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getExtensionUnitAllowableValues();
        if (!is_null($this->container['extension_unit']) && !in_array($this->container['extension_unit'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'extension_unit', must be one of '%s'",
                $this->container['extension_unit'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getLatestCancellationWarningUnitAllowableValues();
        if (!is_null($this->container['latest_cancellation_warning_unit']) && !in_array($this->container['latest_cancellation_warning_unit'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'latest_cancellation_warning_unit', must be one of '%s'",
                $this->container['latest_cancellation_warning_unit'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets bill_until
     *
     * @param string|null $bill_until bill_until
     *
     * @return self
     */
    public function setBillUntil($bill_until)
    {
        ...
        $allowedValues = $this->getBillUntilAllowableValues();
        if (!in_array($bill_until, $allowedValues, true)) {
     ...
     *
     * @param string|null $billing_target_invoice_status billing_target_invoice_status
     *
     * @return self
     */
    public function setBillingTargetInvoiceStatus($billing_target_invoice_status)
    {
        ...
        $allowedValues = $this->getBillingTargetInvoiceStatusAllowableValues();
        if (!in_array($billing_target_invoice_status, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'billing_target_invoice_status', must be one of '%s'",
                    $billing_target_invoice_status,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     *
     * @param string|null $cancellation_period_softframe cancellation_period_softframe
     *
     * @return self
     */
    public function setCancellationPeriodSoftframe($cancellation_period_softframe)
    {
        ...
        $allowedValues = $this->getCancellationPeriodSoftframeAllowableValues();
        if (!in_array($cancellation_period_softframe, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'cancellation_period_softframe', must be one of '%s'",
                    $cancellation_period_softframe,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     *
     * @param string|null $cancellation_period_unit cancellation_period_unit
     *
     * @return self
     */
    public function setCancellationPeriodUnit($cancellation_period_unit)
    {
        ...
        $allowedValues = $this->getCancellationPeriodUnitAllowableValues();
        if (!in_array($cancellation_period_unit, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'cancellation_period_unit', must be one of '%s'",
     ...
     *
     * @param string|null $contract_status contract_status
     *
     * @return self
     */
    public function setContractStatus($contract_status)
    {
        ...
        $allowedValues = $this->getContractStatusAllowableValues();
        if (!in_array($contract_status, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'contract_status', must be one of '%s'",
                    $contract_status,
    ...
    /**
     * Gets deposit_location_id
     *
     * @return string|null
     */
    public function getDepositLocationId()
    {
        return $this->container['deposit_location_id'];
    }

    /**
     * Sets deposit_location_id
     *
     * @param string|null $deposit_location_id deposit_location_id
     *
     * @return self
     */
    public function setDepositLocationId($deposit_location_id)
    {
        if (is_null($deposit_location_id)) {
            throw new \InvalidArgumentException('non-nullable deposit_location_id cannot be null');
        }
        $this->container['deposit_location_id'] = $deposit_location_id;
    ...
    /**
     * Gets desired_sales_order_status
     *
     * @return string|null
     */
    public function getDesiredSalesOrderStatus()
    {
        return $this->container['desired_sales_order_status'];
    }

    /**
     * Sets desired_sales_order_status
     *
     * @param string|null $desired_sales_order_status desired_sales_order_status
     *
     * @return self
     */
    public function setDesiredSalesOrderStatus($desired_sales_order_status)
    {
        if (is_null($desired_sales_order_status)) {
            throw new \InvalidArgumentException('non-nullable desired_sales_order_status cannot be null');
        }
        $allowedValues = $this->getDesiredSalesOrderStatusAllowableValues();
        if (!in_array($desired_sales_order_status, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'desired_sales_order_status', must be one of '%s'",
                    $desired_sales_order_status,
                    implode("', '", $allowedValues)
                )
            );
        }
        $this->container['desired_sales_order_status'] = $desired_sales_order_status;
     ...
     * Sets extension_unit
     *
     * @param string|null $extension_unit extension_unit
     *
     * @return self
     */
    public function setExtensionUnit($extension_unit)
    {
        ...
        $allowedValues = $this->getExtensionUnitAllowableValues();
        if (!in_array($extension_unit, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'extension_unit', must be one of '%s'",
                    $extension_unit,
    ...
    /**
     * Gets form_variant_id
     *
     * @return string|null
     */
    public function getFormVariantId()
    {
        return $this->container['form_variant_id'];
    }

    /**
     * Sets form_variant_id
     *
     * @param string|null $form_variant_id form_variant_id
     *
     * @return self
     */
    public function setFormVariantId($form_variant_id)
    {
        if (is_null($form_variant_id)) {
            throw new \InvalidArgumentException('non-nullable form_variant_id cannot be null');
        }
        $this->container['form_variant_id'] = $form_variant_id;
     ...
     *
     * @param string|null $latest_cancellation_warning_unit latest_cancellation_warning_unit
     *
     * @return self
     */
    public function setLatestCancellationWarningUnit($latest_cancellation_warning_unit)
    {
        ...
        $allowedValues = $this->getLatestCancellationWarningUnitAllowableValues();
        if (!in_array($latest_cancellation_warning_unit, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'latest_cancellation_warning_unit', must be one of '%s'",
                    $latest_cancellation_warning_unit,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     * Sets reminder_type
     *
     * @param string|null $reminder_type reminder_type
     *
     * @return self
     */
    ...
    /**
     * Gets technical_contact_person_id
     *
     * @return string|null
     */
    public function getTechnicalContactPersonId()
    {
        return $this->container['technical_contact_person_id'];
    }

    /**
     * Sets technical_contact_person_id
     *
     * @param string|null $technical_contact_person_id technical_contact_person_id
     *
     * @return self
     */
    public function setTechnicalContactPersonId($technical_contact_person_id)
    {
        if (is_null($technical_contact_person_id)) {
            throw new \InvalidArgumentException('non-nullable technical_contact_person_id cannot be null');
        }
        $this->container['technical_contact_person_id'] = $technical_contact_person_id;

...
class ProductionWorkScheduleAssignment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['production_work_schedule_id'] === null) {
            $invalidProperties[] = "'production_work_schedule_id' can't be null";
        }
     ...
     *
     * @param string $production_work_schedule_id production_work_schedule_id
     *
     * @return self
     */

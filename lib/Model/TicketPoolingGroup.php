...
/**
 * TicketPoolingGroup Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class TicketPoolingGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ticketPoolingGroup';
    ...
    protected static $openAPITypes = [
        ...
        'ticket_pooling_group_members' => '\kruegge82\weclapp\Model\TicketPoolingGroupMember[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'ticket_pooling_group_members' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'ticket_pooling_group_members' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'ticket_pooling_group_members' => 'ticketPoolingGroupMembers'
    ];
    ...
    protected static $setters = [
        ...
        'ticket_pooling_group_members' => 'setTicketPoolingGroupMembers'
    ];
    ...
    protected static $getters = [
        ...
        'ticket_pooling_group_members' => 'getTicketPoolingGroupMembers'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ticket_pooling_group_members', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets ticket_pooling_group_members
     *
     * @return \kruegge82\weclapp\Model\TicketPoolingGroupMember[]|null
     */
    public function getTicketPoolingGroupMembers()
    {
        return $this->container['ticket_pooling_group_members'];
    }

    /**
     * Sets ticket_pooling_group_members
     *
     * @param \kruegge82\weclapp\Model\TicketPoolingGroupMember[]|null $ticket_pooling_group_members ticket_pooling_group_members
     *
     * @return self
     */
    public function setTicketPoolingGroupMembers($ticket_pooling_group_members)
    {
        if (is_null($ticket_pooling_group_members)) {
            throw new \InvalidArgumentException('non-nullable ticket_pooling_group_members cannot be null');
        }
        $this->container['ticket_pooling_group_members'] = $ticket_pooling_group_members;

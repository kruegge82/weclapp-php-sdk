    ...
    */
    ...
    public function setRecipientCountryCode($recipient_country_code)
    {
        ...
        if ((mb_strlen($recipient_country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $recipient_country_code when calling PurchaseOrder., must be smaller than or equal to 5.');
        }
    ...
    public function setSenderCountryCode($sender_country_code)
    {
        ...
        if ((mb_strlen($sender_country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $sender_country_code when calling PurchaseOrder., must be smaller than or equal to 5.');
        }

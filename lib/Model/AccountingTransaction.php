...
class AccountingTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const STATUS_PREBATCHBOOKING = 'PREBATCHBOOKING';
    public const TYPE_CARRY_FORWARD = 'CARRY_FORWARD';
    public const TYPE_CREDIT_ADVICE = 'CREDIT_ADVICE';
    public const TYPE_IMPERSONAL = 'IMPERSONAL';
    public const TYPE_INCOMING_CREDIT_NOTE = 'INCOMING_CREDIT_NOTE';
    public const TYPE_INCOMING_INVOICE = 'INCOMING_INVOICE';
    public const TYPE_INCOMING_MANUAL_ENTRY = 'INCOMING_MANUAL_ENTRY';
    public const TYPE_INCOMING_PAYMENT = 'INCOMING_PAYMENT';
    public const TYPE_OUTGOING_CREDIT_NOTE = 'OUTGOING_CREDIT_NOTE';
    public const TYPE_OUTGOING_INVOICE = 'OUTGOING_INVOICE';
    public const TYPE_OUTGOING_MANUAL_ENTRY = 'OUTGOING_MANUAL_ENTRY';
    public const TYPE_OUTGOING_PAYMENT = 'OUTGOING_PAYMENT';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_CREDIT_ADVICE,
            self::TYPE_IMPERSONAL,
            self::TYPE_INCOMING_CREDIT_NOTE,
            self::TYPE_INCOMING_INVOICE,
            self::TYPE_INCOMING_MANUAL_ENTRY,
            self::TYPE_INCOMING_PAYMENT,
            self::TYPE_OUTGOING_CREDIT_NOTE,
            self::TYPE_OUTGOING_INVOICE,
            self::TYPE_OUTGOING_MANUAL_ENTRY,
            self::TYPE_OUTGOING_PAYMENT,
        ];
    }

...
/**
 * DocumentIdIdCopyPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class DocumentIdIdCopyPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_document_id__id__copy_post_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['source_document_id'] === null) {
            $invalidProperties[] = "'source_document_id' can't be null";
        }
     ...
     *
     * @param string $source_document_id source_document_id
     *
     * @return self
     */
    public function setSourceDocumentId($source_document_id)
    {
        if (is_null($source_document_id)) {
            throw new \InvalidArgumentException('non-nullable source_document_id cannot be null');
        }

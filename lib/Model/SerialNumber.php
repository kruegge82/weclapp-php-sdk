    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SerialNumber., must be smaller than or equal to 2048.');
        }
    ...
    public function setSerialNumber($serial_number)
    {
        ...
        if ((mb_strlen($serial_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling SerialNumber., must be smaller than or equal to 1000.');
        }

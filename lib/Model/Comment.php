...
class Comment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'author_user_username' => 'authorUserUsername',
        'comment' => 'comment',
        'entity_id' => 'entityId',
    ...
    protected static $setters = [
        ...
        'author_user_username' => 'setAuthorUserUsername',
        'comment' => 'setComment',
    ...
    protected static $getters = [
        ...
        'author_user_username' => 'getAuthorUserUsername',
        'comment' => 'getComment',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('author_user_username', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets author_user_username
     *
     * @return string|null
     * @deprecated
     */
    public function getAuthorUserUsername()
    {
        return $this->container['author_user_username'];
    }

    /**
     * Sets author_user_username
     *
     * @param string|null $author_user_username author_user_username
     *
     * @return self
     * @deprecated
     */
    public function setAuthorUserUsername($author_user_username)
    {
        if (is_null($author_user_username)) {
            throw new \InvalidArgumentException('non-nullable author_user_username cannot be null');
        }
        $this->container['author_user_username'] = $author_user_username;

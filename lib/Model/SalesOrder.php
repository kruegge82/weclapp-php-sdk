...
class SalesOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sales_order_payment_type' => 'string',
    ...
    public const ADVANCE_PAYMENT_STATUS_OPEN = 'OPEN';
    ...
    public const SALES_ORDER_PAYMENT_TYPE_ADVANCE_PAYMENT = 'ADVANCE_PAYMENT';
    public const SALES_ORDER_PAYMENT_TYPE_COUNTER_SALES = 'COUNTER_SALES';
    public const SALES_ORDER_PAYMENT_TYPE_PART_PAYMENT = 'PART_PAYMENT';
    public const SALES_ORDER_PAYMENT_TYPE_PREPAYMENT = 'PREPAYMENT';
    public const SALES_ORDER_PAYMENT_TYPE_STANDARD = 'STANDARD';
    public const STATUS_CANCELLED = 'CANCELLED';
    public const STATUS_CLOSED = 'CLOSED';
    public const STATUS_MANUALLY_CLOSED = 'MANUALLY_CLOSED';
    public const STATUS_ORDER_CONFIRMATION_PRINTED = 'ORDER_CONFIRMATION_PRINTED';
    public const STATUS_ORDER_ENTRY_IN_PROGRESS = 'ORDER_ENTRY_IN_PROGRESS';
    ...
    {
        return [
            self::ADVANCE_PAYMENT_STATUS_OPEN,
            self::ADVANCE_PAYMENT_STATUS_PAID,
        ];
    }
     ...
     * @return string[]
     */
    public function getSalesOrderPaymentTypeAllowableValues()
    {
        return [
            self::SALES_ORDER_PAYMENT_TYPE_ADVANCE_PAYMENT,
            self::SALES_ORDER_PAYMENT_TYPE_COUNTER_SALES,
            self::SALES_ORDER_PAYMENT_TYPE_PART_PAYMENT,
            self::SALES_ORDER_PAYMENT_TYPE_PREPAYMENT,
            self::SALES_ORDER_PAYMENT_TYPE_STANDARD,
        ];
    }
    ...
    public function getStatusAllowableValues()
    {
        return [
            ...
            self::STATUS_ORDER_CONFIRMATION_PRINTED,
            self::STATUS_ORDER_ENTRY_IN_PROGRESS,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSalesOrderPaymentTypeAllowableValues();
        if (!is_null($this->container['sales_order_payment_type']) && !in_array($this->container['sales_order_payment_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'sales_order_payment_type', must be one of '%s'",
                $this->container['sales_order_payment_type'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string|null $advance_payment_status advance_payment_status
     *
     * @return self
     */
    public function setAdvancePaymentStatus($advance_payment_status)
    {
        ...
        $allowedValues = $this->getAdvancePaymentStatusAllowableValues();
        if (!in_array($advance_payment_status, $allowedValues, true)) {
     ...
     *
     * @param string|null $sales_order_payment_type sales_order_payment_type
     *
     * @return self
     */
    public function setSalesOrderPaymentType($sales_order_payment_type)
    {
        ...
        $allowedValues = $this->getSalesOrderPaymentTypeAllowableValues();
        if (!in_array($sales_order_payment_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'sales_order_payment_type', must be one of '%s'",
                    $sales_order_payment_type,
                    implode("', '", $allowedValues)
                )
            );
        }

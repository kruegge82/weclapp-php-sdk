    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Warehouse., must be smaller than or equal to 150.');
        }
    ...
    public function setShortIdentifier($short_identifier)
    {
        ...
        if ((mb_strlen($short_identifier) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $short_identifier when calling Warehouse., must be smaller than or equal to 1000.');
        }

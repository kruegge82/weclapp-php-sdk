...
/**
 * SystemCreateDemoTestSystemPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class SystemCreateDemoTestSystemPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_system_createDemoTestSystem_post_request';
    ...
    public const PRESET_PROD_SYSTEM = 'PROD_SYSTEM';
    public const PRESET_TEMPLATE_SYSTEM = 'TEMPLATE_SYSTEM';
    ...
    public function getPresetAllowableValues()
    {
        return [
            self::PRESET_NONE,
            self::PRESET_PROD_SYSTEM,
            self::PRESET_TEMPLATE_SYSTEM,
        ];
    }
    ...
    {
        $this->setIfExists('all_users', $data ?? [], null);
    ...
    */
     ...
     * Sets all_users
     *
     * @param bool|null $all_users all_users
     *
     * @return self
     */
    public function setAllUsers($all_users)
    {
        if (is_null($all_users)) {
            throw new \InvalidArgumentException('non-nullable all_users cannot be null');
        }

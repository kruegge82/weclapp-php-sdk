...
class LedgerAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'parent_account_number' => 'setParentAccountNumber',
        'type' => 'setType'
    ];
    ...
    protected static $getters = [
        ...
        'parent_account_number' => 'getParentAccountNumber',
        'type' => 'getType'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('parent_account_number', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['parent_account_number'];
    }

    /**
     * Sets parent_account_number
     *
     * @param string|null $parent_account_number parent_account_number
     *
     * @return self
     * @deprecated
     */
    public function setParentAccountNumber($parent_account_number)
    {
        if (is_null($parent_account_number)) {
            throw new \InvalidArgumentException('non-nullable parent_account_number cannot be null');
        }
        $this->container['parent_account_number'] = $parent_account_number;

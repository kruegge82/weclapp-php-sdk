    ...
    */
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Address., must be smaller than or equal to 5.');
        }
     ...
     *
     * @param bool|null $primary_address primary_address
     *
     * @return self
     */

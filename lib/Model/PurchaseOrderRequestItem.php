...
class PurchaseOrderRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'price_scale_values' => 'priceScaleValues'
    ];
    ...
    protected static $setters = [
        ...
        'price_scale_values' => 'setPriceScaleValues'
    ];
    ...
    protected static $getters = [
        ...
        'price_scale_values' => 'getPriceScaleValues'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('price_scale_values', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets price_scale_values
     *
     * @return float[]|null
     */
    public function getPriceScaleValues()
    {
        return $this->container['price_scale_values'];
    }

    /**
     * Sets price_scale_values
     *
     * @param float[]|null $price_scale_values price_scale_values
     *
     * @return self
     */
    public function setPriceScaleValues($price_scale_values)
    {
        if (is_null($price_scale_values)) {
            throw new \InvalidArgumentException('non-nullable price_scale_values cannot be null');
        }
        $this->container['price_scale_values'] = $price_scale_values;

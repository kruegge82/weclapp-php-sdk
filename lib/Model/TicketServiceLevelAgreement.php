...
/**
 * TicketServiceLevelAgreement Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class TicketServiceLevelAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ticketServiceLevelAgreement';
    ...
    protected static $openAPITypes = [
        ...
        'version' => 'string',
        'active' => 'bool',
        'categories' => '\kruegge82\weclapp\Model\OnlyId[]',
        'customers' => '\kruegge82\weclapp\Model\OnlyId[]',
        'degree_of_performance' => 'int',
        'include_no_ticket_type' => 'bool',
        'name' => 'string',
        'rating_id' => 'string',
        'targets' => '\kruegge82\weclapp\Model\TicketServiceLevelAgreementTarget[]',
    ...
    protected static $openAPIFormats = [
        ...
        'categories' => null,
        'customers' => null,
        'degree_of_performance' => 'int32',
        'include_no_ticket_type' => null,
        'name' => null,
        'rating_id' => null,
        'targets' => null,
        'types' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'categories' => false,
        'customers' => false,
        'degree_of_performance' => false,
        'include_no_ticket_type' => false,
        'name' => false,
        'rating_id' => false,
        'targets' => false,
        'types' => false,
    ...
    protected static $attributeMap = [
        ...
        'customers' => 'customers',
        'degree_of_performance' => 'degreeOfPerformance',
        'include_no_ticket_type' => 'includeNoTicketType',
        'name' => 'name',
        'rating_id' => 'ratingId',
        'targets' => 'targets',
        'types' => 'types',
    ...
    protected static $setters = [
        ...
        'degree_of_performance' => 'setDegreeOfPerformance',
        'include_no_ticket_type' => 'setIncludeNoTicketType',
        'name' => 'setName',
    ...
    protected static $getters = [
        ...
        'degree_of_performance' => 'getDegreeOfPerformance',
        'include_no_ticket_type' => 'getIncludeNoTicketType',
        'name' => 'getName',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('degree_of_performance', $data ?? [], null);
        $this->setIfExists('include_no_ticket_type', $data ?? [], null);
    ...
    */
     ...
     * Sets categories
     *
     * @param \kruegge82\weclapp\Model\OnlyId[]|null $categories categories
     *
     * @return self
     */
    ...
    /**
     * Gets degree_of_performance
     *
     * @return int|null
     */
    public function getDegreeOfPerformance()
    {
        return $this->container['degree_of_performance'];
    }

    /**
     * Sets degree_of_performance
     *
     * @param int|null $degree_of_performance degree_of_performance
     *
     * @return self
     */
    public function setDegreeOfPerformance($degree_of_performance)
    {
        if (is_null($degree_of_performance)) {
            throw new \InvalidArgumentException('non-nullable degree_of_performance cannot be null');
        }
        $this->container['degree_of_performance'] = $degree_of_performance;

        return $this;
    }

    /**
     * Gets include_no_ticket_type
     *
     * @return bool|null
     */
    public function getIncludeNoTicketType()
    {
        return $this->container['include_no_ticket_type'];
    }

    /**
     * Sets include_no_ticket_type
     *
     * @param bool|null $include_no_ticket_type include_no_ticket_type
     *
     * @return self
     */
    public function setIncludeNoTicketType($include_no_ticket_type)
    {
        if (is_null($include_no_ticket_type)) {
            throw new \InvalidArgumentException('non-nullable include_no_ticket_type cannot be null');
        }
        $this->container['include_no_ticket_type'] = $include_no_ticket_type;
     ...
     * Gets targets
     *
     * @return \kruegge82\weclapp\Model\TicketServiceLevelAgreementTarget[]|null
     */
     ...
     * Sets targets
     *
     * @param \kruegge82\weclapp\Model\TicketServiceLevelAgreementTarget[]|null $targets targets
     *
     * @return self
     */

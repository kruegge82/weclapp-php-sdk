<?php
/**
 * ArticleSupplySourceGet200ResponseAdditionalProperties
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ArticleSupplySourceGet200ResponseAdditionalProperties Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class ArticleSupplySourceGet200ResponseAdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_articleSupplySource_get_200_response_additionalProperties';
    ...
    protected static $openAPITypes = [
        'current_purchase_price' => '\kruegge82\weclapp\Model\PriceData[]',
        'current_purchase_price_in_company_currency' => '\kruegge82\weclapp\Model\Amount[]',
        'last_purchase_order_date' => 'int[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'current_purchase_price_in_company_currency' => null,
        'last_purchase_order_date' => 'timestamp'
    ];
    ...
    protected static array $openAPINullables = [
        'current_purchase_price' => false,
        'current_purchase_price_in_company_currency' => false,
        'last_purchase_order_date' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'current_purchase_price_in_company_currency' => 'currentPurchasePriceInCompanyCurrency',
        'last_purchase_order_date' => 'lastPurchaseOrderDate'
    ];
    ...
    protected static $setters = [
        'current_purchase_price' => 'setCurrentPurchasePrice',
        'current_purchase_price_in_company_currency' => 'setCurrentPurchasePriceInCompanyCurrency',
        'last_purchase_order_date' => 'setLastPurchaseOrderDate'
    ];
    ...
    protected static $getters = [
        'current_purchase_price' => 'getCurrentPurchasePrice',
        'current_purchase_price_in_company_currency' => 'getCurrentPurchasePriceInCompanyCurrency',
        'last_purchase_order_date' => 'getLastPurchaseOrderDate'
    ];
    ...
    {
        $this->setIfExists('current_purchase_price', $data ?? [], null);
        $this->setIfExists('current_purchase_price_in_company_currency', $data ?? [], null);
        $this->setIfExists('last_purchase_order_date', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets current_purchase_price
     *
     * @return \kruegge82\weclapp\Model\PriceData[]|null
     */
    public function getCurrentPurchasePrice()
    {
        return $this->container['current_purchase_price'];
    }

    /**
     * Sets current_purchase_price
     *
     * @param \kruegge82\weclapp\Model\PriceData[]|null $current_purchase_price current_purchase_price
     *
     * @return self
     */
    public function setCurrentPurchasePrice($current_purchase_price)
    {
        if (is_null($current_purchase_price)) {
            throw new \InvalidArgumentException('non-nullable current_purchase_price cannot be null');
        }
        $this->container['current_purchase_price'] = $current_purchase_price;

        return $this;
    }

    /**
     * Gets current_purchase_price_in_company_currency
     *
     * @return \kruegge82\weclapp\Model\Amount[]|null
     */
    public function getCurrentPurchasePriceInCompanyCurrency()
    {
        return $this->container['current_purchase_price_in_company_currency'];
    }

    /**
     * Sets current_purchase_price_in_company_currency
     *
     * @param \kruegge82\weclapp\Model\Amount[]|null $current_purchase_price_in_company_currency current_purchase_price_in_company_currency
     *
     * @return self
     */
    public function setCurrentPurchasePriceInCompanyCurrency($current_purchase_price_in_company_currency)
    {
        if (is_null($current_purchase_price_in_company_currency)) {
            throw new \InvalidArgumentException('non-nullable current_purchase_price_in_company_currency cannot be null');
        }
        $this->container['current_purchase_price_in_company_currency'] = $current_purchase_price_in_company_currency;

        return $this;
    }

    /**
     * Gets last_purchase_order_date
     *
     * @return int[]|null
     */
    public function getLastPurchaseOrderDate()
    {
        return $this->container['last_purchase_order_date'];
    }

    /**
     * Sets last_purchase_order_date
     *
     * @param int[]|null $last_purchase_order_date last_purchase_order_date
     *
     * @return self
     */
    public function setLastPurchaseOrderDate($last_purchase_order_date)
    {
        if (is_null($last_purchase_order_date)) {
            throw new \InvalidArgumentException('non-nullable last_purchase_order_date cannot be null');
        }
        $this->container['last_purchase_order_date'] = $last_purchase_order_date;

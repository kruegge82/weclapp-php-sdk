...
class Customer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'customer_rating_name' => 'string',
        'customer_supplier_number' => 'string',
        'customer_topics' => '\kruegge82\weclapp\Model\Entity[]',
        ...
        'satisfaction' => '\kruegge82\weclapp\Model\CustomerSatisfaction',
    ...
    protected static $attributeMap = [
        ...
        'customer_rating_name' => 'customerRatingName',
    ...
    protected static $setters = [
        ...
        'customer_rating_name' => 'setCustomerRatingName',
    ...
    protected static $getters = [
        ...
        'customer_rating_name' => 'getCustomerRatingName',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('customer_rating_name', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['amount_insured']) && !preg_match("/^([0-9]{1,14})([.][0-9]{1,4})?$/", $this->container['amount_insured'])) {
            $invalidProperties[] = "invalid value for 'amount_insured', must be conform to the pattern /^([0-9]{1,14})([.][0-9]{1,4})?$/.";
        }

        if (!is_null($this->container['credit_limit']) && !preg_match("/^([0-9]{1,14})([.][0-9]{1,4})?$/", $this->container['credit_limit'])) {
            $invalidProperties[] = "invalid value for 'credit_limit', must be conform to the pattern /^([0-9]{1,14})([.][0-9]{1,4})?$/.";
        }
    ...
    public function setAmountInsured($amount_insured)
    {
        ...
        if ((!preg_match("/^([0-9]{1,14})([.][0-9]{1,4})?$/", ObjectSerializer::toString($amount_insured)))) {
            throw new \InvalidArgumentException("invalid value for \$amount_insured when calling Customer., must conform to the pattern /^([0-9]{1,14})([.][0-9]{1,4})?$/.");
        }
    ...
    public function setCreditLimit($credit_limit)
    {
        ...
        if ((!preg_match("/^([0-9]{1,14})([.][0-9]{1,4})?$/", ObjectSerializer::toString($credit_limit)))) {
            throw new \InvalidArgumentException("invalid value for \$credit_limit when calling Customer., must conform to the pattern /^([0-9]{1,14})([.][0-9]{1,4})?$/.");
        }
    ...
    /**
     * Gets customer_rating_name
     *
     * @return string|null
     * @deprecated
     */
    public function getCustomerRatingName()
    {
        return $this->container['customer_rating_name'];
    }

    /**
     * Sets customer_rating_name
     *
     * @param string|null $customer_rating_name customer_rating_name
     *
     * @return self
     * @deprecated
     */
    public function setCustomerRatingName($customer_rating_name)
    {
        if (is_null($customer_rating_name)) {
            throw new \InvalidArgumentException('non-nullable customer_rating_name cannot be null');
        }
        $this->container['customer_rating_name'] = $customer_rating_name;
     ...
     *
     * @param \kruegge82\weclapp\Model\Entity[]|null $customer_topics customer_topics
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets satisfaction
     *
     * @param \kruegge82\weclapp\Model\CustomerSatisfaction|null $satisfaction satisfaction
     *
     * @return self
     */

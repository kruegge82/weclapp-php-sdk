...
/**
 * LoadingEquipmentIdentifier Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class LoadingEquipmentIdentifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'loadingEquipmentIdentifier';
    ...
    protected static $openAPITypes = [
        ...
        'version' => 'string',
        'description' => 'string',
        'loading_equipment_articles' => '\kruegge82\weclapp\Model\OnlyId[]',
        'name' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'version' => null,
        'description' => null,
        'loading_equipment_articles' => null,
        'name' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'version' => false,
        'description' => false,
        'loading_equipment_articles' => false,
        'name' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'loading_equipment_articles' => 'loadingEquipmentArticles',
        'name' => 'name'
    ];
    ...
    protected static $setters = [
        ...
        'loading_equipment_articles' => 'setLoadingEquipmentArticles',
        'name' => 'setName'
    ];
    ...
    protected static $getters = [
        ...
        'loading_equipment_articles' => 'getLoadingEquipmentArticles',
        'name' => 'getName'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('loading_equipment_articles', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets loading_equipment_articles
     *
     * @return \kruegge82\weclapp\Model\OnlyId[]|null
     */
    public function getLoadingEquipmentArticles()
    {
        return $this->container['loading_equipment_articles'];
    }

    /**
     * Sets loading_equipment_articles
     *
     * @param \kruegge82\weclapp\Model\OnlyId[]|null $loading_equipment_articles loading_equipment_articles
     *
     * @return self
     */
    public function setLoadingEquipmentArticles($loading_equipment_articles)
    {
        if (is_null($loading_equipment_articles)) {
            throw new \InvalidArgumentException('non-nullable loading_equipment_articles cannot be null');
        }
        $this->container['loading_equipment_articles'] = $loading_equipment_articles;

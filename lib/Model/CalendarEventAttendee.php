...
/**
 * CalendarEventAttendee Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class CalendarEventAttendee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'calendarEventAttendee';
    ...
    protected static $openAPITypes = [
        ...
        'version' => 'string',
        'attendee_status' => '\kruegge82\weclapp\Model\EventInvitationStatus',
        'calendar_event_id' => 'string',
        'event_permission' => '\kruegge82\weclapp\Model\EventRight',
        'user_id' => 'string'
    ];
    ...
    protected static $setters = [
        ...
        'event_permission' => 'setEventPermission',
        'user_id' => 'setUserId'
    ];
    ...
    protected static $getters = [
        ...
        'event_permission' => 'getEventPermission',
        'user_id' => 'getUserId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('attendee_status', $data ?? [], null);
        $this->setIfExists('calendar_event_id', $data ?? [], null);
        $this->setIfExists('event_permission', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \kruegge82\weclapp\Model\EventInvitationStatus|null
     */
     ...
     *
     * @param \kruegge82\weclapp\Model\EventInvitationStatus|null $attendee_status attendee_status
     *
     * @return self
     */
    public function setAttendeeStatus($attendee_status)
    {
        if (is_null($attendee_status)) {
            throw new \InvalidArgumentException('non-nullable attendee_status cannot be null');
        }
    ...
    /**
     * Gets event_permission
     *
     * @return \kruegge82\weclapp\Model\EventRight|null
     */
    public function getEventPermission()
    {
        return $this->container['event_permission'];
    }

    /**
     * Sets event_permission
     *
     * @param \kruegge82\weclapp\Model\EventRight|null $event_permission event_permission
     *
     * @return self
     */
    public function setEventPermission($event_permission)
    {
        if (is_null($event_permission)) {
            throw new \InvalidArgumentException('non-nullable event_permission cannot be null');
        }
        $this->container['event_permission'] = $event_permission;

...
/**
 * ArticleIdIdCreateLabelPdfPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class ArticleIdIdCreateLabelPdfPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_article_id__id__createLabelPdf_post_request';
    ...
    {
        $this->setIfExists('print_count', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['print_count'] === null) {
            $invalidProperties[] = "'print_count' can't be null";
        }
    ...
    {
        if (is_null($print_count)) {
            throw new \InvalidArgumentException('non-nullable print_count cannot be null');
        }

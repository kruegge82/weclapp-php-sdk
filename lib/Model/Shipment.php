...
class Shipment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'package_width' => 'int',
        'parcels' => '\kruegge82\weclapp\Model\Parcel[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['total_weight']) && !preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", $this->container['total_weight'])) {
            $invalidProperties[] = "invalid value for 'total_weight', must be conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.";
        }
     ...
     * Gets parcels
     *
     * @return \kruegge82\weclapp\Model\Parcel[]|null
     */
     ...
     * Sets parcels
     *
     * @param \kruegge82\weclapp\Model\Parcel[]|null $parcels parcels
     *
     * @return self
     */
    ...
    public function setTotalWeight($total_weight)
    {
        ...
        if ((!preg_match("/^-?([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($total_weight)))) {
            throw new \InvalidArgumentException("invalid value for \$total_weight when calling Shipment., must conform to the pattern /^-?([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }

...
/**
 * TaxConfigureSalesTaxesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class TaxConfigureSalesTaxesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tax_configureSalesTaxes_post_request';
    ...
    protected static $openAPIFormats = [
        ...
        'tax_eu_persons_recipient_country' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'tax_eu_persons_recipient_country' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'tax_eu_persons_recipient_country' => 'taxEuPersonsRecipientCountry'
    ];
    ...
    protected static $setters = [
        ...
        'tax_eu_persons_recipient_country' => 'setTaxEuPersonsRecipientCountry'
    ];
    ...
    protected static $getters = [
        ...
        'tax_eu_persons_recipient_country' => 'getTaxEuPersonsRecipientCountry'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tax_eu_persons_recipient_country', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tax_eu_persons_recipient_country'] === null) {
            $invalidProperties[] = "'tax_eu_persons_recipient_country' can't be null";
        }
    ...
    /**
     * Gets tax_eu_persons_recipient_country
     *
     * @return bool
     */
    public function getTaxEuPersonsRecipientCountry()
    {
        return $this->container['tax_eu_persons_recipient_country'];
    }

    /**
     * Sets tax_eu_persons_recipient_country
     *
     * @param bool $tax_eu_persons_recipient_country tax_eu_persons_recipient_country
     *
     * @return self
     */
    public function setTaxEuPersonsRecipientCountry($tax_eu_persons_recipient_country)
    {
        if (is_null($tax_eu_persons_recipient_country)) {
            throw new \InvalidArgumentException('non-nullable tax_eu_persons_recipient_country cannot be null');
        }
        $this->container['tax_eu_persons_recipient_country'] = $tax_eu_persons_recipient_country;

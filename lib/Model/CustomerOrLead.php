...
/**
 * CustomerOrLead Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class CustomerOrLead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerOrLead';
    ...
    */
    ...
    public function setAnnualRevenue($annual_revenue)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($annual_revenue)))) {
            throw new \InvalidArgumentException("invalid value for \$annual_revenue when calling CustomerOrLead., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }

...
/**
 * SalesOrderStatusHistory Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class SalesOrderStatusHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'salesOrderStatusHistory';
    ...
    protected static $setters = [
        'credit_limit_exceeded' => 'setCreditLimitExceeded',
        'status' => 'setStatus',
    ...
    protected static $getters = [
        'credit_limit_exceeded' => 'getCreditLimitExceeded',
        'status' => 'getStatus',
    ...
    {
        $this->setIfExists('credit_limit_exceeded', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets credit_limit_exceeded
     *
     * @return bool|null
     */
    public function getCreditLimitExceeded()
    {
        return $this->container['credit_limit_exceeded'];
    }

    /**
     * Sets credit_limit_exceeded
     *
     * @param bool|null $credit_limit_exceeded credit_limit_exceeded
     *
     * @return self
     */
    public function setCreditLimitExceeded($credit_limit_exceeded)
    {
        if (is_null($credit_limit_exceeded)) {
            throw new \InvalidArgumentException('non-nullable credit_limit_exceeded cannot be null');
        }
        $this->container['credit_limit_exceeded'] = $credit_limit_exceeded;

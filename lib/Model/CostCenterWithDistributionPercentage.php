...
/**
 * CostCenterWithDistributionPercentage Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class CostCenterWithDistributionPercentage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'costCenterWithDistributionPercentage';
    ...
    protected static $setters = [
        ...
        'distribution_percentage' => 'setDistributionPercentage'
    ];
    ...
    protected static $getters = [
        ...
        'distribution_percentage' => 'getDistributionPercentage'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('distribution_percentage', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets distribution_percentage
     *
     * @return float|null
     */
    public function getDistributionPercentage()
    {
        return $this->container['distribution_percentage'];
    }

    /**
     * Sets distribution_percentage
     *
     * @param float|null $distribution_percentage distribution_percentage
     *
     * @return self
     */
    public function setDistributionPercentage($distribution_percentage)
    {
        if (is_null($distribution_percentage)) {

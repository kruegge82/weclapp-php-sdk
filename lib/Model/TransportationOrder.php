...
class TransportationOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TRANSPORTATION_ORDER_TYPE_PICKING = 'PICKING';
    public const TRANSPORTATION_ORDER_TYPE_STOCK_TRANSFER = 'STOCK_TRANSFER';
     ...
     * @return string[]
     */
    public function getTransportationOrderTypeAllowableValues()
    {
        return [
            self::TRANSPORTATION_ORDER_TYPE_PICKING,
            self::TRANSPORTATION_ORDER_TYPE_STOCK_TRANSFER,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['transportation_order_type'] === null) {
            $invalidProperties[] = "'transportation_order_type' can't be null";
        }
        $allowedValues = $this->getTransportationOrderTypeAllowableValues();
        if (!is_null($this->container['transportation_order_type']) && !in_array($this->container['transportation_order_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'transportation_order_type', must be one of '%s'",
                $this->container['transportation_order_type'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string $transportation_order_type transportation_order_type
     *
     * @return self
     */
    public function setTransportationOrderType($transportation_order_type)
    {
        ...
        $allowedValues = $this->getTransportationOrderTypeAllowableValues();
        if (!in_array($transportation_order_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'transportation_order_type', must be one of '%s'",

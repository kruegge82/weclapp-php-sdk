    ...
    */
    ...
    public function setBatchNumber($batch_number)
    {
        ...
        if ((mb_strlen($batch_number) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $batch_number when calling InventoryItem., must be smaller than or equal to 1000.');
        }
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InventoryItem., must be smaller than or equal to 255.');
        }
    ...
    public function setPositionNumber($position_number)
    {
        ...
        if ((mb_strlen($position_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $position_number when calling InventoryItem., must be smaller than or equal to 255.');
        }

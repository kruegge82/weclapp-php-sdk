...
class Quotation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const QUOTATION_TYPE_CONTRACT = 'CONTRACT';
    public const QUOTATION_TYPE_NONE = 'NONE';
    public const QUOTATION_TYPE_PROJECT = 'PROJECT';
    public const QUOTATION_TYPE_SALES_INVOICE = 'SALES_INVOICE';
    public const QUOTATION_TYPE_SALES_ORDER = 'SALES_ORDER';
    public const STATUS_ACCEPTED = 'ACCEPTED';
    public const STATUS_CANCELLED = 'CANCELLED';
    public const STATUS_INQUIRED = 'INQUIRED';
     ...
     * @return string[]
     */
    public function getQuotationTypeAllowableValues()
    {
        return [
            self::QUOTATION_TYPE_CONTRACT,
            self::QUOTATION_TYPE_NONE,
            self::QUOTATION_TYPE_PROJECT,
            self::QUOTATION_TYPE_SALES_INVOICE,
            self::QUOTATION_TYPE_SALES_ORDER,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getQuotationTypeAllowableValues();
        if (!is_null($this->container['quotation_type']) && !in_array($this->container['quotation_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'quotation_type', must be one of '%s'",
                $this->container['quotation_type'],
     ...
     * Sets quotation_type
     *
     * @param string|null $quotation_type quotation_type
     *
     * @return self
     */
    public function setQuotationType($quotation_type)
    {
        ...
        $allowedValues = $this->getQuotationTypeAllowableValues();
        if (!in_array($quotation_type, $allowedValues, true)) {

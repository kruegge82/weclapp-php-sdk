...
/**
 * CustomerSpecificArticleAttributes Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class CustomerSpecificArticleAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerSpecificArticleAttributes';
    ...
    */
    ...
    public function setCustomerArticleNumber($customer_article_number)
    {
        if (is_null($customer_article_number)) {
            throw new \InvalidArgumentException('non-nullable customer_article_number cannot be null');
        }

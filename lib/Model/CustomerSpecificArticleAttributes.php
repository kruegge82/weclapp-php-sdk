...
class CustomerSpecificArticleAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customer_article_number'] === null) {
            $invalidProperties[] = "'customer_article_number' can't be null";
        }
     ...
     *
     * @param string $customer_article_number customer_article_number
     *
     * @return self
     */

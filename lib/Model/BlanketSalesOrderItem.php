...
/**
 * BlanketSalesOrderItem Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class BlanketSalesOrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blanketSalesOrderItem';
    ...
    */
    ...
    public function setReleasedQuantity($released_quantity)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($released_quantity)))) {
            throw new \InvalidArgumentException("invalid value for \$released_quantity when calling BlanketSalesOrderItem., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }

<?php
/**
 * CustomAttributeDefinitionUpdateOrderPostRequestOrderInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CustomAttributeDefinitionUpdateOrderPostRequestOrderInner Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class CustomAttributeDefinitionUpdateOrderPostRequestOrderInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_customAttributeDefinition_updateOrder_post_request_order_inner';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'override_group_name' => 'overrideGroupName'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'override_group_name' => 'setOverrideGroupName'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'override_group_name' => 'getOverrideGroupName'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('override_group_name', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets override_group_name
     *
     * @return string|null
     */
    public function getOverrideGroupName()
    {
        return $this->container['override_group_name'];
    }

    /**
     * Sets override_group_name
     *
     * @param string|null $override_group_name override_group_name
     *
     * @return self
     */
    public function setOverrideGroupName($override_group_name)
    {
        if (is_null($override_group_name)) {
            throw new \InvalidArgumentException('non-nullable override_group_name cannot be null');
        }
        $this->container['override_group_name'] = $override_group_name;

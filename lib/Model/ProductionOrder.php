...
class ProductionOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['target_end_date'] === null) {
            $invalidProperties[] = "'target_end_date' can't be null";
        }
        if ($this->container['target_quantity'] === null) {
            $invalidProperties[] = "'target_quantity' can't be null";
        }
        if ($this->container['target_start_date'] === null) {
            $invalidProperties[] = "'target_start_date' can't be null";
        }
     ...
     *
     * @param int $target_end_date target_end_date
     *
     * @return self
     */
     ...
     *
     * @param float $target_quantity target_quantity
     *
     * @return self
     */
     ...
     *
     * @param int $target_start_date target_start_date
     *
     * @return self
     */

...
class Ticket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'note' => 'string',
        'party_id' => 'string',
        'performance_recorded_status' => 'string',
        'phone_number' => 'string',
    ...
    public const INVOICING_STATUS_NOT_INVOICED = 'NOT_INVOICED';
    public const INVOICING_STATUS_PARTLY_INVOICED = 'PARTLY_INVOICED';
    public const PERFORMANCE_RECORDED_STATUS_NOT_PERFORMANCE_RECORDED = 'NOT_PERFORMANCE_RECORDED';
    public const PERFORMANCE_RECORDED_STATUS_PERFORMANCE_RECORDED = 'PERFORMANCE_RECORDED';
    public const PERFORMANCE_RECORDED_STATUS_UNDEFINED = 'UNDEFINED';
    public const TICKET_RATING_STARS_1 = 'STARS_1';
    public const TICKET_RATING_STARS_2 = 'STARS_2';
    public const TICKET_RATING_STARS_3 = 'STARS_3';
    public const TICKET_RATING_STARS_4 = 'STARS_4';
    public const TICKET_RATING_STARS_5 = 'STARS_5';
     ...
     * @return string[]
     */
    public function getInvoicingStatusAllowableValues()
    {
        return [
            self::INVOICING_STATUS_INVOICED,
            self::INVOICING_STATUS_NOT_INVOICED,
            self::INVOICING_STATUS_PARTLY_INVOICED,
        ];
    }
     ...
     * @return string[]
     */
    public function getPerformanceRecordedStatusAllowableValues()
    {
        return [
            self::PERFORMANCE_RECORDED_STATUS_NOT_PERFORMANCE_RECORDED,
            self::PERFORMANCE_RECORDED_STATUS_PERFORMANCE_RECORDED,
            self::PERFORMANCE_RECORDED_STATUS_UNDEFINED,
        ];
    }
     ...
     * @return string[]
     */
    public function getTicketRatingAllowableValues()
    {
        return [
            self::TICKET_RATING_STARS_1,
            self::TICKET_RATING_STARS_2,
            self::TICKET_RATING_STARS_3,
            self::TICKET_RATING_STARS_4,
            self::TICKET_RATING_STARS_5,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getInvoicingStatusAllowableValues();
        if (!is_null($this->container['invoicing_status']) && !in_array($this->container['invoicing_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'invoicing_status', must be one of '%s'",
                $this->container['invoicing_status'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getPerformanceRecordedStatusAllowableValues();
        if (!is_null($this->container['performance_recorded_status']) && !in_array($this->container['performance_recorded_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'performance_recorded_status', must be one of '%s'",
                $this->container['performance_recorded_status'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['ticket_priority_id'] === null) {
            $invalidProperties[] = "'ticket_priority_id' can't be null";
        }
        $allowedValues = $this->getTicketRatingAllowableValues();
        if (!is_null($this->container['ticket_rating']) && !in_array($this->container['ticket_rating'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'ticket_rating', must be one of '%s'",
                $this->container['ticket_rating'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['ticket_status_id'] === null) {
            $invalidProperties[] = "'ticket_status_id' can't be null";
        }
     ...
     *
     * @param string|null $invoicing_status invoicing_status
     *
     * @return self
     */
    public function setInvoicingStatus($invoicing_status)
    {
        ...
        $allowedValues = $this->getInvoicingStatusAllowableValues();
        if (!in_array($invoicing_status, $allowedValues, true)) {
     ...
     *
     * @param string|null $performance_recorded_status performance_recorded_status
     *
     * @return self
     */
    public function setPerformanceRecordedStatus($performance_recorded_status)
    {
        ...
        $allowedValues = $this->getPerformanceRecordedStatusAllowableValues();
        if (!in_array($performance_recorded_status, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'performance_recorded_status', must be one of '%s'",
                    $performance_recorded_status,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     *
     * @param string $ticket_priority_id ticket_priority_id
     *
     * @return self
     */
     ...
     * Sets ticket_rating
     *
     * @param string|null $ticket_rating ticket_rating
     *
     * @return self
     */
    public function setTicketRating($ticket_rating)
    {
        ...
        $allowedValues = $this->getTicketRatingAllowableValues();
        if (!in_array($ticket_rating, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'ticket_rating', must be one of '%s'",
                    $ticket_rating,
     ...
     *
     * @param string $ticket_status_id ticket_status_id
     *
     * @return self
     */

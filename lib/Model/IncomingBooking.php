...
/**
 * IncomingBooking Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\weclapp
 * @author   OpenAPI Generator team
 ...
 */
class IncomingBooking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'incomingBooking';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($quantity)))) {
            throw new \InvalidArgumentException("invalid value for \$quantity when calling IncomingBooking., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setArticleValuationPrice($article_valuation_price)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})([.][0-9]{1,5})?$/", ObjectSerializer::toString($article_valuation_price)))) {
            throw new \InvalidArgumentException("invalid value for \$article_valuation_price when calling IncomingBooking., must conform to the pattern /^([0-9]{1,13})([.][0-9]{1,5})?$/.");
        }
    ...
    public function setConfirmedQuantityDeprecated($confirmed_quantity_deprecated)
    {
        ...
        if ((!preg_match("/^([0-9]{1,13})/", ObjectSerializer::toString($confirmed_quantity_deprecated)))) {
            throw new \InvalidArgumentException("invalid value for \$confirmed_quantity_deprecated when calling IncomingBooking., must conform to the pattern /^([0-9]{1,13})/.");
        }
